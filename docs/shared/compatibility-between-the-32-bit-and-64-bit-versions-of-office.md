...
Вам необходимо заглянуть в документацию по Windows API на сайте Microsoft Developers Network и найти функцию, которую вы хотите вызвать. Дескрипторы и указатели должны быть преобразованы в **LongPtr**. Например, в документации для функции [RegOpenKeyA](https://msdn.microsoft.com/library/c8a590f2-3249-437f-a320-c7443d42b792.aspx) есть такая сигнатура: 
...
В [Win32API_PtrSafe.txt](https://www.microsoft.com/downloads/details.aspx?displaylang=en&amp;FamilyID=035b72a5-eef9-4baf-8dbc-63fbd2dd982b) оператор **Declare** определен следующим образом: 
...
- [Структура оператора Declare](https://msdn.microsoft.com/library/office/aa671659.aspx)
