...
2. Создайте объект **прожекткреатионинформатион** , чтобы указать исходные свойства проекта. Укажите обязательное свойство **Name** с помощью функции **прожекткреатионинформатион. set_name** . 
    
3. Получение опубликованных проектов с сервера с помощью функции **ProjectContext. get_projects** . Функция **get_projects** возвращает объект **прожектколлектион** . 
...
2. Получение опубликованных проектов с сервера с помощью функции **ProjectContext. get_projects** . Функция **get_projects** возвращает объект **прожектколлектион** . 
...
6. Измените дату начала проекта с помощью функции **драфтпрожект. set_startDate** . 
