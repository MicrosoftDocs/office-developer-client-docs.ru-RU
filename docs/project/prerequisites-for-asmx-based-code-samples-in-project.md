...
5. После устранения ссылки введите имя ссылки в текстовом поле **имя веб-ссылки** . В примерах кода в документации для разработчиков Project 2013 используется произвольное стандартное ссылочное имя **svc __**. Например, веб-служба проекта называется **SvcProject** (см. рис. 3). 
