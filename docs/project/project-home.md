...
- [Справочник по VBA для Project](https://docs.microsoft.com/office/vba/api/overview/project)
...
- [Начало работы с надстройками Project](https://docs.microsoft.com/office/dev/add-ins/quickstarts/project-quickstart)
