...
Сведения о разработке распределения, размещения и управление надстройками, просматривать [надстройки SharePoint](https://docs.microsoft.com/en-us/sharepoint/dev/sp-add-ins/sharepoint-add-ins) и [надстроек Office](https://docs.microsoft.com/en-us/office/dev/add-ins/overview/office-add-ins)и щелкните ссылку в документации разработчика по SharePoint Server 2013 и Office 2013. Сведения о область запроса разрешений для других SharePoint надстроек содержатся в разделе [разрешения Add-in в SharePoint 2013](http://msdn.microsoft.com/library/5f7a8440-3c09-4cf8-83ec-c236bfa2d6c4%28Office.15%29.aspx).
