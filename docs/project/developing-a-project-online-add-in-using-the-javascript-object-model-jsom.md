...
> [!NOTE]
> Надстройки могут публикации и продается в магазин Office или развернут в частном каталоге приложений на сайте SharePoint. Дополнительные сведения можно [Развернуть и публикация надстройки Office](https://docs.microsoft.com/en-us/office/dev/add-ins/publish/publish).
> 
