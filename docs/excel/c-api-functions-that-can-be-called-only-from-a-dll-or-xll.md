...
---
# <a name="c-api-functions-that-can-be-called-only-from-a-dll-or-xll"></a>Функции API C, которые могут быть вызваны только из DLL или XLL

**Область применения:** Excel 2013 | Office 2013 | Visual Studio 
  
API C предоставляет 15 функций вызова Microsoft Excel, которые можно вызывать только с помощью функций **Excel4,** **Excel4v,** **Excel12** или **Excel12v** (или одной из этих функций косвенно с помощью функций **Framework Excel** или **Excel12f).** Это означает, что они могут быть вызваны только из DLL или XLL.
