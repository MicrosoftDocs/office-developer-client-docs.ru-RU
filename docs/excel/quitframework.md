...
Функция библиотеки Framework, которая униниализает библиотеку Framework, которая просто повторно инициализирует временные структуры данных памяти **XLOPER** /  **XLOPER12,** освободив все уже выделенные памяти. 
