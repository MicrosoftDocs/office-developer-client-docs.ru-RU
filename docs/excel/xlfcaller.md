...
|Auto_Open, Автозакрытие, Auto_Activate или Auto_Deactivate макрос  <br/> |Имя телефонной ведомости.  <br/> |
...
Для получения дополнительных сведений о параметрах **XLOPER**/ **XLOPER12s** см [в Excel](memory-management-in-excel.md).
