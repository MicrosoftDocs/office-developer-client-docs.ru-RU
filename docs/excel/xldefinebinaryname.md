...
Используется для выделения постоянного хранилища для **кслтипебигдата** **XLOPER**/ **.** Данные с определенным двоичным именем сохраняются вместе с книгой и могут быть доступны по имени в любое время. Дополнительные сведения [см. в разделе "](known-issues-in-excel-xll-development.md)ограничения области двоичных имен".
