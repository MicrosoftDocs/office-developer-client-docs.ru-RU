...
Эта функция работает правильно при вызове с использованием [Excel4 и Excel12](excel4-excel12.md) с использованием функций обратного вызова API, так **как обе структуры** **и структуры** , которые поддерживают тип значения **кслтипебигдата** . 
