...
Одна или несколько **XLOPER**/ **разпроцессоров XLOPER, которые должны**быть освобождены. В версиях Excel до 2003 максимальное число указателей, которые можно передать: 30. Начиная с Excel 2007, это увеличено до 255.
