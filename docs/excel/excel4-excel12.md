...
|столбцов  <br/> |**xlretStackOvfl** <br/> |Произошло переполнение стека. Используйте **кслстакк** для отслеживания объема помещения, расположенного в стеке. Избегайте выделения в стеке очень больших локальных (автоматически) массивов и структур, где это возможно; Сделайте их статическими. (Обратите внимание, что переполнение стека может произойти без обнаружения.)  <br/> |
