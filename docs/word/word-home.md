...
Найдите практических руководств, примеры кода, документацию по SDK и API, справочные материалы VBA, обучающие и технические статьи по разработке решений и настройке Word.
...
- [Справочник по VBA для Word](https://msdn.microsoft.com/en-us/library/ee861527.aspx)
...
- [Начало работы с надстройки Word](https://docs.microsoft.com/en-us/office/dev/add-ins/quickstarts/word-quickstart)
...
- [Примеры кода Word в центре разработчиков Office](https://developer.microsoft.com/en-us/word/gallery/?filterBy=Word,Samples)
