...
Вы можете интегрировать сторонние приложения на универсальной платформе приложений Windows с Excel Mobile, русская версия, PowerPoint Mobile и Word Mobile. Универсальные приложения интегрируются с приложениями Office с помощью [контрактов выбора файлов Windows](https://msdn.microsoft.com/ru-RU/library/windows/apps/hh465174.aspx), [свойств Expando](https://msdn.microsoft.com/ru-RU/library/windows/apps/xaml/hh770655.aspx) и [контрактов обновления кэшированных файлов](https://msdn.microsoft.com/ru-RU/library/windows/apps/windows.storage.provider.cachedfileupdater.aspx).
...
- использовать [контракты выбора файлов](https://msdn.microsoft.com/ru-RU/library/windows/apps/hh465174.aspx) в Windows;
...
|**Параметр**|**Описание**|
|:-----|:-----|
|[ReadActivationMode](https://msdn.microsoft.com/ru-RU/library/windows/apps/windows.storage.provider.readactivationmode.aspx) <br/> |Задайте параметр **BeforeAccess**, чтобы позволить приложению обновлять файл перед его отправкой в Office.  <br/> |
...
|[CachedFileOptions.RequireUpdateOnAccess](https://msdn.microsoft.com/ru-RU/library/windows/apps/windows.storage.provider.cachedfileoptions.aspx) <br/> |Задайте это свойство, чтобы ваше приложение всегда обновляло файл после получения к нему доступа пользователем в списке последних использованных файлов.  <br/> |
   
## <a name="invoking-office-from-your-app"></a>Вызов Office из вашего приложения

Кода пользователь будет открывать документ Office в вашем приложении, документ может открыться в Excel Mobile, PowerPoint Mobile и Word Mobile. Например, если пользователь выберет файл \*.docx в вашем приложении, файл \*.docx откроется в окне Word Mobile. То, какое приложение Office откроется, зависит от того, с каким приложением пользователь связал тип открываемого файла.
...
Дополнительные сведения см. в статье [Класс Launcher](https://msdn.microsoft.com/ru-RU/library/windows/apps/windows.system.launcher.aspx).
...
Дополнительные сведения об атрибутах см. в статье [Функция SetFileAttributes](https://msdn.microsoft.com/ru-RU/library/windows/desktop/aa365535%28v=vs.85%29.aspx).
