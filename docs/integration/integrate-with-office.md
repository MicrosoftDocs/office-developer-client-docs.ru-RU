...
- [Интеграция приложений Android с Office](integrate-with-office-from-android-applications.md)
    
## <a name="see-also"></a>См. также

- [Разработка клиента Office](https://msdn.microsoft.com/en-us/library/dn833103.aspx)
