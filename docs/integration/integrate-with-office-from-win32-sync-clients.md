...
Чтобы клиент синхронизации Win32 отображался как корневой узел в области навигации проводника и средства выбора файлов Windows, необходимо интегрировать приложение на корневом уровне. Сведения об этом можно найти в [статье об интеграции с поставщиком облачного хранилища](https://msdn.microsoft.com/en-us/library/windows/desktop/dn889934%28v=vs.85%29.aspx). 
...
В приложениях Office пользователи могут создавать документы в библиотеках документов одним действием. Добавить путь к папке синхронизации в библиотеку документов можно с помощью [функции SHAddFolderPathToLibrary](https://msdn.microsoft.com/en-us/library/windows/desktop/dd378432%28v=vs.85%29.aspx). 
