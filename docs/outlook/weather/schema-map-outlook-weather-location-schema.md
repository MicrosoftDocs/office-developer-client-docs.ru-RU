---
title: Схема карты (Outlook схема расположения погоды)
manager: soliver
ms.date: 11/16/2014
...
description: В этом разделе показано определение схемы для Outlook XML-схемы расположения погоды.
...
---
# <a name="schema-map-outlook-weather-location-schema"></a><span data-ttu-id="399c3-103">Схема карты (Outlook схема расположения погоды)</span><span class="sxs-lookup"><span data-stu-id="399c3-103">Schema map (Outlook Weather Location Schema)</span></span>

<span data-ttu-id="399c3-104">В этом разделе показано определение схемы для Outlook XML-схемы расположения погоды.</span><span class="sxs-lookup"><span data-stu-id="399c3-104">This topic shows the schema definition for the Outlook Weather Location XML Schema.</span></span>
