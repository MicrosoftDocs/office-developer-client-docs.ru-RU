...
---
# <a name="forecasttype-complextype-outlook-weather-information-schema"></a>complexType forecastType (Outlook схема сведений о погоде)

Определяет параметры прогнозируемых погодных условий расположения.
