...
---
# <a name="schema-map-outlook-weather-information-schema"></a>Карта схемы (схема прогноза погоды в Outlook)

В этом разделе показано определение схемы для схемы XML данных о погоде в Outlook.
