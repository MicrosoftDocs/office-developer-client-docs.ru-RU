...
---
# <a name="schema-map-outlook-weather-information-schema"></a>Схема карты (Outlook схема сведений о погоде)

В этом разделе показано определение схемы XML Outlook информации о погоде.
