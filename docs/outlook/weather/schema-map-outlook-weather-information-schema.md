...
ms.locfileid: "19812940"
---
# <a name="schema-map-outlook-weather-information-schema"></a><span data-ttu-id="bb98c-103">Карта схемы (схема сведения о погоде Outlook)</span><span class="sxs-lookup"><span data-stu-id="bb98c-103">Schema map (Outlook Weather Information Schema)</span></span>

<span data-ttu-id="bb98c-104">В этом разделе показано определение схемы для схемы XML сведения о погоде Outlook.</span><span class="sxs-lookup"><span data-stu-id="bb98c-104">This topic shows the schema definition for the Outlook Weather Information XML Schema.</span></span>
