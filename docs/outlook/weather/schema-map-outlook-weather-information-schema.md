...
---
# <a name="schema-map-outlook-weather-information-schema"></a><span data-ttu-id="f37bb-103">Карта схемы (схема сведений о погоде Outlook)</span><span class="sxs-lookup"><span data-stu-id="f37bb-103">Schema map (Outlook Weather Information Schema)</span></span>

<span data-ttu-id="f37bb-104">В этом разделе показано определение схемы схемы XML для сведений о погоде Outlook.</span><span class="sxs-lookup"><span data-stu-id="f37bb-104">This topic shows the schema definition for the Outlook Weather Information XML Schema.</span></span>
