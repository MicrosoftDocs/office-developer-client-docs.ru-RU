...
---
# <a name="types-outlook-weather-information-schema"></a>Типы (схема сведений о погоде Outlook)

В этом разделе перечислены типы в схеме XML-данных о погоде Outlook.
