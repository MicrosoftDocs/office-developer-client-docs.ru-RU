...
---
# <a name="types-outlook-weather-information-schema"></a>Типы (Outlook схема сведений о погоде)

В этом разделе перечислены типы в схеме XML Outlook сведения о погоде.
