...
Указывает, следует ли использовать безопасный слой socket (SSL) для общего почтового ящика Интернета.
...
Нулевое значение означает, что не используйте SSL, в противном случае используйте SSL.
