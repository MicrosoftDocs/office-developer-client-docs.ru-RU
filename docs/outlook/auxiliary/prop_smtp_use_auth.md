...
Указывает, следует ли использовать проверку подлинности для учетной записи SMTP.
...
Нулевое значение означает, что проверка подлинности не используется, в противном случае используется проверка подлинности.
