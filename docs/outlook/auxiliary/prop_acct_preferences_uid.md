...
Извлекает уникальный идентификатор (UID) для раздела профилей, который хранит предпочтения учетной записи. 
...
Используйте **PROP_ACCT_PREFERENCES_UID** в вызовах [в IMAPISupport::OpenProfileSection,](https://msdn.microsoft.com/library/cd1fa994-9531-46c4-94e5-505e7f90b884%28Office.15%29.aspx) чтобы получить раздел профилей, содержащий предпочтения учетной записи. 
