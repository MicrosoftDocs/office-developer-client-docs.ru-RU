...
Извлекает уникальный идентификатор (UID) для раздела профиля, в котором хранится настройка учетной записи. 
...
Используйте **PROP_ACCT_PREFERENCES_UID** вызовов [IMAPISupport::OpenProfileSection,](https://msdn.microsoft.com/library/cd1fa994-9531-46c4-94e5-505e7f90b884%28Office.15%29.aspx) чтобы получить раздел профиля, содержащий настройки учетной записи. 
