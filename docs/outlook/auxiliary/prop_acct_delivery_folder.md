...
description: Представляет ID записи папки доставки по умолчанию для учетной записи.
...
Представляет ID записи папки доставки по умолчанию для учетной записи.
...
Папка доставки по умолчанию — **папка "Входящие".**
