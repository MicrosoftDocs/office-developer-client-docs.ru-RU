...
Это значение может быть одной из следующих констант. См. [константы (API управления](constants-account-management-api.md) учетной записью) для их значений. 
  
|**Константы**|**Описание**|
|:-----|:-----|
|**ENCRYPT_CONN_NO_SECURITY** <br/> |Не используйте шифрование.  <br/> |
|**ENCRYPT_CONN_SSL** <br/> |Используйте шифрование Secure Socket Layer (SSL).  <br/> |
|**ENCRYPT_CONN_TLS** <br/> |Используйте протокол шифрования и проверки подлинности транспортного слоя (TLS).  <br/> |
