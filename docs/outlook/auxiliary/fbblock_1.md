...
> Сведения о доступности этого блока, указывающие на то, что пользователь находится вне офиса, занят, является вопросом или свободен в течение периода времени между _m_tmStart_ и _m_tmEnd_.
