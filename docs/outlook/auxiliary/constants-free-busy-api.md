...
Для следующих идентификаторов интерфейса предположим, что макрос ДЕФИНЕ_ГУИД, определенный в файле заголовка Windows SDK guiddef. h, связывает символьное имя GUID со значением.
  
{00067064-0000-0000 — C000 — 000000000046}
  
ДЕФИНЕ_ГУИД (Иид_иенумфбблокк, 0x00067064, 0x0, 0x0, 0xC0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x46);
  
{00067066-0000-0000 — C000 — 000000000046}
  
ДЕФИНЕ_ГУИД (Иид_ифрибусидата, 0x00067066, 0x0, 0x0, 0xC0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x46);
  
{00067067-0000-0000 — C000 — 000000000046}
  
ДЕФИНЕ_ГУИД (Иид_ифрибусисуппорт, 0x00067067, 0x0, 0x0, 0xC0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x46);
