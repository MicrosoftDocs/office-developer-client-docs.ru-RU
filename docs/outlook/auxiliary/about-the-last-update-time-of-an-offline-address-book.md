...
## <a name="see-also"></a><span data-ttu-id="b2e5e-115">См. также</span><span class="sxs-lookup"><span data-stu-id="b2e5e-115">See also</span></span>

- [<span data-ttu-id="b2e5e-116">Managing Offline Address Books</span><span class="sxs-lookup"><span data-stu-id="b2e5e-116">Managing Offline Address Books</span></span>](https://msdn.microsoft.com/library/b7f26eca-b93b-4834-ba50-11febdefbb18.aspx)
