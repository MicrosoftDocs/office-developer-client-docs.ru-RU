...
В этом разделе концептуальные сведения о календарях и встречах Outlook, включая API занятости, обновления запросов на собрания и переосмысление календарей на летнее время. 
