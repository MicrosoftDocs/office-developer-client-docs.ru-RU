...
- [Сведения о переходе на летнЕе время в календаре программным способом](about-rebasing-calendars-programmatically-for-daylight-saving-time.md) (Также существует распространяемый установщик для сторонних средств базового календаря, который работает с предыдущими версиями Outlook, так как Outlook 2010. Чтобы скачать установщик, ознакомьтесь со статьей [Outlook 2010: дополнительный справочНый установщик и заголовочНый файл для перебазового календаря](https://www.microsoft.com/downloads/details.aspx?FamilyID=77748863-4352-4b99-ae57-1d4ae803983b).)
