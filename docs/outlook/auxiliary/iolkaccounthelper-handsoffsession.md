...
|**HRESULT**|**Description**|
|:-----|:-----|
|S_OK  <br/> |Если реализация **иолкаккаунселпер** создает свой собственный сеанс MAPI, который возвращается в **Иолкаккаунселпер:: жетмаписессион**, необходимо освободить сеанс здесь и возвратить S_OK.  <br/> |
|E_NOTIMPL  <br/> |Если в вашей реализации **иолкаккаунселпер** не был создан собственный сеанс MAPI, необходимо возвращать только E_NOTIMPL. В этом случае поддерживается только возвращаемое значение.  <br/> |
