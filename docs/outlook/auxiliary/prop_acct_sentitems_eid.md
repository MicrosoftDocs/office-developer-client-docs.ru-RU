...
Это свойство доступно только для чтения для учетных записей POP3 и IMAP. При попытке задать это свойство для этих типов учетных записей возвращается **E_ACCT_NOT_FOUND**. 
