...
Представляет ID записи папки по умолчанию для отправленных элементов для учетной записи. 
...
Папка по умолчанию для отправленных элементов — **отправленные элементы.**
  
Это свойство только для чтения для учетных записей POP3 и IMAP. Попытка установить это свойство для этих типов учетных записей возвращает **E_ACCT_NOT_FOUND**. 
