...
Представляет [структуру ACCT_BIN,](acct_bin.md) которая содержит UID учетной записи Exchange учетной записи. 
...
Используйте [PROP_ACCT_IS_EXCH,](prop_acct_is_exch.md) чтобы проверить, является ли учетная запись Exchange учетной записью. Если это так, **prop \_ MAPI_EMSMDB_UID**  является ACCT_BIN, который содержит **emsmdbUID**, который является уникальным ID, для Exchange учетной записи. Если учетная запись не является Exchange учетной записью, это свойство не является неопределенным.
  
## <a name="see-also"></a>См. также

- [Сведения об API управления учетными записями](about-the-account-management-api.md) 
- [Constants (Account management API)](constants-account-management-api.md)
- [Использование нескольких Exchange учетных записей](https://msdn.microsoft.com/library/4e1804bf-4c50-4942-a7ab-9a8caf1be7e5%28Office.15%29.aspx)  
