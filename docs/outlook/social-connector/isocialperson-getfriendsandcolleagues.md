...
Тем не менее, если выбранный пользователь Outlook не указывает тот же SMTP-адрес для учетной записи в социальной сети, или если пользователь Outlook не имеет учетной записи в этой социальной сети, OSC не сможет найти соответствующее значение для этого пользователя и не будет отображать действия для этого пользователя в социальной сети.
