...
- **хидехиперлинкс** как **false** , чтобы указать, что поставщик OSC поддерживает только существующие учетные записи с известными паролями, а OSC не должен отображать **для создания учетной записи учетную запись** и **забыли пароль?** гиперссылки в диалоговом окне Настройка учетной записи. 
