...
---
# <a name="outlook-social-connector-provider-xml-schema"></a><span data-ttu-id="e9004-104">Схема XML поставщика Outlook Social Connector</span><span class="sxs-lookup"><span data-stu-id="e9004-104">Outlook Social Connector provider XML schema</span></span>

<span data-ttu-id="e9004-105">Все файлы XML, который возвращается, поставщики OSC в методах расширения поставщика OSC должен соответствовать требованиям следующая схема XML для OSC поставщика.</span><span class="sxs-lookup"><span data-stu-id="e9004-105">All XML that is returned by OSC providers in OSC provider extensibility methods must comply with the following OSC provider XML schema.</span></span> <span data-ttu-id="e9004-106">Схема OSC воспроизведена здесь целиком.</span><span class="sxs-lookup"><span data-stu-id="e9004-106">The OSC schema is reproduced here in its entirety.</span></span> <span data-ttu-id="e9004-107">Текущий файл определения схемы OutlookSocialProvider1_1.xsd, также предоставляется в файл для загрузки для поставщика шаблонов, которые прилагаются к этой статье.</span><span class="sxs-lookup"><span data-stu-id="e9004-107">The current schema definition file, OutlookSocialProvider1_1.xsd, is also provided in the download for the provider templates that accompany this article.</span></span> <span data-ttu-id="e9004-108">Дополнительные сведения можно [Outlook Social Connector 2013: шаблоны поставщика](http://code.msdn.microsoft.com/Outlook-Social-Connector-73fd8d2c).</span><span class="sxs-lookup"><span data-stu-id="e9004-108">For more information, see [Outlook Social Connector 2013: Provider templates](http://code.msdn.microsoft.com/Outlook-Social-Connector-73fd8d2c).</span></span> 
...
## <a name="see-also"></a><span data-ttu-id="e9004-109">См. также</span><span class="sxs-lookup"><span data-stu-id="e9004-109">See also</span></span>

- [<span data-ttu-id="e9004-110">Пример возможности XML</span><span class="sxs-lookup"><span data-stu-id="e9004-110">Capabilities XML Example</span></span>](capabilities-xml-example.md)  
- [<span data-ttu-id="e9004-111">Пример XML друзей</span><span class="sxs-lookup"><span data-stu-id="e9004-111">Friends XML Example</span></span>](friends-xml-example.md) 
- [<span data-ttu-id="e9004-112">Пример XML веб-канала активности</span><span class="sxs-lookup"><span data-stu-id="e9004-112">Activity Feed XML Example</span></span>](activity-feed-xml-example.md)  
- [<span data-ttu-id="e9004-113">XML-код для возможности</span><span class="sxs-lookup"><span data-stu-id="e9004-113">XML for Capabilities</span></span>](xml-for-capabilities.md)  
- [<span data-ttu-id="e9004-114">XML-код для друзей</span><span class="sxs-lookup"><span data-stu-id="e9004-114">XML for Friends</span></span>](xml-for-friends.md)  
- [<span data-ttu-id="e9004-115">XML-код для действия</span><span class="sxs-lookup"><span data-stu-id="e9004-115">XML for Activities</span></span>](xml-for-activities.md)  
- [<span data-ttu-id="e9004-116">Интерфейсы поставщика Outlook Social Connector</span><span class="sxs-lookup"><span data-stu-id="e9004-116">Outlook Social Connector Provider Interfaces</span></span>](outlook-social-connector-provider-interfaces.md)
