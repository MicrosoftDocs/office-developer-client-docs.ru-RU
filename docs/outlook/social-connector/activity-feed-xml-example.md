...
- Запись блога Майкла Аффронти, в которой показано одно и то же **овнерид** в 5015012 как два последних действия. Это действие задает две переменные шаблона типа **публишервариабле** и **линквариабле**. **публишервариабле** указывает пользователя, опубликовавшего элемент веб-канала активности, и **линквариабле** содержит дополнительные сведения (заданные с помощью **имени**, **текста**и дочерних элементов **value** из **линквариабле**) о записи блога.
