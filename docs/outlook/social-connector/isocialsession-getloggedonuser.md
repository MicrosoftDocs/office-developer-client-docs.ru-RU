...
description: Получает интерфейс ИсоЦиалпрофиле, представляющий пользователя, выполнившего вход в систему.
...
Получает интерфейс [исоЦиалпрофиле](isocialprofileisocialperson.md) , представляющий пользователя, выполнившего вход в систему. 
...
> вышли Интерфейс **исоЦиалпрофиле** . 
