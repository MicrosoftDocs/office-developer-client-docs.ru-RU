...
description: Получает интерфейс ISocialProfile, который представляет во входе пользователя.
...
Получает интерфейс [ISocialProfile,](isocialprofileisocialperson.md) который представляет во входе пользователя. 
