...
- [Справочник по VBA для Outlook](https://docs.microsoft.com/office/vba/api/overview/outlook)
...
- [Начало работы с надстройками Outlook](https://docs.microsoft.com/outlook/add-ins/quick-start?tabs=visual-studio)
  
- [Обзор платформы](https://docs.microsoft.com/office/dev/add-ins/overview/office-add-ins)
  
### <a name="code-samples"></a>Примеры кода
  
- [Примеры кода для Outlook в Центре разработчиков Office](https://developer.microsoft.com/office/gallery/?filterBy=Samples,Outlook)
