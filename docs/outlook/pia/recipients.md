...
В этом разделе приведены примеры задач, в которых используются получатели. Получатели — это пользователи, которые получают исходящие электронные письма, запросы на общий доступ или приглашения на собрания.
...
|[Получение адреса электронной почты получателя](how-to-get-the-e-mail-address-of-a-recipient.md)  |В этой статье рассказано, как получить SMTP-адрес получателя.|
