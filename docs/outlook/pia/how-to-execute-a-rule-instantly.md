...
Чтобы отменить выполнение правила, воспользуйтесь мастером правил и оповещений. Также можно отменить выполнение правила, присвоив параметру *ShowProgress* значение **true**, а затем выбрав команду отмены в диалоговом окне хода выполнения процесса. После выбора команды отмены возвращается ошибка метода **Execute**. 
