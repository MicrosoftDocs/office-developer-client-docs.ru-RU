...
В следующем примере кода процедура GetDefaultMessageClass использует **PropertyAccessor**, чтобы определить для папки форму по умолчанию. Если свойство СВОЙСТВА папки **PR \_ DEF POST \_ \_ MSGCLASS** [(PidTagDefaultPostMessageClass)](https://msdn.microsoft.com/library/cc815305\(v=office.15\)) не найдено и Outlook вызывает ошибку, **попробуйте... блок** catch возвращает **свойство DefaultMessageClass** для **папки.**
