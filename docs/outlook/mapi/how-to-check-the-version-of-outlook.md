...
---
# <a name="check-the-version-of-outlook"></a><span data-ttu-id="b6cbf-103">Проверка версии Outlook</span><span class="sxs-lookup"><span data-stu-id="b6cbf-103">Check the version of Outlook</span></span>
...
## <a name="see-also"></a><span data-ttu-id="b6cbf-110">См. также</span><span class="sxs-lookup"><span data-stu-id="b6cbf-110">See also</span></span>

- [<span data-ttu-id="b6cbf-111">Общие сведения о программировании MAPI</span><span class="sxs-lookup"><span data-stu-id="b6cbf-111">MAPI Programming Overview</span></span>](mapi-programming-overview.md)
