...
---
# <a name="pidlidlogdocumentposted-canonical-property"></a>Каноническое свойство PidLidLogDocumentPosted

  
  
**Область применения**: Outlook 2013 | Outlook 2016 
  
Указывает, был ли документ отправлен по электронной почте или отправлен в папку сервера во время журнального журнала.
