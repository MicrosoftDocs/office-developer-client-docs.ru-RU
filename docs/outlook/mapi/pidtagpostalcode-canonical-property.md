...
Содержит почтовый код почтового адреса получателя.
...
Почтовый код имеет особый характер для страны или региона получателя. В Соединенных Штатах Америки это свойство содержит почтовый индекс.
