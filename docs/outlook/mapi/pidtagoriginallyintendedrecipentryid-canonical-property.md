...
Содержит идентификатор записи исходного получателя сообщения с автоматической переназначаемой почтой.
...
Это свойство является одним из свойств адреса для исходного получателя сообщения. Его должен установить автоматический агент, который переадил сообщение.
