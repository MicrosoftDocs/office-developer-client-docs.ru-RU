...
Содержит указатель на структуру для управления, используемого в диалоговом окне. 
...
Это свойство представляет собой длинную указатель, отбрасываемую в одну из структур управления. Структуры управления включают:
