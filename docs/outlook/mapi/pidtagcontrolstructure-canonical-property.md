...
Содержит указатель на структуру для используемого в диалоговом окне управления. 
...
Это свойство представляет длинный указатель, который передается в одну из структур управления. К структурам управления относятся:
