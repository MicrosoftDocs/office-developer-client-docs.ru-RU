...
Указывает, насколько активно входящие сообщения следует отправлять в папку нежелательной почты.
...
Это свойство соответствует параметру фильтра high/low /none. Значение "0xFFFFFFFF" указывает, что фильтрация нежелательной почты не должна применяться, однако списки блокирований по-прежнему должны применяться. Значение "0x80000000" указывает, что вся почта является нежелательной, за исключением сообщений от отправителей из списка надежных отправителей или отправленных получателям в списке надежных получателей. Для этого значения следуют следующим образом:
  
|**Значение**|**Описание**|
|:-----|:-----|
|0xFFFFFFFF  <br/> |Фильтрация нежелательной почты не будет  <br/> |
