...
Клиентские приложения используют это свойство для создания списка рассылки в контейнере. Поддержка создания записей необязательна для контейнеров адресной книги; те, кто не поддерживает его, не обязаны выставлять это свойство. 
