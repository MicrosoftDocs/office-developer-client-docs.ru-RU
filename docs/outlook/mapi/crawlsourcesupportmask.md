...
Указывает, следует ли Microsoft Office Outlook сканировать папки в хранилище, включая папки "Контакты", "Календарь" и "Задачи", при запуске для заполнения области навигации.
...
Это свойство позволяет поставщикам магазина указать, следует ли Outlook проверять различные папки в хранилище. Он используется при запуске, когда Outlook сканирует существующие папки в каждом открытом хранилище для заполнения области **навигации;** Outlook проверяет наличие и значение этого свойства в хранилище перед началом проверки. 
