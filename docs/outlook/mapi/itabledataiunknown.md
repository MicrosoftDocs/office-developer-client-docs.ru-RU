...
Предоставляет полезные методы для работы с таблицами. MAPI предоставляет объекты или объекты табличные данные, которые реализуют **ITableData,** чтобы помочь поставщикам услуг выполнять обслуживание таблиц. Чтобы получить объект данных таблицы, поставщики услуг вызовут [функцию CreateTable.](createtable.md) 
  
|||
|:-----|:-----|
|Файл заголовка:  <br/> |Mapiutil.h  <br/> |
|Выставим:  <br/> |Объекты данных таблицы  <br/> |
...
|||
|:-----|:-----|
|[HrGetView](itabledata-hrgetview.md) <br/> |Создает представление таблицы, возвращая указатель на [реализацию IMAPITable.](imapitableiunknown.md)  <br/> |
|[HrModifyRow](itabledata-hrmodifyrow.md) <br/> |Вставляет новую строку таблицы, возможно, заменяя существующую строку.  <br/> |
...
|[HrEnumRow](itabledata-hrenumrow.md) <br/> |Извлекает строку на основе ее позиции в таблице.  <br/> |
...
Реализация MAPI **ITableData** работает с таблицами, удерживая все данные и все связанные ограничения в памяти, что делает его непригодным для использования с очень большими таблицами. Большие ограничения и сложные операции, такие как категоризация, не поддерживаются. 
