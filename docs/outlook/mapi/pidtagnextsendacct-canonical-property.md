...
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_НЕКСТ_СЕНД_АККТ  <br/> |
...
Формат этого свойства зависит от реализации. Это свойство можно использовать в клиенте, чтобы определить, какой сервер должен направить сообщение, но является необязательным и значение не имеет смысла для сервера.
