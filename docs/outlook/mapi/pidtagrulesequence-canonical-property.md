...
Значение, используемее для определения порядка оценки и выполнения правил. 
...
Правила оцениваются последовательно в соответствии с растущим порядком этого значения. Порядок оценки для правил, которые имеют одинаковое значение в этом свойстве, неопределяется.
