...
Указывает, запрашивалось ли у назначенного назначения сообщение электронной почты при отправке обновления сообщения электронной почты.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidTaskSOC  <br/> |
