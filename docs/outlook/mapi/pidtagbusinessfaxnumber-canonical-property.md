...
Содержит телефонный номер факсимили получателя. 
...
Эти свойства являются примерами свойств, которые предоставляют идентификацию и доступ к сведениям о получателе. Эти свойства определяются получателем и организацией получателя. 
