...
Эти свойства содержат сведения, созданные агентом передачи сообщений или поставщиком транспорта, связанными с отчетом. Как правило, он используется для доставки или ненастройного текста отчета, который исходил из системы обмена сообщениями.
