...
Это свойство возвращается MTA после успешного завершения отправки сообщения. Любое дальнейшее обращение к MTA, касающееся этого сообщения, например запрос на отмену, использует идентификатор MTS в этом свойстве.
