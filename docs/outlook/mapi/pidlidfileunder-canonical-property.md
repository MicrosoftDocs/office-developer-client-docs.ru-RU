...
Указывает имя, под которым подавался контакт при отобрачии списка контактов.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidFileUnder  <br/> |
|Набор свойств:  <br/> |PSETID_Address  <br/> |
|Длинный ИД (КРЫШКА):  <br/> |0x00008005  <br/> |
|Тип данных:  <br/> |PT_UNICODE  <br/> |
|Область:  <br/> |Контакт  <br/> |
   
## <a name="remarks"></a>Примечания

Приложение должно рассматривать это свойство как пустое PT_UNICODE если оно отсутствует в контакте.
