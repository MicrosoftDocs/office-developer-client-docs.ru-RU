...
Указывает имя, в котором будет храниться контакт при отображении списка контактов.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |диспидфилеундер  <br/> |
...
Приложение должно считать это свойство пустым PT_UNICODE, если оно отсутствует в контакте.
