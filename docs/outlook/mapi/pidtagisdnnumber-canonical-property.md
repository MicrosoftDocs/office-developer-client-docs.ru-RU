...
Содержит номер телефона для получателя с поддержкой ISDN. 
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |PR_ISDN_NUMBER, PR_ISDN_NUMBER_A PR_ISDN_NUMBER_W  <br/> |
|Идентификатор:  <br/> |0x3A2D  <br/> |
