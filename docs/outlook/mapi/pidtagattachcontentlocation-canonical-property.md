...
Содержит заглавную головку расположения контента многоцелевого вложения сообщений для расширения интернет-почты (MIME). 
...
Эти свойства используются для поддержки MHTML. Они представляют заглавный заголовок расположения контента для соответствующей части тела MIME. 
