...
Указывает, связан ли объект с повторяющейся серией.
...
Значение TRUE указывает, что объект представляет повторяющиеся серии или исключение (в том числе экземпляр для сирот). Значение FALSE или отсутствие этого свойства указывает на то, что объект представляет один экземпляр. Обратите внимание на разницу между этим свойством **и PR_RECURRING** [(PidLidRecurring).](pidlidrecurring-canonical-property.md)
