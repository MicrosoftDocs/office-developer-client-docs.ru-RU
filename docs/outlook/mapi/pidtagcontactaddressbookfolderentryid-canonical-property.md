...
Содержит идентификатор папки Контакты в хранилище сообщений, где хранятся пользователи почты. 
...
Это свойство в контейнере адресной книги контактов и столбец в таблице контейнеров адресной книги контактов.
