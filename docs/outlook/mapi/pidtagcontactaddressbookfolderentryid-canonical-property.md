...
Содержит идентификатор папки "Контакты" в хранилище сообщений, в котором хранятся почтовые пользователи. 
...
Это свойство контейнера адресной книги контактов и столбец в таблице контейнеров адресной книги контактов.
