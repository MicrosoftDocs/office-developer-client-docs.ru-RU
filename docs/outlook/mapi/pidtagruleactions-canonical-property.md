...
|:-----|:-----|:-----|
|Импортпрокс. cpp  <br/> |Пропкопиморе, Хркопяктионс  <br/> |В этих функциях показано, как выполнить синтаксический анализ свойства PT_ACTIONS в целях копирования в другое свойство.  <br/> |
