...
Указывает, должна ли классификация сообщений сохраняться с сообщением, если сообщение было переададрено или ответило.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidClassKeep  <br/> |
