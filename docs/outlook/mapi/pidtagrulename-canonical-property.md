...
---
# <a name="pidtagrulename-canonical-property"></a>Каноническое свойство PidTagRuleName

  
  
**Относится к**: Outlook 
  
Задает понятное для пользователя имя правила.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |PR_RULE_NAME  <br/> |
|Идентификатор:  <br/> |0x6682  <br/> |
