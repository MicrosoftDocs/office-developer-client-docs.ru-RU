...
Если номер, указанный в _улровнумбер_ , не соответствует строке в таблице, **ХРЕНУМРОВ** возвращает значение S_OK и ЗАДАЕТ для параметра _лппсров_ значение null. 
