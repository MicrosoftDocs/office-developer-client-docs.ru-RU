...
Это свойство отображается только в таблицах содержимого. Категория существует, только если в ней есть элементы.
...
> Категория расширена; Пользовательский интерфейс обычно отображает его со знаком минус ( - ) рядом с ним.
    
TBL_COLLAPSED_CATEGORY 
  
> Категория свернута; Пользовательский интерфейс обычно отображает его со знаком плюса (+) рядом с ним.
