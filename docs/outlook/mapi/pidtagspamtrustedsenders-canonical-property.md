...
Содержит список адресов электронной почты и доменов, которые состоят из доверенных отправителей, разделенных точкой с запятой.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |PR_SPAM_TRUSTED_SENDERS_W  <br/> |
|Длинный идентификатор (крышка):  <br/> |0x0418  <br/> |
