...
|:-----|:-----|:-----|
|Мфкаутпут. cpp  <br/> |_OutputFormInfo  <br/> |MFCMAPI использует метод **имапиформинфо:: калквербсет** при записи выходных данных отладки для объектов данных формы.  <br/> |
