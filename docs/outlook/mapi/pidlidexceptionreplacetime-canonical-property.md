...
Указывает дату и время в шаблоне повторения, которые будет заменять исключение.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidExceptionReplaceTime  <br/> |
|Набор свойств:  <br/> |PSETID_Appointment  <br/> |
|Длинный ИД (КРЫШКА):  <br/> |0x00008228  <br/> |
|Тип данных:  <br/> |PT_SYSTIME  <br/> |
|Область:  <br/> |Календарь  <br/> |
   
## <a name="remarks"></a>Примечания

Значение должно быть указано в UTC. Это свойство позволяет найти объект вложения исключения для определенного экземпляра.
