...
Указывает дату и время в шаблоне повторения, который заменит исключение.
...
Значение должно быть указано в координируется универсальное время (UTC). Это свойство позволяет найти объект вложения исключений для конкретного экземпляра.
