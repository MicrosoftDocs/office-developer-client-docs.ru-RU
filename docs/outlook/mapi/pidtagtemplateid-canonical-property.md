...
Содержит **PR_ENTRYID** [(PidTagEntryId),](pidtagentryid-canonical-property.md)выраженный как формат постоянного входа.
