...
Параметры _лпсзпрепроцесс_, _лпсзремовепрепроцессинфо_и _лпсздллнаме_ должны указывать на строки, которые можно использовать в сочетании с вызовами функции Win32 **GetProcAddress** , что позволяет правильно вызывать точку входа DLL препроцессора. 
