...
В непрочитанном отчете это свойство содержит копию ключа поиска исходного получателя сообщения, для которого создается отчет. Если исходный получатель входит в список рассылки, ключ поиска в списке рассылки сохраняется для отчета.
