...
Предоставляет сведения, которые отображаются в диалоговом оке отправки и получения. Если во время синхронизации произошли ошибки, поставщик магазина вызывает эту функцию.
