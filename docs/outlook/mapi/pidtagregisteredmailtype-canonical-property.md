...
Это свойство содержит тип регистрации, используемые для физического доставки сообщения.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |PR_REGISTERED_MAIL_TYPE  <br/> |
|Идентификатор:  <br/> |0x0C16  <br/> |
