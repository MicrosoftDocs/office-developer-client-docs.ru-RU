...
Создает [именоваемую структуру ENTRYID,](entryid.md) которая содержит **ab-член** указанного размера. 
...
> Количество вбайтов в **члене ab** новой структуры. 
...
Чтобы использовать новую структуру, которая является результатом макроса **SizedENTRYID** в качестве указателя на структуру **ENTRYID,** выполните следующую cast: 
