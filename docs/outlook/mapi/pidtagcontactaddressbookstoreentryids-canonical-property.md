...
Содержит идентификаторы хранилищ, в которых найдены папки, которые являются записями адресной книги контактов.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_КОНТАБ_СТОРЕ_ЕНТРИДС  <br/> |
