...
Содержит ИД записей хранилищ, в которых находятся папки, которые выступают в качестве записей адресной книги контакта.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |PR_CONTAB_STORE_ENTRYIDS  <br/> |
|Идентификатор:  <br/> |0x6626  <br/> |
|Тип данных:  <br/> |PT_MV_BINARY  <br/> |
|Область:  <br/> |Адресная книга контакта  <br/> |
   
## <a name="remarks"></a>Примечания

Это свойство в разделе профиля адресной книги контактов.
