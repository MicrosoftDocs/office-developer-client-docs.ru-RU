...
Когда имя функции в точке входа отображается в методе **PR_SERVICE_ENTRY_NAME** ([PidTagServiceEntryName](pidtagserviceentryname-canonical-property.md)), он указывает, что точка входа существует.
