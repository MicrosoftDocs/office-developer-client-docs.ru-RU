...
Это свойство получено из хранилищ, которые содержат папки "Контакты". Поставщик адресной книги контактов использует ее для оценки адекватности поддерживаемых функций магазина. Это свойство в разделе профиля адресной книги контактов. 
