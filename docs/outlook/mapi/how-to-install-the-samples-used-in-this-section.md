...
7. В представлении дерева папок разверните узел, который содержит банк данных. Имя, отображаемое для этого узла, зависит от выбранного типа профиля. Как правило, этот узел отображается как **IPM_Subtree** или в **верхней части банка данных**.
