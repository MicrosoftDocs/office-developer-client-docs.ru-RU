...
Содержит сведения о конверте сообщения, относя сведения о транспорте.
...
Поставщик транспорта может сгенерировать сведения о загонах для входящие сообщения.
  
Эти свойства предлагают альтернативу либо отбрасыванием сведений о транспортном сообщении, либо их подготовкой к тексту сообщения. Клиент может выбрать, следует ли отображать информацию.
