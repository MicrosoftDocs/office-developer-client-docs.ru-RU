...
Указывает предлагаемое значение для свойства **dispidApptEndWhole** [(PidLidAppointmentEndWhole)](pidlidappointmentendwhole-canonical-property.md)для встречного предложения.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidApptProposedEndWhole  <br/> |
