...
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ЛИД_ВХЕРЕ  <br/> |
...
Значение этого свойства должно совпадать со значением свойства **диспидлокатион** ([PidLidLocation](pidlidlocation-canonical-property.md)) из связанного собрания.
