...
> [in] Возвращаемого значения из метода, который не удалось.
...
> [out] Указывает на структуру [MAPI MAPIERROR, которая](mapierror.md) содержит сведения о последней ошибке, которая произошла для объекта таблицы. 
