...
Содержит битмаску флагов, которые определяют физический режим доставки (например, специальную доставку) для сообщения, назначенного для конкретного получателя.
