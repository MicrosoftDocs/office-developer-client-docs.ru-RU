...
|||
|:-----|:-----|
|Связанные свойства:  <br/> |диспидбкдисплайдефинитион  <br/> |
...
Макет визитной карточки можно представить в виде изображения и ряда текстовых полей. Изображение может представлять собой фотографию контакта или изображение карточки. Текстовые поля состоят из значения из другого набора свойств контакта и дополнительной настраиваемой строки метки, предоставленной пользователем. Обратите внимание, что многобайтовые значения хранятся в буфере в формате с прямым порядком байтов.
