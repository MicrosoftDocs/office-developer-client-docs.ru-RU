...
|Связанные макрос:  <br/> |[CbNewSPropProblemArray](cbnewspropproblemarray.md) <br/> [CbSPropProblemArray](cbspropproblemarray.md) <br/> [SizedSPropProblemArray](sizedspropproblemarray.md) <br/> |
...
Дополнительные сведения о том, как структуры **SPropProblem** и **SPropProblemArray** работают с ошибками, связанными с свойствами, см. в рублях [MAPI Named Properties](mapi-named-properties.md). 
