...
Указывает smTP-адрес пользователя, иницившего сообщение общего доступа. Это свойство общего сообщения. 
...
Это свойство должно быть задано значению **свойства PR_SMTP_ADDRESS** [(PidTagSmtpAddress)](pidtagsmtpaddress-canonical-property.md)из адресной книги, идентифицированной **dispidSharingInitiatorEid** [(PidLidSharingInitiatorEntryId)](pidlidsharinginitiatorentryid-canonical-property.md)и должно быть проигнорировано.
