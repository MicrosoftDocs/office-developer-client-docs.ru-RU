...
Клиенты, реализующие объекты приемника уведомлений, могут определять свои интерфейсы в своих объектах вручную или с помощью макросов **MAPI_IUNKNOWN_METHODS** и **MAPI_IMAPIADVISESINK_METHODS** . Разработчики объектов должны использовать макросы интерфейса везде, где это возможно, для обеспечения согласованности между объектами, а также для экономии времени и усилий. 
