...
Содержит сведения о маршруте, охватываемом доставленным сообщением.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |PR_REDIRECTION_HISTORY  <br/> |
|Идентификатор:  <br/> |0x002C  <br/> |
|Тип данных:  <br/> |PT_BINARY  <br/> |
|Область:  <br/> |Конверт MAPI  <br/> |
   
## <a name="remarks"></a>Примечания

Это свойство используется, когда автоматический агент автоматически перенагружит сообщение.
