...
Указывает количество участников, отправивших предложения счетчиков, которые не были приняты или отклонены организатором.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidApptProposalNum  <br/> |
|Набор свойств:  <br/> |PSETID_Appointment  <br/> |
|Длинный ИД (КРЫШКА):  <br/> |0x00008259  <br/> |
