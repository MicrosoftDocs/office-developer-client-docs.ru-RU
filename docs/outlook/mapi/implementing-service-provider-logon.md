...
1. Увеличивает счетчик ссылок на объекте поддержки, который передается в качестве входного параметра путем вызова метода [IUnknown::AddRef](http://msdn.microsoft.com/en-us/library/ms691379%28v=VS.85%29.aspx) . 
