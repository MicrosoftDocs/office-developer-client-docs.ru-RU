...
Содержит значение поля поля заго глав контента [RFC3282].
...
Чтобы установить значение этого свойства, клиенты multipurpose Internet Message Extensions (MIME) должны написать поле заготавливщика контента с нужным значением. Читатели MIME должны скопировать значение поля заглавного поля content-Class к значению этого свойства. 
