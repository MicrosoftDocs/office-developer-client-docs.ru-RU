...
Содержит идентификатор записи стандартной папки удаленных элементов для межличностных сообщений (IPM). 
...
Клиентская заявка должна переместить удаленные межличностные сообщения в папку "Удаленные элементы". Если сообщение уже находится в этой папке или если это свойство не поддерживается, клиент должен удалить сообщение. 
