...
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_РКВД_РЕПРЕСЕНТИНГ_НАМЕ, ПР_РКВД_РЕПРЕСЕНТИНГ_НАМЕ_А, ПР_РКВД_РЕПРЕСЕНТИНГ_НАМЕ_В  <br/> |
...
Эти свойства являются примерами свойств адресов для пользователя обмена сообщениями, представленного принимающим пользователем. Они должны быть заданы входящим поставщиком транспорта, который также отвечает за авторизацию или проверку делегата. Если не представлен пользователь обмена сообщениями, для этих свойств необходимо задать отображаемое имя, содержащееся в свойстве **пр_рецеивед_би_наме** ([PidTagReceivedByName](pidtagreceivedbyname-canonical-property.md)).
  
Клиентское приложение, отвечающее на сообщение, полученное от имени другого клиента, должно копировать эти свойства из полученного сообщения в свойство **пр_сент_репресентинг_наме** ([PidTagSentRepresentingName](pidtagsentrepresentingname-canonical-property.md)) для ответа.
