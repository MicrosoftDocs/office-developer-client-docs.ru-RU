...
Метод **иперсистмессже::** задает содержимое параметра _лпклассид_ в качестве идентификатора класса сервера форм и возвращает значение S_OK. Если средство просмотра форм вызывает **** метод вызовов вызовов вызовов вызовов вызовов вызовов вызовов вызовов вызовов вызовов вызовов вызовов [](uninitialized-state.md) вызовов вызовов вызовов вызовов вызовов вызовов вызовов вызовов вызовов вызовов вызовов вызовов вызовов вызовов вызовов вызовов. 
