...
Каждая команда определена в отдельной **[verb.** _строка_ **]** . **[Verb.** _строка_ **]** описывает одну команду, предлагаемую формой. Запись **DisplayName** в **[verb.** _строка_ **]** раздел, указывающий имя команды, отображаемое в пользовательском интерфейсе. Запись **кода** соответствует номеру команды, переданному в методе [Имапиформ::D оверб](imapiform-doverb.md) . Синтаксис **[verb.** _строка_ **]** раздел: 
  
 **Команд.** _строка_ **]**
  
 **DisplayName** =  _Отображаемая строка_ DisplayName
  
 **Code** =  _Целое число_ кода
  
 **Flags** =  _Целое число_ флагов
  
 **Attribs** =  _Целое число_ аттрибс
  
Ниже приведен пример **[verb.** _строка_ **]** . 
