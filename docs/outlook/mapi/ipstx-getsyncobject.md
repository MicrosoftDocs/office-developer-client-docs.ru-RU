...
>  [вышел] Указатель на **интерфейс IOSTX** для получения. 
    
## <a name="remarks"></a>Примечания

Вызываемая должна убедиться, что одна и та же папка не синхронизируется одновременно на более чем одном потоке.
