...
Это свойство является одним из свойств адреса для пользователя сообщения, который получает сообщение. Его должен установить поставщик входящих транспортных услуг.
