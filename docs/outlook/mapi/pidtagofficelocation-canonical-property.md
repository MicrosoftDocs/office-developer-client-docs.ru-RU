...
ms.locfileid: "22573749"
---
# <a name="pidtagofficelocation-canonical-property"></a>Каноническое свойство PidTagOfficeLocation

  
  
**Относится к**: Outlook 2013 | Outlook 2016 
  
Содержит расположение комнаты получателя.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |PR_OFFICE_LOCATION, PR_OFFICE_LOCATION_A, PR_OFFICE_LOCATION_W  <br/> |
|Идентификатор:  <br/> |0x3A19  <br/> |
