...
Содержит последнюю дату и время доставки сообщения агентом передачи сообщений (MTA). 
...
Если MTA не может доставить сообщение до указанного свойства, оно отменяет сообщение без доставки. 
