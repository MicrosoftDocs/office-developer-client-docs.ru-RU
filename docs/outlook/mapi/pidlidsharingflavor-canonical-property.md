...
|**Значение**|**Тип объекта Общего доступа к сообщению**|
|:-----|:-----|
...
|0x00025100  <br/> |Ответ общего доступа, отказывающий запросу.  <br/> |
|0x00023310  <br/> |Ответ общего доступа, принимающий запрос (также тип приглашения общего доступа).  <br/> |
