...
Вызов **иаблогон:: метод compareentryids** эквивалентно извлечению свойства **PR_RECORD_KEY** ([PidTagRecordKey](pidtagrecordkey-canonical-property.md)) для каждого из этих объектов и их сравнения напрямую.
...
3. Убедитесь, что размер идентификатора записи задан правильно для соответствующего типа. В противном случае присвойте параметру _лпулресулт_ значение false и возвратите значение ошибки MAPI_E_UNKNOWN_ENTRYID. 
