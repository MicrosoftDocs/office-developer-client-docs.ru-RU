...
Указывает дату и время отправки объекта, связанного с собранием.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |LID_ATTENDEE_CRITICAL_CHANGE  <br/> |
|Набор свойств:  <br/> |PSETID_Meeting  <br/> |
|Длинный идентификатор (крышка):  <br/> |0x00000001  <br/> |
