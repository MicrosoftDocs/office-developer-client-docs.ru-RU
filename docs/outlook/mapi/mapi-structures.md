...
В следующих записях в алфавитном порядке описываются структуры MAPI. Для получения более подробных сведений также включены ссылки на другие публикации или другие разделы в этой документации.
...
|[�����������](notification.md) <br/> |[NOTIFKEY](notifkey.md) <br/> |
