...
В следующих алфавитных записях описываются структуры MAPI. Дополнительные сведения также включаются в перекрестные ссылки на другие публикации или другие темы в этой документации.
