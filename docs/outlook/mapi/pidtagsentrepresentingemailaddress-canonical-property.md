...
Содержит адрес электронной почты пользователя обмена сообщениями, представленного отправищиком.
...
Если отправляющий клиент установил эти свойства, эти свойства всегда должны оставаться без изменений. Если он не затенен, поставщик транспорта должен установить для него свойство **PR_SENDER_EMAIL_ADDRESS** ([PidTagSenderEmailAddress)](pidtagsenderemailaddress-canonical-property.md)в исходящие копии сообщения и оставить его ненастроенным для локальной копии.
