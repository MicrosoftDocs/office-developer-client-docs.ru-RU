...
Это свойство содержит true, если отправитель сообщения запрашивает подтверждение того, что система передачи сообщений отправила сообщение для доставки исходному получателю.
...
|Область:  <br/> |MAPI Non-transmittable  <br/> |
