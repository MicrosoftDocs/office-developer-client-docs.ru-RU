...
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_ЕМСМДБ_СЕКТИОН_УИД  <br/> |
...
Это свойство можно извлечь с помощью вызова метода [IMAPIProp::](imapiprop-getprops.md) PidTagExchangeProfileSectionId в **** после запроса для любого из следующих интерфейсов: 
...
Если объект не связан с Exchange, вызов возвращает **мапи_е_нот_фаунд**.
...
Устаревшая служба Exchange имеет свойство **пр_емсмдб_легаци** (0x3D18000B), для которого задано **значение true** в таблице службы сообщений. 
