...
Указывает часть кода страны для рабочего адреса контакта.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |диспидворкаддресскаунтрикоде  <br/> |
|Набор свойств:  <br/> |PSETID_Address  <br/> |
|Длинный идентификатор (крышка):  <br/> |0x000080DB  <br/> |
