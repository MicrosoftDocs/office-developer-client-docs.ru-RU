...
Указывает, что задача изначально была создана текущим пользователем или агентом пользователя, а не обработкой запроса задачи.
...
Клиент задает это свойство TRUE, когда пользователь создает задачу, и FALSE, когда задача назначена другим пользователем. Если это свойство остается неустановленным, предполагается значение TRUE.
