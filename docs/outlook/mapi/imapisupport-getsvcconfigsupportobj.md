...
> [out] Указатель на указатель на новый объект поддержки службы сообщений.
...
Метод **IMAPISupport::GetSvcConfigSupportObj** реализован для всех объектов поддержки. Поставщики услуг вызовите **GetSvcConfigSupportObj,** чтобы создать объект поддержки конфигурации, который будет передан функции точки входа службы сообщений. 
