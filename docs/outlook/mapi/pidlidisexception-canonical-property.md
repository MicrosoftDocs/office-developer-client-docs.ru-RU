...
Указывает, что объект, который представляет исключение (включая потерянный экземпляр).
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |LID_IS_EXCEPTION  <br/> |
|Набор свойств:  <br/> |PSETID_Meeting  <br/> |
|Длинный ИД (КРЫШКА):  <br/> |0x0000000A  <br/> |
|Тип данных:  <br/> |PT_BOOLEAN  <br/> |
|Область:  <br/> |Собрания  <br/> |
   
## <a name="remarks"></a>Примечания

Значение FALSE указывает, что объект, представляющий повторяющийся ряд или один экземпляр. Отсутствие этого свойства для любого объекта указывает на значение FALSE, за исключением внедренного сообщения исключения, которое предполагает значение TRUE.
