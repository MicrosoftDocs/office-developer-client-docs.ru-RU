 ...
 **Екстрактпропс** поддерживается только для объектов, открытых с флагом TNEF_DECODE для функции **опентнефстреам** или [опентнефстреамекс](opentnefstreamex.md) . 
