...
Значение этого свойства, если этот параметр указан, должны совпадать с значение свойства **PR_BUSINESS_HOME_PAGE** ([PidTagBusinessHomePage](pidtagbusinesshomepage-canonical-property.md)).
