...
Содержит название задания получателя.
...
Эти свойства обычно используются для указать официальное название задания получателя, например старший программист, а не профессиональный класс, например программист. Он обычно не используется для названий "суффикса", таких как Esq. или DDS.
  
Общие значения для этого свойства включают: управляющий директор, программист II, доцент и руководитель разработки. 
