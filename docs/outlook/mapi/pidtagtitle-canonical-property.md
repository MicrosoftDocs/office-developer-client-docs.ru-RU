...
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_ТИТЛЕ, ПР_ТИТЛЕ_А, ПР_ТИТЛЕ_В  <br/> |
...
Эти свойства предоставляют сведения о идентификации и доступе для получателя. Они определяются получателем и Организацией получателя. 
  
Эти свойства обычно используются для обозначения формального должности получателя, например, старший программист, а не класс для занятий, например программист. Обычно он не используется для названий "суффиксов", например ЕСК. или DDS.
  
Общие значения для этого свойства включают: Управление директором, программист II, сопоставление профессор и руководитель по разработке. 
