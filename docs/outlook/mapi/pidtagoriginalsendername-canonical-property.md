...
Содержит отображаемое имя отправителя первой версии сообщения, то есть сообщение перед пересылкой или ответом.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_ОРИГИНАЛ_СЕНДЕР_НАМЕ, ПР_ОРИГИНАЛ_СЕНДЕР_НАМЕ_А, ПР_ОРИГИНАЛ_СЕНДЕР_НАМЕ_В  <br/> |
