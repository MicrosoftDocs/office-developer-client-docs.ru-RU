...
Содержит **EntryID** для папки задач Outlook. 
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_ИПМ_ТАСК_ЕНТРИД  <br/> |
...
Это свойство считывается или записывается с помощью протокола объекта свойства и потока. Он считывается и записывается в папку "Входящие" или в корневую папку. Реализация должна использовать папку "Входящие", когда хранилище является основным пользователем обмена сообщениями, и при наличии у пользователя делегирования он должен использовать корневую папку.
