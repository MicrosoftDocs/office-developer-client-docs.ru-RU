...
Содержит TRUE, если отправитель разрешает автопродавку этого сообщения. 
...
Если автопередача запрещена или не назначен альтернативный получатель, следует сгенерить отчет о неделивстве. 
