...
Содержит значение TRUE, если отправитель разрешает автоматическую пересылку этого сообщения. 
...
Если автоматическая пересылка не разрешена или если не назначен альтернативный получатель, должен быть создан отчет о недоставке. 
