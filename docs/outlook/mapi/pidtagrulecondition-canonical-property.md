...
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_РУЛЕ_КОНДИТИОН  <br/> |
|Идентификатор:  <br/> |0x6679  <br/> |
|Тип данных:  <br/> |ПТ_СРЕСТРИКТИОН  <br/> |
...
|:-----|:-----|:-----|
|Импортпрокс. cpp  <br/> |Пропкопиморе, Хркопирестриктион  <br/> |В этих функциях показано, как выполнить синтаксический анализ свойства **пт_срестриктион** для копирования в другое свойство.  <br/> |
