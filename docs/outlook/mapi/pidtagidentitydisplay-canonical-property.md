...
Содержит отображаемого имени для удостоверения поставщика услуг, как определено в системе обмена сообщениями. 
...
Эти свойства отображаются не как свойства любого объекта, а только как столбец в таблице состояния. Это часть удостоверения поставщика услуг, который выдает строку таблицы состояния. Удостоверение поставщика обычно ссылается на его учетную запись на сервере, но может ссылаться на любое представление, определенное поставщиком в системе обмена сообщениями. 
  
Поставщик услуг, который предоставил любое из свойств удостоверений, должен предоставить все из них. Поставщики, принадлежащие к одной службе сообщений, должны иметь одинаковые значения для свойств удостоверения. 
