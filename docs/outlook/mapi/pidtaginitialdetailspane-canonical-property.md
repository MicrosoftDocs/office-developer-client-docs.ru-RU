...
Указывает страницу шаблона отображения для отображения в первую очередь.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_ИНИТИАЛ_ДЕТАИЛС_ПАНЕ  <br/> |
...
Он должен присутствовать во всех объектах адресной книги на сервере интерфейса поставщика услуг имен (NSPI), и его значение должно быть равно нулю (0). Он не должен определяться ни для каких объектов в автономной адресной книге.
