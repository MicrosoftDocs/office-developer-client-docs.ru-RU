...
Описывает свойства ид записи каталога.
...
> Номер версии DIR_ENTRYID **структуры.** Должен иметь CONTAB_VERSION. 
    
 **ulType**
  
> Integer representing the directory entry ID type. Это должно быть одно из следующих значений:
...
> GUID, идентифицирует объект для логотипа.
    
## <a name="remarks"></a>Примечания

Структуры DIR_ENTRYID  [CONTAB_ENTRYID](contab_entryid.md) идентичны, за исключением члена **ulType.** Содержимое члена **ulType** определяет, какая структура подходит для остальных полей. 
