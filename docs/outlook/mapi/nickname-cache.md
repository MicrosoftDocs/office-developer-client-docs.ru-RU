...
- Не записываете свойства типа ПТ_МВ_УНИКОДЕ и PR_MV_STRING8 в поток автозаполнения, который будет использоваться в Microsoft Outlook 2003. Эти свойства понятны только для Outlook 2007, Outlook 2010 и Outlook 2013.
