...
1. Вызывает функцию точки входа службы сообщений с параметром _улконтекст_ , равным MSG_SERVICE_DELETE перед удалением разделов профиля. Это позволяет службе выполнять любые задачи, связанные с определенной службой. 
