...
Содержит значение поля List-Unsubscribe MIME.
...
Чтобы создать List-Unsubscribe поля, клиенты должны установить для этих свойств нужное значение. Авторы MIME должны скопировать значение этих свойств в List-Unsubscribe загона.
