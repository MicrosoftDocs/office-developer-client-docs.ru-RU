...
Содержит закодированные типы данных (EI), которые применяются к передаемом сообщению для описания преобразований.
...
Среды X.400 используют это свойство как для отчетов о доставке, так и для отчетов о доставке.
