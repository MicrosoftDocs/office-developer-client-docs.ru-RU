...
Указывает идентификатор для родителя папки или элемента в магазине.
...
Поставщики магазинов могут указать значение для этого свойства для родителя папки или элемента, но между сеансами значение должно быть одинаковым. Поставщики магазинов используют это свойство для определения результатов поиска, возвращаемой из поисковой системы.
