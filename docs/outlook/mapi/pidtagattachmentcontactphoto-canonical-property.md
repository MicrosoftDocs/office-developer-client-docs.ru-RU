...
Указывает на наличие вложений фотографии контакта.
...
Значение этого свойства необходимо установить значение TRUE, и должны быть только одного вложения на того или иного объекта контакта.
