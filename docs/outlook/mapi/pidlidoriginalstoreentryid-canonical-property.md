...
Указывает ИД записи в хранилище делегатора.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidOrigStoreEid  <br/> |
|Набор свойств:  <br/> |PSETID_Appointment  <br/> |
|Длинный ИД (КРЫШКА):  <br/> |0x00008237  <br/> |
|Тип данных:  <br/> |PT_BINARY  <br/> |
|Область:  <br/> |Собрания  <br/> |
   
## <a name="remarks"></a>Примечания

Это свойство должно быть установлено для объектов собраний, созданных или обновленных делегатом.
