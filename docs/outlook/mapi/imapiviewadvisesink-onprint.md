...
Если задание печати включает несколько страниц, вы можете вызвать функцию **OnPrint** после печати каждой страницы. Установите _двпаженумбер_ на странице, которая печатается в данный момент, и _хрстатус_ на S_OK. После завершения задания печати вызовите функцию **OnPrint** с _двпаженумбер_ , установленной на последнюю отпечатанную страницу, а для _хрстатус_ задано значение S_FALSE. 
