...
Если запрос собрания представляет повторяющийся ряд или исключение, это значение поля CalendarType из свойства **dispidApptRecur.** В противном случае это свойство не установлено и считается 0. 
