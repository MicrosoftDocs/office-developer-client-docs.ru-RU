...
Эти свойства содержат сведения о оригинального источника скопированной запись.
  
Для nonread отчета эти свойства содержит копию отображаемое имя исходный получатель сообщения, для которого создается отчет. Если исходный получатель входит в список рассылки, отображаемое имя списка рассылки сохраняется для отчета.
  
Клиентское приложение может использовать эти свойства для предотвращения изменения или «спуфинг» записей, передав неизменными копию отображаемое имя для сравнения.
