...
Содержит отображаемую имя приложения журналов (например, MSWord) и обычно является атрибутом в свободной форме сообщения журнала, обычно строкой.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidLogType  <br/> |
|Набор свойств:  <br/> |PSETID_Log  <br/> |
|Длинный ИД (КРЫШКА):  <br/> |0x00008700  <br/> |
