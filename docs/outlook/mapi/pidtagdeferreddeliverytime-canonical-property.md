...
Содержит дату и время, когда отправитель сообщения хочет доставить сообщение. 
...
MAPI не выполняет отложенную доставку; это вариант системы обмена сообщениями для обработки отложенной доставки.
