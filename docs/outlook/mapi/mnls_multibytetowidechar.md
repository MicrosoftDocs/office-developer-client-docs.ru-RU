...
Эта функция имеет функцию **MultiByteToWideChar** . Для получения дополнительных сведений см [MultiByteToWideChar](https://msdn.microsoft.com/library/dd319072%28VS.85%29.aspx).
