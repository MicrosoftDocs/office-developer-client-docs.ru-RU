...
Эти свойства предназначены для использования в сочетании с доставкой в физическое место назначения, а не в электронный почтовый ящик, если получатель не должен присутствовать при доставке. В качестве примера можно привести номер телефона на листе факс-связи.
