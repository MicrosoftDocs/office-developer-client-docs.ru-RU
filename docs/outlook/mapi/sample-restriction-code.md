...
Этот код использует динамическое распределение и инициализацию; Существует возможность для размещения и инициализации статической также. Чтобы краткости проверки ошибок, должны выполняться следующие приложения для распределения вызовов не включено в образце. 
