...
Содержит массив указателей на информационные объекты формы. 
...
> Количество указателей в массиве, на которые указывает **член aFormInfo.** 
    
 **aFormInfo**
  
> Указатель на массив указателей на информационные объекты формы.
