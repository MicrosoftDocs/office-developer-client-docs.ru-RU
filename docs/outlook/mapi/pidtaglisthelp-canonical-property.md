...
Чтобы создать поле заголовка списка справки, клиентам необходимо задать для свойства **PR_LIST_HELP** или связанного свойства нужное значение. Модули записи MIME должны скопировать это значение в поле заголовка List – Help. 
...
|:-----|:-----|:-----|
|**PR_LIST_HELP** <br/> |List – Справка  <br/> |Список "X" — Справка  <br/> |
