...
Содержит значение поля многоцелевых расширений интернет-почты (MIME) List-Help.
...
Чтобы создать поле List-Help, клиенты должны установить  значение PR_LIST_HELP или связанного свойства с нужным значением. Авторы MIME должны скопировать это значение в поле List-Help загона. 
