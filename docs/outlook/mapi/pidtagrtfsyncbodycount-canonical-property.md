...
Функция [RTFSync](rtfsync.md) вычисляет количество символов в тексте, используя только те, которые считаются значимыми для сообщения. Например, некоторое белое пространство и другие игнорируемые символы не учитываются в графе. 
