...
---
# <a name="macros-related-to-structures"></a>Макрос, связанный со структурами

  
  
**Область применения**: Outlook 2013 | Outlook 2016 
  
В разделах описаны макрос, связанные со структурами MAPI. Дополнительные сведения также включаются в перекрестные ссылки на другие публикации или другие темы в этой документации. 
  
В следующей таблице перечислены макрос, связанные со структурами MAPI:
