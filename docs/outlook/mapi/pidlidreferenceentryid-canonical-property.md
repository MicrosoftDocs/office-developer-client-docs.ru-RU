...
Указывает идентификатор [EntryID](entryid.md) ссылки для контакта. 
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |Диспидреференцееид  <br/> |
...
Если это свойство задано, это свойство должно быть равно значению элемента **EntryID** контакта. 
