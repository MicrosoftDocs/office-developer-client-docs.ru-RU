...
Копирует одно значение в многоценном свойстве в одно значение того же типа. 
...
> [in] Указатель на [структуру SPropValue,](spropvalue.md) определяемую многоценным свойством. 
...
> [in] Номер экземпляра, то есть элемент массива, значения, копируется из структуры, заданной _параметром pvalMv._ 
