...
Указывает значение свойства **dispidBusyStatus** [(PidLidBusyStatus)](pidlidbusystatus-canonical-property.md)в календаре организатора при отправлении запроса на собрание или обновления собрания.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidIntendedBusyStatus  <br/> |
...
Допустимые значения этого свойства такие же, как и для свойства **dispidBusyStatus.**
