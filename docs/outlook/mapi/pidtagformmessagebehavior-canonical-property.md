...
Содержит true, если сообщение должно быть составлено в текущей папке. 
...
Значение FALSE указывает, что сообщение должно быть составлено как любое другое межличное сообщение, то есть в папке "Outbox". 
