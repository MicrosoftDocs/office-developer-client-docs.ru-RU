...
2. Затем выполните одно из следующих действий.
   ...
   - Вызовите метод [IMAPIProp::-PROPS](imapiprop-getprops.md) для каждой интересующей записи адресной книги со списком одного или нескольких извлекаемых свойств. 
