...
---
# <a name="pidlidfax1emailtype-canonical-property"></a>Каноническое свойство PidLidFax1EmailType

  
  
**Область применения**: Outlook 2013 | Outlook 2016 
  
Указывает тип электронной почты для факса в деловом адресе контакта.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidFax1EmailType  <br/> |
|Набор свойств:  <br/> |Псетид_аддресс  <br/> |
|Длинный идентификатор (крышка):  <br/> |0x000080B7  <br/> |
