...
Указывает битовую область, описываемую состояние объекта.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidApptStateFlags  <br/> |
|Набор свойств:  <br/> |PSETID_Appointment  <br/> |
|Длинный ИД (КРЫШКА):  <br/> |0x00008217  <br/> |
...
> Этот флаг указывает, что объект является объектом собрания или связанным с собранием объектом.
