...
Содержит список идентификаторов записей для альтернативных получателей, назначенных первоначальным получателем. 
...
Это свойство используется для автоматических сообщений. Она содержит [структуру FLATENTRYLIST](flatentrylist.md) альтернативных получателей. Если автопровождение не разрешено или не назначено альтернативного получателя, создается отчет о неделивстве. 
