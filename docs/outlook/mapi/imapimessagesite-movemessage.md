...
Реализация **мовемессаже** в средстве просмотра формы должна вызывать метод [Имапивиевконтекст:: активатенекст](imapiviewcontext-activatenext.md) , передающий флаг VCDIR_MOVE перед фактическим перемещением сообщения в новую папку. Чтобы получить структуру **Rect** , используемую окном формы, вызовите функцию Windows [жетвиндоврект](https://msdn.microsoft.com/library/ms633519) . 
