...
|Длинный ИД (КРЫШКА):  <br/> |0x00008514  <br/> |
|Тип данных:  <br/> |PT_BOOLEAN  <br/> |
|Область:  <br/> |Настройка времени запуска  <br/> |
   
## <a name="remarks"></a>Примечания

Это свойство имеет true, если вложения сообщения считаются скрытыми.
  
Он указывает, не имеет ли объект сообщения видимых вложений конечных пользователей. Это свойство может быть не заданной; В этом случае предполагается, что значение по умолчанию — FALSE.
