...
Указывает расстояние (в пикселях) от верхнего края экрана, где пользовательский интерфейс отображает заметку.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidNoteY  <br/> |
|Набор свойств:  <br/> |PSETID_Note  <br/> |
|Длинный ИД (КРЫШКА):  <br/> |0x00008B05  <br/> |
