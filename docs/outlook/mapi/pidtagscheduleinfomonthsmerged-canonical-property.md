...
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_СЧДИНФО_МОНСС_МЕРЖЕД  <br/> |
...
В это свойство не включены события типа сведений о занятости под вопросом. Синтаксис/формат и ограничения этого свойства такие же, как и в **пр_счдинфо_монсс_тентативе** ([PidTagScheduleInfoMonthsTentative](pidtagscheduleinfomonthstentative-canonical-property.md)), но ссылаются на встречи, помеченные как неработающие или занятые для связанного объекта Calendar. 
