...
Метод **IMAPITable:: експандров** расширяет категорию свернутой таблицы, добавляя конечные или нижние строки заголовков, принадлежащие к категории, в представление таблицы. В параметре _улровкаунт_ можно указать только число строк, возвращаемых в параметре _лппровс_ . Если для _улровкаунт_ задано значение больше нуля и одна или несколько строк возвращаются в наборе строк, на который указывает _лппровс_, то положение закладки BOOKMARK_CURRENT перемещается в строку сразу после последней строки в наборе строк.
  
Если для параметра _улровкаунт_ задано значение 0, в категорию добавляются строки заголовков из нуля или более низкого уровня, так как в категории отсутствуют строки заголовков конечных или нижних уровней, для позиции BOOKMARK_CURRENT задается строка, указанная с помощью _пбинстанцекэй_. 
