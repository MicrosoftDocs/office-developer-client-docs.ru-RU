...
Содержит количество игнорируемых символов, которые появляются после важных символов сообщения.
...
Это свойство является вспомогательным свойством RFT. Эти свойства используются функцией [RTFSync](rtfsync.md) и не предназначены для непосредственного использования клиентских приложений. 
