...
Вы можете использовать **куерипоситион** , чтобы разместить ползунок в полосе прокрутки. Например, в таблице, содержащей 100 строк, если **куерипоситион** возвращает значение 75 в параметре _лпулнумератор_ , 100 в параметре _лпулденоминатор_ и 75 в параметре _лпулров_ , вы можете разместить бегунок 3/4 в полосе прокрутки. 
