...
Указывает, должен ли клиент соблюдать значения свойств **dispidReminderPlaySound** ([PidLidReminderPlaySound)](pidlidreminderplaysound-canonical-property.md)и **dispidReminderFileParam** ( [PidLidReminderFileParameter).](pidlidreminderfileparameter-canonical-property.md)
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidReminderOverride  <br/> |
|Набор свойств:  <br/> |PSETID_Common  <br/> |
|Длинный ИД (КРЫШКА):  <br/> |0x0000851C  <br/> |
