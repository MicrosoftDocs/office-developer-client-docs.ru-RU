...
Задает список всех участников, кроме организатора, включая ресурсы и неотправленных участников.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |Диспидаллаттендисстринг  <br/> |
...
Значение для каждого участника — отображаемое имя участника. Отдельные записи должны отделяться точкой с запятой и пробелом. Это свойство не является обязательным.
