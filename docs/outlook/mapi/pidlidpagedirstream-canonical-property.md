...
Представляет сведения о страницах настраиваемой формы, связанных с сообщением.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidPageDirStream  <br/> |
|Набор свойств:  <br/> |PSETID_Common  <br/> |
|Длинный ИД (КРЫШКА):  <br/> |0x00008513  <br/> |
