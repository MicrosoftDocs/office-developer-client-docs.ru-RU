...
Содержит идентификатор агента передачи сообщений (MTA), отправившего сообщение.
...
Это свойство, если задано, доступно для отправленных сообщений в папке "Отправленные".
