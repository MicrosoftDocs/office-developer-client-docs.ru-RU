...
- [Выбор API или технологий для разработки решений для Outlook 2013](https://msdn.microsoft.com/library/jj900714.aspx)
