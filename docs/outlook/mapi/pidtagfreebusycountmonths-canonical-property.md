...
Содержит значение для вычисления даты начала и окончания диапазона данных о занятости, публикуемого в общедоступных папках.
...
Значение этого свойства должно быть больше или равно 0 и меньше или равно 36. Это свойство не является обязательной.
