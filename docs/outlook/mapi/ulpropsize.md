...
> [in] Указатель на [структуру SPropValue,](spropvalue.md) определяющей свойство, для измерения. 
...
Функция **UlPropSize** возвращает размер в bytes значения свойства для указанного свойства. Он игнорирует размер оставшейся части **структуры SPropValue.** 
