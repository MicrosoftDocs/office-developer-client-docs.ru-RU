...
Содержит значение, которое должно быть равно нулю (0).
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |PR_SCHDINFO_RESOURCE_TYPE  <br/> |
...
Для этого свойства должно быть задано значение ноль (0) при отправке и игнорировании при получении.
