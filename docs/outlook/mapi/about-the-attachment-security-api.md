...
API безопасности вложений позволяет Outlook решения, чтобы узнать, считается ли вложение небезопасным по Outlook и блокируется для просмотра и индексации. Он предоставляет следующие определения и интерфейс.
