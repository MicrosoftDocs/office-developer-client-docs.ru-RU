...
При отправке приглашений на собрание в приложениях планирования следует задать как **PR_START_DATE** ([PidTagStartDate](pidtagstartdate-canonical-property.md)), так и это свойство. 
