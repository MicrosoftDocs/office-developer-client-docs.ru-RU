---
title: Каноническое свойство PidLidSharingConfigurationUrl
manager: soliver
ms.date: 03/09/2015
...
|||
|:-----|:-----|
|Связанные свойства:  <br/> |Диспидшарингконфигурл  <br/> |
|Набор свойств:  <br/> |Псетид_шаринг  <br/> |
|Длинный идентификатор (крышка):  <br/> |0x00008A24  <br/> |
|Тип данных:  <br/> |PT_UNICODE  <br/> |
|Область:  <br/> |Общий доступ  <br/> |
   
## <a name="remarks"></a>Примечания

Значение этого свойства должно быть строкой нулевой длины. 
