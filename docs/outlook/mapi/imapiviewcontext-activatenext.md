...
> возврата Флаги состояния, которые предоставляют сведения о сообщении, которое необходимо активировать. Допустимые параметры флагов:
  ...
  - ВКДИР_КАТЕГОРИ: средство просмотра должно активировать сообщение в другой категории представления. Активируемое сообщение: 
        
    - Первое сообщение в категории "в следующем представлении", если этот флаг имеет значение **или**ED с вкдир_некст. 
        
    - Последнее сообщение в предыдущей категории представления, если этот флаг имеет значение **или**ED с вкдир_прев, а предыдущая категория развернута. 
        
    - Первое сообщение в предыдущей категории представления, если этот флаг имеет значение **или**ED с вкдир_прев, а предыдущая категория не развернута. В этом случае предыдущая категория перестанет автоматически расширяться. 
        
  - ВКДИР_ДЕЛЕТЕ: средство просмотра должно активировать следующее или предыдущее сообщение, так как текущее сообщение было удалено. 
        
  - ВКДИР_МОВЕ: средство просмотра должно активировать следующее или предыдущее сообщение, так как текущее сообщение было перемещено. 
        
  - ВКДИР_НЕКСТ: средство просмотра должно активировать следующее сообщение в порядке просмотра. 
        
  - ВКДИР_ПРЕВ: средство просмотра должно активировать предыдущее сообщение в порядке просмотра. 
        
  - ВКДИР_УНРЕАД: средство просмотра должно активировать следующее или предыдущее непрочитанное сообщение в порядке просмотра. 
