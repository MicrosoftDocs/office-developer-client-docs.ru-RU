...
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_ЕМС_АБ_СЕРВЕР, ПР_ЕМС_АБ_СЕРВЕР_А, ПР_ЕМС_АБ_СЕРВЕР_В  <br/> |
...
Это свойство имеет тип свойства reseted to **пт_уникоде** , если он скомпилирован с `UNICODE` символом на платформе Юникода, и для **PT_STRING8** , когда он не компилируется вместе с `UNICODE` символом. 
