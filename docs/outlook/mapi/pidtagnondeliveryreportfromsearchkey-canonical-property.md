...
Если значение на отчет о недоставке, обозначает ключ поиска неудачных отправки-под учетной записью пользователя.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |PR_NDR_FROM_SEARCH_KEY  <br/> |
|Идентификатор:  <br/> |0x6906  <br/> |
