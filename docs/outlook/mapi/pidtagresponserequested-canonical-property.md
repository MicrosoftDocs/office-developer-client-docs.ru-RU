...
Содержит TRUE, если отправитель сообщения хочет получить ответ на запрос собрания.
...
Это свойство используется для запросов на собрания. Получающие клиентские приложения должны побудить пользователя принять или отклоть запрос, а затем отправить этот ответ обратно отправителю.
