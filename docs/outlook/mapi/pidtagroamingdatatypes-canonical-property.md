...
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_РОАМИНГ_ДАТАТИПЕС  <br/> |
...
|0x00000004  <br/> |Указывает, что сообщение ФАИ должно содержать XML-поток, хранящийся в свойстве **пр_роаминг_ксмлстреам** ([PidTagRoamingXmlStream](pidtagroamingxmlstream-canonical-property.md)), использующем произвольную XML-схему.  <br/> |
