...
Сообщает зрителю формы, что текущее сообщение в форме сохранено.
...
Объект формы вызывает **метод IMAPIViewAdviseSink::OnSaved** после успешного сэкономленного текущего сообщения в форме. Это позволяет зрителям обновлять окна для отражения изменений в сообщении. 
