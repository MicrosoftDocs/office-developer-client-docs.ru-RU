...
Это свойство вычисляется в хранилищах сообщений для всех папок и сообщений.
  
Для корневой папки магазина сообщений это свойство содержит собственный идентификатор записи папки.
...
> Указывает метод доставки данных автономной адресной книги (OAB) с сервера на клиент.
