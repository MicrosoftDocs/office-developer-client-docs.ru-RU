...
Содержит идентификатор папки, содержащей папку или сообщение.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_ПАРЕНТ_ЕНТРИД  <br/> |
...
Для корневой папки хранилища сообщений это свойство содержит собственный идентификатор записи.
  
 **Пр_парент_дисплай** ([PidTagParentDisplay](pidtagparentdisplay-canonical-property.md)), и это свойство не связано друг с другом. Они относятся исключительно к разным контекстам.
