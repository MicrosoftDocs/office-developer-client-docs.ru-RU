...
Содержит URL-адрес протокола передачи файлов (FTP) контакта. FTP — это протокол, используемый для передачи данных, как указано в [RFC959].
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |PR_FTP_SITE, PR_FTP_SITE_A, PR_FTP_SITE_W  <br/> |
|Идентификатор:  <br/> |0x3A4C  <br/> |
