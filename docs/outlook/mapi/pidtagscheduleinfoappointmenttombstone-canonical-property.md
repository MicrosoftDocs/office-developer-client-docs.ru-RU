...
|глобалобжектид  <br/> |Значение свойства **LID_GLOBAL_OBJID** ([PidLidGlobalObjectId](pidlidglobalobjectid-canonical-property.md)) собрания, представляющего эту запись.  <br/> |
