...
Эти свойства указывают, какая версия дизайна в настоящее время действует для формы. Версия определяется и поддерживается конструктором формы и не обязательно связана с любой версией компонента MAPI. 
