...
6. ВыЗовите метод [итнеф:: опентагжедбоди](itnef-opentaggedbody.md) с установленными флагами МАПИ_КРЕАТЕ и мапи_модифи. Этот вызов Удаляет теги вложений из текста сообщения и преобразует их в сведения о расположении вложения в сообщении MAPI. 
