...
Содержит массив структур [LARGE_INTEGER](https://go.microsoft.com/fwlink/?LinkId=132130) , которые используются для описания свойства типа PT_MV_I8. 
...
> Указатель на массив структур **LARGE_INTEGER** , содержащих целочисленные значения. 
