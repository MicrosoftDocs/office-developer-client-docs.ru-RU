...
Содержит массив [LARGE_INTEGER,](https://go.microsoft.com/fwlink/?LinkId=132130) используемых для описания свойства типа PT_MV_I8. 
...
> Указатель на массив **LARGE_INTEGER,** которые удерживают целый ряд значений. 
