...
|Длинный ИД (КРЫШКА):  <br/> |0x00008544  <br/> |
|Тип данных:  <br/> |PT_MV_LONG  <br/> |
|Область:  <br/> |Общие сообщения  <br/> |
   
## <a name="remarks"></a>Примечания

Это свойство необходимо, только если задано свойство **dispidNonSendableCC.** Число значений в этом свойстве должно быть равно числу значений **в dispidNonSendableCC.** Каждое PT_LONG в этом свойстве соответствует участнику в свойстве **dispidNonSendableCC** с одинаковым индексом. 
