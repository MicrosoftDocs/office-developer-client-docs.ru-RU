...
Вычисляет количество bytes в существующей структуре [SMessageClassArray,](smessageclassarray.md) которая содержит определенное количество указателей строк для классов сообщений. 
...
> Количество указателей для классов сообщений, включенных в существующий **SMessageClassArray.**
