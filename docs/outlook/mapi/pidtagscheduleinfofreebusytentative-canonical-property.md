...
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_СЧДИНФО_ФРИБУСИ_ТЕНТАТИВЕ  <br/> |
...
Это свойство имеет столько же значений, сколько значений в **пр_счдинфо_монсс_тентативе** ([PidTagScheduleInfoMonthsTentative](pidtagscheduleinfomonthstentative-canonical-property.md)). Каждое двоичное значение соответствует месяцу и соответствует значению в том же индексе в **пр_счдинфо_монсс_тентативе**. Двоичные значения сортируются в том же порядке, что и значения в **пр_счдинфо_монсс_тентативе**.
