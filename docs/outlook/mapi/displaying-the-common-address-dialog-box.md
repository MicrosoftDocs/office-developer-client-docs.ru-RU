...
2. Создайте ограничение свойства, использующее РЕЛОП_ЕК для элемента **релоп** структуры [спропертирестриктион](spropertyrestriction.md) , и либо **пр_ентрид** ([PidTagEntryId](pidtagentryid-canonical-property.md)), либо **пр_аб_провидер_ид** ([PidTagAbProviderId](pidtagabproviderid-canonical-property.md)), как элемент **улпроптаг** . Если вы используете **пр_ентрид**, передайте идентификатор записи, полученный из **жетпаб**. Если вы используете **пр_аб_провидер_ид**, передайте значение, включенное в мспаб. H файл заголовка. **Пр_аб_провидер_ид** — это уникальный идентификатор личной адресной книги, разработанной MAPI. 
