...
Предоставляет метод для входа в объект поставщика адресной книги и метод, чтобы сделать объект поставщика адресной книги недействительным.
  
|||
|:-----|:-----|
|Файл заголовка:  <br/> |Mapispi.h  <br/> |
|Выставим:  <br/> |Объекты поставщиков адресных книг  <br/> |
