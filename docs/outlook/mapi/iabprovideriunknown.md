...
Предоставляет метод входа в объект поставщика адресной книги и метод для недействительных объектов поставщика адресной книги.
  
|||
|:-----|:-----|
|Файл заголовка:  <br/> |Mapispi.h  <br/> |
|Подвергается:  <br/> |Объекты поставщиков адресных книг  <br/> |
...
|[Shutdown](iabprovider-shutdown.md) <br/> |Отмена подключения к активному сеансу.  <br/> |
