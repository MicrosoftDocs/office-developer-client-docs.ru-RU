...
Это свойство является временным значением, допустимым только для жизни объекта, который является владельцем таблицы. Он отображается в качестве столбца таблицы, но не сохраняется.
