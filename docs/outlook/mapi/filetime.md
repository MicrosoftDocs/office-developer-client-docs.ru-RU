...
Определение структуры **fileTime** находится в справочнике программиста _Win32_ и в файле заголовка MAPI MAPIDEFS. h. MAPI определяет структуру условно, чтобы убедиться, что она определена, когда определение Win32 недоступно. 
