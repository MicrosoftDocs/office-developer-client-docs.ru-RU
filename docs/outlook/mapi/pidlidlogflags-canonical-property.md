...
Содержит метаданные журнала.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidLogFlags  <br/> |
|Набор свойств:  <br/> |PSETID_Log  <br/> |
|Длинный ИД (КРЫШКА):  <br/> |0x0000870C  <br/> |
|Тип данных:  <br/> |PT_LONG  <br/> |
|Область:  <br/> |Журнал  <br/> |
   
## <a name="remarks"></a>Примечания

Бит, содержащий метаданные журнала, должен иметь значение 0 или 0x40000000.
