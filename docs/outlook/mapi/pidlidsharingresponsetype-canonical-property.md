...
Указывает тип ответа, с которым ответил получатель запроса на общий доступ. Это свойство сообщения общего доступа.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidSharingResponseType  <br/> |
|Набор свойств:  <br/> |PSETID_Sharing  <br/> |
|Длинный ИД (КРЫШКА):  <br/> |0x00008A27  <br/> |
