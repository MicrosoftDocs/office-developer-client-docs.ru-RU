...
- Если был передан Неизвестный номер команды, возвращается МАПИ_Е_НО_СУППОРТ. В противном случае возвращает результат на основе успешности или сбоя любой выполняемой команды.
...
Немодальные команды можно сделать модальными глаголами, наведя _лпвиевконтекст_ на реализацию контекста представления, которая ВОЗВРАЩАЕТ флаг вкстатус_модал из метода [Имапивиевконтекст:: жетвиевстатус](imapiviewcontext-getviewstatus.md) . 
