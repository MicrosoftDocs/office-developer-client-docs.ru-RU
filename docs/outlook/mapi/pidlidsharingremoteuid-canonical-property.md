...
Для этого свойства должно быть задано шестнадцатеричное строковое представление значения свойства ПР_ЕНТРИД ([PidTagEntryId](pidtagentryid-canonical-property.md)) для общей папки. Это свойство сообщения о совместном доступе.
