...
---
# <a name="pidlidfax1richtextformat-canonical-property"></a>Каноническое свойство PidLidFax1RichTextFormat

  
  
**Область применения**: Outlook 2013 | Outlook 2016 
  
Задает формат форматированного текста для факса в деловом адресе контакта.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidFax1RTF  <br/> |
|Набор свойств:  <br/> |Псетид_аддресс  <br/> |
|Длинный идентификатор (крышка):  <br/> |0x000080B6  <br/> |
