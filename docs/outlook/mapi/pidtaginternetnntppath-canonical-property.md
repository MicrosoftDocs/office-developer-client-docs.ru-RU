...
Соповедет с загоером пути MIME.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |PR_INTERNET_NNTP_PATH, PR_INTERNET_NNTP_PATH_A, PR_INTERNET_NNTP_PATH_W  <br/> |
|Идентификатор:  <br/> |0x1038  <br/> |
