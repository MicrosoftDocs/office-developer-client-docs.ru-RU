...
---
# <a name="pidtagpreferredbyname-canonical-property"></a>Каноническое свойство PidTagPreferredByName

  
  
**Область применения**: Outlook 2013 | Outlook 2016 
  
Содержит имя, с которым предпочитается вызывать получателя.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_ПРЕФЕРРЕД_БИ_НАМЕ, ПР_ПРЕФЕРРЕД_БИ_НАМЕ_А, ПР_ПРЕФЕРРЕД_БИ_НАМЕ_В  <br/> |
|Идентификатор:  <br/> |0x3A47  <br/> |
