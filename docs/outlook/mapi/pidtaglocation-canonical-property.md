...
Содержит расположение получателя в формате, который полезен организации получателя. 
...
Содержимое определяется потребностями организации получателя. Например, некоторые организации могут идентифицировать пользователей сообщений, указав номер здания и номер офиса. 
