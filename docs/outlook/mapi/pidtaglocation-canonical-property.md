...
Содержит расположение получателя в формате, который будет полезно для организации получателя. 
...
Содержимое определены требований организации получателя. Например в некоторых организациях может идентификации пользователей обмена мгновенными сообщениями путем указания номера построения и адрес офиса. 
