...
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_ЛОКАТИОН, ПР_ЛОКАТИОН_А, ПР_ЛОКАТИОН_В  <br/> |
...
Содержимое определяется потребностями организации получателя. Например, некоторые организации могут определять пользователей для обмена сообщениями, указывая номер здания и номер Office. 
