...
Свойство **dispidSharingFlavor** должно быть одним из следующих значений. 
  
|**Значение**|**Тип сообщения общего доступа**|
|:-----|:-----|
|0x00020310  <br/> |Приглашение к совместному доступу для специальной папки.  <br/> |
|0x00000310  <br/> |Приглашение к совместному доступу для папки, которая не является специальной папкой.  <br/> |
...
|0x00025100  <br/> |Ответ на общий доступ, который отказано в запросе.  <br/> |
|0x00023310  <br/> |Ответ общего доступа, который принимает запрос (также тип приглашения общего доступа).  <br/> |
