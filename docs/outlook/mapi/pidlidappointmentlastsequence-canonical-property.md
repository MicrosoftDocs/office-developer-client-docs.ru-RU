...
Указывает организатору последний порядковый номер, отправленный любому участнику.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |диспидапптластсекуенце  <br/> |
|Набор свойств:  <br/> |PSETID_Appointment  <br/> |
|Длинный идентификатор (крышка):  <br/> |0x00008203  <br/> |
|Тип данных:  <br/> |PT_LONG  <br/> |
|Область:  <br/> |Собрания  <br/> |
   
## <a name="remarks"></a>Примечания

Это свойство не имеет смысла для участника.
