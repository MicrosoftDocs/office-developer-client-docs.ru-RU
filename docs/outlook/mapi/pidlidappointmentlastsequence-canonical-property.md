...
Указывает организатору последний номер последовательности, отправленный любому участнику.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidApptLastSequence  <br/> |
...
Это свойство не имеет значения для участника.
