...
Представляет значение свойства **диспидшарингремотенаме** ([PidLidSharingRemoteName](pidlidsharingremotename-canonical-property.md)).
  
|||
|:-----|:-----|
|Понятные имена:  <br/> |Нет  <br/> |
|Набор свойств:  <br/> |ПС_ИНТЕРНЕТ_ХЕАДЕРС  <br/> |
|Имя свойства:  <br/> |X – общий доступ — удаленное имя  <br/> |
