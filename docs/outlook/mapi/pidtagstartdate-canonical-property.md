...
Содержит даты и время начала встречи, управляемые приложением планирования.
...
Приложения планирования должны устанавливать как это свойство, так и **PR_END_DATE** ([PidTagEndDate)](pidtagenddate-canonical-property.md)при отправке запросов на собрание.
