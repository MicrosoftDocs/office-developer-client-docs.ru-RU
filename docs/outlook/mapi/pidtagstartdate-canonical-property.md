...
Содержит дату и время начала встречи, управляемой приложением планирования.
...
При отправке приглашений на собрание приложения планирования должны задать свойства и свойства **PR_END_DATE** ([PidTagEndDate](pidtagenddate-canonical-property.md)).
