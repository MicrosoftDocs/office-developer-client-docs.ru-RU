...
Содержит почтовый индекс для домашнего адреса пользователя.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |PR_HOME_ADDRESS_POSTAL_CODE, PR_HOME_ADDRESS_POSTAL_CODE_A PR_HOME_ADDRESS_POSTAL_CODE_W  <br/> |
|Идентификатор:  <br/> |0x3A5B  <br/> |
