...
|:-----|:-----|
|Метаданные  <br/> |SP4  <br/> |
|Основной номер версии  <br/> |SP4  <br/> |
|Дополнительный номер версии  <br/> |SP4  <br/> |
|Набор строк  <br/> |Переменная  <br/> |
|Количество байтов дополнительных сведений EI  <br/> |SP4  <br/> |
|Дополнительные сведения  <br/> |EI  <br/> |
|Метаданные  <br/> |8,5  <br/> |
...
|**Данные значения**|**Количество байтов**|
|:-----|:-----|
|Тег свойства  <br/> |SP4  <br/> |
|Зарезервированные данные  <br/> |SP4  <br/> |
...
|**Данные значения**|**Количество байтов**|
|:-----|:-----|
|Байты, интерпретируемые как GUID  <br/> |столбцов  <br/> |
|||
...
|**Данные значения**|**Количество байтов**|
|:-----|:-----|
|Количество двоичных массивов X  <br/> |SP4  <br/> |
...
|**Данные значения**|**Количество байтов**|
|:-----|:-----|
|Количество строк ANSI X  <br/> |SP4  <br/> |
...
|**Данные значения**|**Количество байтов**|
|:-----|:-----|
|Количество строк Юникода X  <br/> |SP4  <br/> |
