...
---
# <a name="about-mapi-urls-for-notification-based-indexing"></a>О MAPI URL-адреса на основе уведомлений индексирования
...
|Часть | Описание|
|:----|:-----------|  
|*ИД БЕЗОПАСНОСТИ* |Идентификатор безопасности для текущего пользователя.| 
