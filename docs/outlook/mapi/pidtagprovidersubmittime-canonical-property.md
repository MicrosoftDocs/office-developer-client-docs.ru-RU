...
Содержит дату и время, когда поставщик транспорта передал сообщение в его систему обмена сообщениями.
...
Это свойство задает исходяющий поставщик транспорта при отправлении сообщения.
  
Это свойство соответствует атрибуту отправки X.400 для каждого сообщения. 
