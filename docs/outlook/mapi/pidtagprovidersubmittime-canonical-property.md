...
Содержит дату и время передачи сообщения поставщиком транспорта в свою систему обмена сообщениями.
...
Это свойство задается поставщиком исходяющих транспортных данных во время отправленного сообщения.
