...
Это свойство вычисляется всеми поставщиками услуг. Он содержит [структуру MAPIUID,](mapiuid.md) связанную с поставщиком и обычно жестко заданная поставщиком. Как правило, оно используется клиентом, которое заинтересовано только в контейнерах адресной книги, предоставленных определенным поставщиком. 
