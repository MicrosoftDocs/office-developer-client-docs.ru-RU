...
Указывает, что пользователь не включил текст в текст ответа на приглашение на собрание.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |LID_IS_SILENT  <br/> |
|Набор свойств:  <br/> |PSETID_Meeting  <br/> |
|Длинный идентификатор (крышка):  <br/> |0x00000004  <br/> |
