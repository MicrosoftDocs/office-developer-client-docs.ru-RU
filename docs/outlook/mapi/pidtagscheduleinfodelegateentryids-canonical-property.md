...
Содержит **идентификаторами EntryID** делегатов. 
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_СЧДИНФО_ДЕЛЕГАТЕ_ЕНТРИДС  <br/> |
...
Каждая запись должна содержать значение свойства **пр_ентрид** ([PidTagEntryId](pidtagentryid-canonical-property.md)) каждой записи адресной книги делегата. Это свойство должно быть задано в объекте сведений о делегате.
