...
Каждая запись должна содержать значение свойства **PR_ENTRYID** ([PidTagEntryId)](pidtagentryid-canonical-property.md)записи адресной книги каждого делегата. Это свойство должно быть установлено в объекте делегирования информации.
