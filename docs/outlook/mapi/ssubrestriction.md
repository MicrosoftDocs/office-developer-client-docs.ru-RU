...
Если реализация не поддерживает ограничения для вложенных объектов, она возвращает МАПИ_Е_ТУ_КОМПЛЕКС из методов [IMAPITable:: restrict](imapitable-restrict.md) или [IMAPITable:: FindRow](imapitable-findrow.md) . 
