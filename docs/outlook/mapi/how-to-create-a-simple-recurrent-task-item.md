...
2. Откройте папку Tasks в хранилище сообщений. Дополнительные сведения см **PR_IPM_TASK_ENTRYID** ([PidTagIpmTaskEntryId](pidtagipmtaskentryid-canonical-property.md)).
