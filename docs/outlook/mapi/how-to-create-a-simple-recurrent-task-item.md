...
<span data-ttu-id="d01d7-137">Ниже приведен полный листинг `AddTask` функции.</span><span class="sxs-lookup"><span data-stu-id="d01d7-137">The following is the complete listing of the  `AddTask` function.</span></span> 
