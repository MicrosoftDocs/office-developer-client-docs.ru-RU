...
Содержит необязательный текст для отчета, генерируемого системой обмена сообщениями.
...
Обычно текст, содержащийся в этих свойствах, создается в ответ на отчет о доставке или неделивстве или отчет о прочтениях, полученный из системы обмена сообщениями, но сам по себе не является текстом, который был передан через эту систему. 
