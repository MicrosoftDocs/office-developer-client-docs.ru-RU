...
Содержит идентификатор записи контейнера адресной книги, который будет использовать в качестве личной адресной книги. 
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |PR_AB_DEFAULT_PAB  <br/> |
|Идентификатор:  <br/> |0x3D07  <br/> |
