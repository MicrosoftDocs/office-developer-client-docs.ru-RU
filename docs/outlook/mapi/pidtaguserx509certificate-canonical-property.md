...
Содержит сертификаты безопасности X.509 версии 3 для пользователя системы обмена сообщениями. 
...
Это свойство используется приложениями, которые используют безопасность с помощью открытого ключа. Он содержит двоичное представление одного или более сертификатов безопасности X.509 версии 3. 
  
Различные приложения и клиенты могут использовать это свойство для собственных сертификатов безопасности. Двоичный формат данных X.509 может отличаться в зависимости от поставщика. 
