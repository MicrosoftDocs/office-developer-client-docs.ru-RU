...
Указывает отображаемое имя третьего адреса электронной почты, которое можно прочитать.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidEmail3DisplayName  <br/> |
|Набор свойств:  <br/> |PSETID_Address  <br/> |
|Длинный ИД (КРЫШКА):  <br/> |0x000080A0  <br/> |
