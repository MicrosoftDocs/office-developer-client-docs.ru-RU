...
Содержит количество игнорируемых символов, которые отображаются перед значительными символами сообщения.
...
Количество символов префикса не включает пробел.
  
Это свойство является вспомогательным свойством RTF. Вспомогательные свойства RTF используются функцией [RTFSync](rtfsync.md) и не предназначены для непосредственного использования клиентских приложений. 
