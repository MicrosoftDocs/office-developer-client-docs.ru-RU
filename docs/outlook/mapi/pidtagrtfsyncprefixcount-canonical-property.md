...
Количество символов префикса не включает в себя белое пространство.
  
Это свойство является вспомогательным свойством Rich Text Format (RTF). Вспомогательные свойства RTF используются функцией [RTFSync](rtfsync.md) и не предназначены для непосредственного использования клиентских приложений. 
