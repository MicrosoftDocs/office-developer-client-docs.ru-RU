...
Содержит UID, который идентифицирует этот сеанс книги контактных адресов.
...
Если настроено несколько адресных книг контактов, это свойство должно быть заданной для каждого из них. 
