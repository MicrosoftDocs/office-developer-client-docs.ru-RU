...
Содержит строку и операцию, выполняемую в этой строке в таблице с помощью [интерфейса IExchangeModifyTable.](iexchangemodifytableiunknown.md) 
...
> Одна из следующих операций, выполняемая в данных: 
  ...
  - ROW_EMPTY. Не добавляйте данные строки в таблицу. (Строка пустая.)
...
> Массив структур [SPropValue,](spropvalue.md) представляющих значения столбцов, которые будут вставлены в таблицу. 
