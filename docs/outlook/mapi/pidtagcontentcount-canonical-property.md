...
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_КОНТЕНТ_КАУНТ  <br/> |
...
Число, которое хранится в этом свойстве, не включает связанные записи в папке. **Пр_контент_унреад** ([PidTagContentUnreadCount](pidtagcontentunreadcount-canonical-property.md)) содержит количество непрочитанных сообщений для папки. Клиентское приложение может читать, но не изменять это свойство и **пр_контент_унреад**. 
