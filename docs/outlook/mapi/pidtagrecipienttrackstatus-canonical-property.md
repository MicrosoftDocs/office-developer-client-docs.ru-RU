...
Указывает состояние ответа, возвращенного участниками.
...
Если это значение не установлено, его следует считать respNone. В противном случае он должен быть одним из следующих:
...
|respTentative  <br/> |0x00000002  <br/> |Это значение на объекте собрания участника указывает, что участник предварительно принял объект запроса собрания.  <br/> |
|respAccepted  <br/> |0x00000003  <br/> |Это значение на объекте собрания участника указывает, что участник принял объект запроса собрания.  <br/> |
|respDeclined  <br/> |0x00000004  <br/> |Это значение на объекте собрания участника указывает, что участник отклонил объект запроса собрания.  <br/> |
