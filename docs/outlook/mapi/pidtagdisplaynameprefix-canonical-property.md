...
Содержит префикс отображаемого имени (например, промахов, Mr., Mrs.) для пользователя обмена сообщениями. 
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_ДИСПЛАЙ_НАМЕ_ПРЕФИКС, ПР_ДИСПЛАЙ_НАМЕ_ПРЕФИКС_А, ПР_ДИСПЛАЙ_НАМЕ_ПРЕФИКС_В  <br/> |
