...
Указывает немногое поле, которое описывает вспомогательное состояние объекта.
...
> Этот флаг в запросе собрания указывает на то, что клиент или сервер должны отправить ответ собрания организатору, когда будет выбран ответ.
    
F (auxApptFlagForwarded, 0x00000004)
  
> Этот флаг в запросе собрания указывает, что он был переададант (в том числе переад. организатором), а не приглашение от организатора.
