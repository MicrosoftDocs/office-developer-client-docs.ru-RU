...
Указывает битовое поле, которое описывает вспомогательное состояние объекта.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidApptAuxFlags  <br/> |
|Набор свойств:  <br/> |PSETID_Appointment  <br/> |
|Длинный ИД (КРЫШКА):  <br/> |0x00008207  <br/> |
...
> Этот флаг указывает, что объект календаря был скопирован из другой папки календаря.
    
R (auxApptFlagForceMtgResponse, 0x00000002)
  
> Этот флаг в запросе на собрание указывает, что клиент или сервер должны отправить ответ на собрание организатору при его выборе.
    
F (auxApptFlagForwarded, 0x00000004)
  
> Этот флаг в приглашении на собрание указывает, что он был переадован (в том числе перенаададовано организатором), а не является приглашением от организатора.
