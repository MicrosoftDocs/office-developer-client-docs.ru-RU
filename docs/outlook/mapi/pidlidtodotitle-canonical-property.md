...
При пометке объекта сообщения, если свойство не существует, клиент должен записать значение **PR_NORMALIZED_SUBJECT** ([PidTagNormalizedSubject](pidtagnormalizedsubject-canonical-property.md)) в это свойство.
  
В объединенном списке дел, если это свойство не существует, клиент должен заменить значение свойства **PR_NORMALIZED_SUBJECT** при отображении этого свойства в списке дел. 
