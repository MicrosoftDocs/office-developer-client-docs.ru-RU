...
|Длинный ИД (КРЫШКА):  <br/> |0x00008A17  <br/> |
...
|**Значение**|**Сценарий**|
|:-----|:-----|
|0x00040290  <br/> |Этот объект Сообщения общего доступа относится к специальной папке.  <br/> |
|0x000402B0  <br/> |Этот объект сообщения общего доступа не относится к специальной папке.  <br/> |
