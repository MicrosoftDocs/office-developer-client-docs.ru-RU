...
Имена файлов в списке, содержащихся в этих свойствах, удаляются с компьютера при использовании панели управления для удаления службы сообщений. Не включай в список ни один DLL, который поддерживает несколько служб сообщений, или дополнительные службы сообщений могут быть случайно удалены.
  
MAPI работает только с именами файлов и другими строками, переданными ему, в наборе символов ANSI. Приложения, которые используют имена файлов в наборе символов OEM, перед вызовом MAPI должны преобразовать их в ANSI.
