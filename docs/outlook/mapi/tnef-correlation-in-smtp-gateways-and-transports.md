...
Значение заголовка MessageID исходящего сообщения копируется в свойство **пр_тнеф_коррелатион_кэй** ([PidTagTnefCorrelationKey](pidtagtnefcorrelationkey-canonical-property.md)) и кодируется в атрибут [аттмапипропс](attmapiprops.md) потока TNEF. Обратите внимание, что **пр_тнеф_коррелатион_кэй** является двоичным свойством, а MessageId — строкой; нулевой признак должен быть включен в копию и в сравнении. 
