...
Содержит произвольный поток XML.
...
Это свойство содержит произвольный поток данных XML. Другие свойства в сообщении могут подразумевать определенные схемы для использования в этом свойстве.
