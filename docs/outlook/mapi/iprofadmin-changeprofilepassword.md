...
> Имя профиля и пароль имеют формат Юникод. Если флаг MAPI_UNICODE не установлен, эти строки представлены в формате ANSI.
    
## <a name="return-value"></a>Возвращаемое значение

S_OK 
  
> При вызове этого метода он возвратит S_OK. Однако никакие действия не выполняются.
