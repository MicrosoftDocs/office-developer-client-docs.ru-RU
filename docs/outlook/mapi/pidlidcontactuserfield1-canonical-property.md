...
Указывает первое поле контакта, предназначенное для разного использования контакта.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidContactUserField1  <br/> |
|Набор свойств:  <br/> |PSETID_Address  <br/> |
|Длинный ИД (КРЫШКА):  <br/> |0x0000804F  <br/> |
