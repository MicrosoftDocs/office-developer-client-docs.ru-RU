...
Установите значение TRUE, если приглашение на собрание было обработано.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_ПРОЦЕССЕД  <br/> |
...
Это свойство обеспечивает обработку приглашений на собрания один раз. Создатель запроса должен задать для этого свойства значение FALSE, а у приемника должно быть значение TRUE, если запрос находится в календаре.
