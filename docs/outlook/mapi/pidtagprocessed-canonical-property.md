...
Это свойство гарантирует, что запросы собраний обрабатываются один раз. Создатель запроса должен установить это свойство false, а приемник должен установить его true после того, как запрос будет в календаре.
