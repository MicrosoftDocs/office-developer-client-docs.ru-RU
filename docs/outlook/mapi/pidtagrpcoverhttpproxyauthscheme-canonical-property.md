...
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_РОХ_ПРОКСИ_АУС_СЧЕМЕ  <br/> |
...
|**Name**|**Value**|**Описание**|
|:-----|:-----|:-----|
|**РОХАУС_БАСИК** <br/> |0x1  <br/> |Обычная проверка подлинности  <br/> |
|**РОХАУС_НТЛМ** <br/> |0x2  <br/> |Проверка подлинности NTLM  <br/> |
