...
Представляет протокол проверки подлинности, используемый для этого профиля.
...
Это свойство можно настроить для базовой проверки подлинности или проверки подлинности NT LAN Manager (NTLM). Возможные значения этого свойства:
