...
Представляет строковую версию **свойства dispidSharingLocalType** [(PidLidSharingLocalType).](pidlidsharinglocaltype-canonical-property.md)
  
|||
|:-----|:-----|
|Дружественные имена:  <br/> |Нет  <br/> |
|Набор свойств:  <br/> |PS_INTERNET_HEADERS  <br/> |
|Имя свойства:  <br/> |X-Sharing-Local-Type  <br/> |
