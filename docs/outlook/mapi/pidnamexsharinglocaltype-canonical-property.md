...
Представляет строковую версию свойства **диспидшаринглокалтипе** ([PidLidSharingLocalType](pidlidsharinglocaltype-canonical-property.md)).
  
|||
|:-----|:-----|
|Понятные имена:  <br/> |Нет  <br/> |
|Набор свойств:  <br/> |PS_INTERNET_HEADERS  <br/> |
|Имя свойства:  <br/> |Локальный тип X для совместного доступа  <br/> |
