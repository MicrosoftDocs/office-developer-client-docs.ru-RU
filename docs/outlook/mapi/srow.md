...
Структура **сров** описывает строку в таблице. Он включен в структуру [TABLE_NOTIFICATION](table_notification.md) , прилагаемую к табличному уведомлению. 
...
![Отношение между сров и SRowSet](media/amapi_17.gif "между сров и SRowSet")
