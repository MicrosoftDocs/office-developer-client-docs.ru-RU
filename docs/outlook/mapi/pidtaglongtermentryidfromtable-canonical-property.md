...
Получение долгосрочного идентификатора входа элемента.
...
Это свойство можно использовать в таблице содержимого для получения идентификатора входа элемента в качестве долгосрочного идентификатора записи, а не краткосрочного идентификатора записи. Сведения о долгосрочных и краткосрочных идентификаторах **см.** в PR_ENTRYID [(PidTagEntryId).](pidtagentryid-canonical-property.md)
