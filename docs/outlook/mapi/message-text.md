...
Для исходящих сообщений в режиме MIME тип содержимого зависит от того, есть ли вложения и как выглядит текст сообщения. При наличии вложений Content-Type является составным _или смешанным;_ текст сообщения и каждое вложение становятся отдельной частью содержимого сообщения, каждый из которых имеет свой тип контента. Если вложений нет, тип содержимого сообщения — _text/plain_ , а существует только одна часть. 
