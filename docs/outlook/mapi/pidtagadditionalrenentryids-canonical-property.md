...
Содержит ИД записей определенных специальных папок. 
...
Первые пять записей этого много значение свойства применяются к следующим специальным папок, если они существуют в хранилище:
  
0 — папка конфликтов
  
1 — папка проблем синхронизации
  
2 — папка локальных сбоев
  
3 — папка сбоя сервера
