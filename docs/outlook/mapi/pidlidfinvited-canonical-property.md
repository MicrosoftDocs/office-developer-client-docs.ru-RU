...
|Длинный ИД (КРЫШКА):  <br/> |0x00008229  <br/> |
|Тип данных:  <br/> |PT_BOOLEAN  <br/> |
|Область:  <br/> |Собрания  <br/> |
   
## <a name="remarks"></a>Примечания

Значение FALSE или отсутствие этого свойства указывает, что запрос на собрание никогда не отправлялся. Значение TRUE указывает, что был отправлен запрос на собрание. Если для собрания установлено значение TRUE, его нельзя изменить.
