...
В диалоговом окне конфигурации предоставляется имя личной таблицы хранения (PST-файла), которую пользователь может изменить. 
...
Если **вместо PR_PST_PATH** [(PidTagPstPath)](pidtagpstpath-canonical-property.md)используется свойство, диалоговое окно конфигурации откроется, но пользователю не будет разрешено изменять путь и многие другие свойства.
