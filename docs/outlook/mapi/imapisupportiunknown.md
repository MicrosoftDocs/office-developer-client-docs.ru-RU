...
|[Сведения](imapisupport-details.md) <br/> |Отображает диалоговое окно, в котором отображаются сведения о конкретной записи адресной книги.  <br/> |
...
|**Сведения** <br/> |**Доконфигпропшит** <br/> |**Допрогрессдиалог** <br/> |
