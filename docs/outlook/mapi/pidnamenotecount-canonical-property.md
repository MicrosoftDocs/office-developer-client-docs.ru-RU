...
---
# <a name="pidnamenotecount-canonical-property"></a>Каноническое свойство PidNameNoteCount

  
  
**Область применения**: Outlook 2013 | Outlook 2016 
  
Указывает количество заметок в файле, который присоединен к документу.
  
|||
|:-----|:-----|
|Дружественные имена:  <br/> |Нет  <br/> |
|Набор свойств:  <br/> |PS_PUBLIC_STRINGS  <br/> |
|Имя свойства:  <br/> |NoteCount  <br/> |
