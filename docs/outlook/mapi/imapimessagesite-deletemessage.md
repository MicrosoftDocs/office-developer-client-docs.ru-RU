...
2. Он вызывает метод **имапивиевконтекст:: активатенекст** , передавая флаг VCDIR_DELETE в параметре _улдир_ . 
