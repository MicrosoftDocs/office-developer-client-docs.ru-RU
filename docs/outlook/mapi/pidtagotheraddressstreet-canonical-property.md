...
Содержит другой уличный адрес пользователя почты.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |PR_OTHER_ADDRESS_STREET, PR_OTHER_ADDRESS_STREET_A, PR_OTHER_ADDRESS_STREET_W  <br/> |
|Идентификатор:  <br/> |0x3A63  <br/> |
