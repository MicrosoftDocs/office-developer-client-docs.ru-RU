...
Содержит XML-документ, описывающий перемещающийся словарь.
...
Это свойство содержит XML-документ Юникод, использующий кодировки UTF8. Сообщение с потоком словаря должно устанавливать это свойство со следующей схемой:
...
Ниже приводится пример XML-документа, хранимый в этом свойстве в сообщении configuration Data: 
