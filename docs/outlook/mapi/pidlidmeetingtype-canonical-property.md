...
Указывает тип запроса на собрание или обновления собрания.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidMeetingType  <br/> |
|Набор свойств:  <br/> |PSETID_Meeting  <br/> |
|Длинный ИД (КРЫШКА):  <br/> |0x00000026  <br/> |
|Тип данных:  <br/> |PT_LONG  <br/> |
|Область:  <br/> |Собрания  <br/> |
   
## <a name="remarks"></a>Примечания

Этому свойству необходимо установить одно из следующих значений:
  
|**Свойство**|**Значение**|**Описание**|
|:-----|:-----|:-----|
|mtgEmpty  <br/> |0x00000000  <br/> |Не засвечено.  <br/> |
...
|mtgDelegatorCopy  <br/> |0x00100000  <br/> |Он устанавливается в копии делегатора, когда делегат обрабатывает объекты, связанные с собранием.  <br/> |
