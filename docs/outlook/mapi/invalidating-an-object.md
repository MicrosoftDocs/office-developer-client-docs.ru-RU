...
При аннулировании объекта обеспечивается максимальная ответственность за освобождение памяти, связанной с объектом. Вы можете освободить все ресурсы, подключенные к объекту, а затем вызвать **макеинвалид** , чтобы сделать недействительными все методы в унаследованных интерфейсах. Вызовы любого из этих методов будут возвращать MAPI_E_INVALID_OBJECT. Использование **макеинвалид** — это параметр, который многие поставщики услуг пропускают. 
