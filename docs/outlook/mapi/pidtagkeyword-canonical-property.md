...
---
# <a name="pidtagkeyword-canonical-property"></a>Каноническое свойство PidTagKeyword

  
  
**Относится к**: Outlook 2013 | Outlook 2016 
  
Содержит ключевое слово, которое идентифицирует получателя для системного администратора получателя.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |PR_KEYWORD, PR_KEYWORD_A, PR_KEYWORD_W  <br/> |
|Идентификатор:  <br/> |0x3A0B  <br/> |
