...
Это свойство должно быть задано значению **PR_DISPLAY_NAME** [(PidTagDisplayName)](pidtagdisplayname-canonical-property.md)из адресной книги, идентифицированной **dispidSharingInitiatorEid** [(PidLidSharingInitiatorEntryId)](pidlidsharinginitiatorentryid-canonical-property.md)и должно быть проигнорировано. 
