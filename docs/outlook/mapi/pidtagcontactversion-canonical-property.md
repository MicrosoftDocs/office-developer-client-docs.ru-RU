...
Содержит версию контактных данных получателя.
...
Это свойство является одним из свойств, которые предоставляют идентификацию и доступ к сведениям о получателе. Эти свойства определяются получателем и организацией получателя.
