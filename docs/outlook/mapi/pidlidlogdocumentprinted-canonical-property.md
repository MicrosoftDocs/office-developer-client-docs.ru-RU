...
---
# <a name="pidlidlogdocumentprinted-canonical-property"></a>Каноническое свойство PidLidLogDocumentPrinted

  
  
**Область применения**: Outlook 2013 | Outlook 2016 
  
Указывает, был ли документ распечатан во время ведения журнала.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |Диспидлогдокпринтед  <br/> |
|Набор свойств:  <br/> |Псетид_лог  <br/> |
|Длинный идентификатор (крышка):  <br/> |0x0000870E  <br/> |
