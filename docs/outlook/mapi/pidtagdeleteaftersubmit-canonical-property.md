...
Содержит TRUE, если клиентская заявка хочет, чтобы MAPI удалила связанное сообщение после отправки. 
...
Клиентские приложения используют это свойство с **свойством PR_SENTMAIL_ENTRYID** [(PidTagSentMailEntryId)](pidtagsentmailentryid-canonical-property.md)для управления тем, что происходит с сообщением после его отправки. Либо один, либо другой должны быть установлены, но не оба. 
