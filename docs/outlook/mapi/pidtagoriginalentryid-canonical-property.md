...
В непрочитанном отчете это свойство содержит копию идентификатора записи исходного получателя сообщения, для которого создается отчет. Если исходный получатель входит в список рассылки, идентификатор записи списка рассылки сохраняется в отчете.
