...
Эти свойства являются примерами свойств, которые обеспечивают идентификации и доступа к информации о получателе. Эти свойства определены получателя и организации получателя. 
