...
Содержит список идентификаторов поставщиков магазинов сообщений в текущем профиле.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |PR_STORE_PROVIDERS  <br/> |
|Идентификатор:  <br/> |0x3D00  <br/> |
