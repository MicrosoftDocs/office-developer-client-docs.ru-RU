...
Указывает исходное значение свойства **dispidLocation** [(PidLidLocation)](pidlidlocation-canonical-property.md)перед обновлением собрания.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidOldLocation  <br/> |
|Набор свойств:  <br/> |PSETID_Meeting  <br/> |
|Длинный ИД (КРЫШКА):  <br/> |0x00000028  <br/> |
