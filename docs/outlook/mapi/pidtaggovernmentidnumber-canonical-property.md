...
Содержит идентификатор правительства для получателя. 
...
Эти свойства предоставляют идентификацию и доступ к данным о получателе. Они определяются получателем и организацией получателя. 
  
Эти свойства обычно устанавливаются на номер паспорта, номер гражданина или номер налогоплательщика, например номер социального обеспечения. 
