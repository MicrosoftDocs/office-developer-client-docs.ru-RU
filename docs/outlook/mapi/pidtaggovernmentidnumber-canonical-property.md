...
Содержит личный идентификатор получателя. 
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_ГОВЕРНМЕНТ_ИД_НУМБЕР, ПР_ГОВЕРНМЕНТ_ИД_НУМБЕР_А, ПР_ГОВЕРНМЕНТ_ИД_НУМБЕР_В  <br/> |
...
Эти свойства обеспечивают идентификацию и доступ к сведениям о получателе. Они определяются получателем и Организацией получателя. 
  
Для этих свойств обычно задаются номер паспорта, номер сообщения или номер налогоплательщика, например номер социального страхования. 
