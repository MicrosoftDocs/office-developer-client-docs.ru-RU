...
Содержит список языков ASCII, включенных в сообщение. 
...
Эти свойства содержат последовательность двух символьных кодов страны или региона, разделенных запятой. 
