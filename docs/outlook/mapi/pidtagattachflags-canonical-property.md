...
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_АТТАЧ_ФЛАГС  <br/> |
...
Для битовой маски **пр_аттач_флагс** можно задать один или несколько из следующих флагов: 
  
АТТ_ИНВИСИБЛЕ_ИН_ХТМЛ 
  
> Указывает, что это вложение недоступно для HTML-приложений отображения и должно игнорироваться при обработке MIME. 
    
АТТ_ИНВИСИБЛЕ_ИН_РТФ 
  
> Указывает, что это вложение недоступно для отображения приложений в формате RTF и должно игнорироваться MAPI.
    
Если свойство **пр_аттач_флагс** имеет нулевое значение или отсутствует, вложение обрабатывается всеми приложениями. 
