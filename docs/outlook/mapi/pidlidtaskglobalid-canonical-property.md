...
Находит существующую задачу с помощью GUID после получения ответа задачи или обновления задачи.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidTaskGlobalObjId  <br/> |
...
Это свойство остается неустановленным для ненаписаных задач.
