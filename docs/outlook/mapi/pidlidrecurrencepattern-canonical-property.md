...
---
# <a name="pidlidrecurrencepattern-canonical-property"></a>Каноническое свойство PidLidRecurrencePattern
...
Если значение этого свойства, он должен иметь значение описание повторения, указанный в свойстве **dispidApptRecur** ([PidLidAppointmentRecur](pidlidappointmentrecur-canonical-property.md)).
