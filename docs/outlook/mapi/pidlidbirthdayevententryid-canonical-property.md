...
Указывает **EntryId** необязательных встреч, которые представляют день рождения контакта. 
