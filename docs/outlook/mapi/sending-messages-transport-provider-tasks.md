...
- Установите свойство **PR_CLIENT_SUBMIT_TIME** сообщения ([PidTagClientSubmitTime),](pidtagclientsubmittime-canonical-property.md)чтобы указать, когда клиент вызвал [IMessage::SubmitMessage.](imessage-submitmessage.md)
    
- Установите свойство **PR_PROVIDER_SUBMIT_TIME** сообщения ([PidTagProviderSubmitTime),](pidtagprovidersubmittime-canonical-property.md)чтобы указать дату и время, когда поставщик store сообщений пометил сообщение как отправленное. 
