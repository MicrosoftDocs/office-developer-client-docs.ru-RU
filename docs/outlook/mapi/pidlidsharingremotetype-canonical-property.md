...
Указывает тип удаленной общей папки. Это свойство общего сообщения.
...
Это свойство должно быть установлено в том же значении, что и свойство **dispidSharingLocalType** [(PidLidSharingLocalType),](pidlidsharinglocaltype-canonical-property.md)и его следует игнорировать.
