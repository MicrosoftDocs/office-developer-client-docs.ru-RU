...
Указывает тип удаленной общей папки. Это свойство сообщения о совместном доступе.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |диспидшарингремотетипе  <br/> |
...
Для этого свойства должно быть задано то же значение, что и свойство **диспидшаринглокалтипе** ([PidLidSharingLocalType](pidlidsharinglocaltype-canonical-property.md)), и его следует игнорировать.
