...
> Хранилище сообщений является временным и не должно добавляться в таблицу хранения сообщений. Когда MDB_TEMPORARY задается, **модифипрофиле** немедленно возвращает S_OK. 
...
Если установлен флаг MDB_TEMPORARY, MAPI не выполняет никаких действий, а метод немедленно возвращает с S_OK.
