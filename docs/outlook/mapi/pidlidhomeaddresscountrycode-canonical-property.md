...
Указывает код страны для домашнего адреса контакта.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |Диспидхомеаддресскаунтрикоде  <br/> |
...
> Задает свойства и операции, допустимые для контакст и личных списков рассылки.
