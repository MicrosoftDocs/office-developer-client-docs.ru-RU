...
- Не разрешать клиентам изменять это свойство в хранилище. Обратите внимание, что константа **ASM_CLIENT_DO_NOT_CHANGE** предназначена для использования в будущем и в настоящее время не реализована. Пока хранилище может запретить клиентам изменять этот флаг, хардкодинг значение, которое возвращает магазин для этого свойства. 
