...
Содержит имя отдела, в котором работает получатель. 
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_ДЕПАРТМЕНТ_НАМЕ, ПР_ДЕПАРТМЕНТ_НАМЕ_А, ПР_ДЕПАРТМЕНТ_НАМЕ_В  <br/> |
|Идентификатор:  <br/> |0x3A18  <br/> |
