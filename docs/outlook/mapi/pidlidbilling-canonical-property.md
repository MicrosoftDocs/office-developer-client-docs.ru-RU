...
---
# <a name="pidlidbilling-canonical-property"></a>Каноническое свойство PidLidBilling

  
  
**Область применения**: Outlook 2013 | Outlook 2016 
  
Содержит сведения о выставлении счетов, связанные с элементом.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |Диспидбиллинг  <br/> |
|Набор свойств:  <br/> |Псетид_коммон  <br/> |
|Длинный идентификатор (крышка):  <br/> |0x00008535  <br/> |
