...
Означает, что, если TRUE, фишинговая марка на сообщении должна быть проигнорирована.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |PR_JUNK_PHISHING_ENABLE_LINKS  <br/> |
|Идентификатор:  <br/> |0x6107  <br/> |
