...
Содержит строку Юникода, которая запрашивается в содержимом вложений в магазине.
...
> [!NOTE]
> Этот тег ограничений MAPI, используемый при поиске содержимого вложений, может быть не определен в загружаемом файле загона, который у вас есть. Вы можете добавить его в код, используя следующее значение: >  `#define PR_SEARCH_ATTACHMENTS_W PROP_TAG(PT_UNICODE, 0x0EA5)`
