...
Содержит объект контейнера, используемый для расширенных поисков.
...
Контейнер, который не поддерживает расширенные возможности поиска, не должен предоставить свойство.
