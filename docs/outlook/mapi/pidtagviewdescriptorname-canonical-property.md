...
Эти свойства должен иметь значение пустой строке сообщения связать сведения о папке (FAI), который содержит определения представлений.
