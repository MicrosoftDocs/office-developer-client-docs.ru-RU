...
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_ВД_НАМЕ, ПР_ВД_НАМЕ_А, ПР_ВД_НАМЕ_В  <br/> |
...
В этих свойствах необходимо указать непустую строку для сообщения о соПоставлении папки (ФАИ), содержащего определения представлений.
