...
Это свойство не должно существовать, если значение **свойства PR_FLAG_STATUS** [(PidTagFlagStatus)](pidtagflagstatus-canonical-property.md)не установлено как "followupFlagged", или объект сообщения является объектом, связанным с собранием. Это свойство не должно существовать на объекте задачи. При заданной на других объектах сообщений это свойство должно быть заданной для одного из следующих значений.
  
|**Числовая величина**|**Имя**|**Описание**|
|:-----|:-----|:-----|
|Не присутствует  <br/> |Н/Д  <br/> |Нет цвета  <br/> |
|1  <br/> |followupIcon1  <br/> |Фиолетовый флаг  <br/> |
