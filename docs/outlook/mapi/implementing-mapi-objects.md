...
Существует множество макросов в файл заголовка Mapidefs.h и OLE файлы заголовков, которые клиенты и поставщики услуг на любом языке можно использовать для справки при их определения объектов MAPI. Например такое макрос для определения методов каждого интерфейса MAPI. Макрос для определения методов интерфейс [IUnknown](https://msdn.microsoft.com/library/ms680509%28v=VS.85%29.aspx) в Mapidefs.h бы выглядел следующим образом: 
