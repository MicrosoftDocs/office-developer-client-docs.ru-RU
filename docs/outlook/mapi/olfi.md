...
Идентификатор записи — это идентификатор операции 4-байтных MAPI для папки или сообщения. Для получения дополнительных сведений см [ENTRYID](https://msdn.microsoft.com/library/ms836424).
