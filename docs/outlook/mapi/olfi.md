...
<span data-ttu-id="e58d9-127">Идентификатор записи — это идентификатор операции 4-байтных MAPI для папки или сообщения.</span><span class="sxs-lookup"><span data-stu-id="e58d9-127">An Entry ID is a 4-byte MAPI entry identifier for a folder or a message.</span></span> <span data-ttu-id="e58d9-128">Для получения дополнительных сведений см [ENTRYID](http://msdn.microsoft.com/ru-ru/library/ms836424).</span><span class="sxs-lookup"><span data-stu-id="e58d9-128">For more information, see [ENTRYID](http://msdn.microsoft.com/ru-ru/library/ms836424).</span></span>
