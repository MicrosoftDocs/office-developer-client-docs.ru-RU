...
Содержит значение вложения [RFC3282], которое состоит из соответствующих данных вилки и вилки ресурсов, используемых клиентами электронной почты на основе Macintosh.
...
Дополнительные сведения см. в разделе MS-OXCMAIL 2.2.4.2 Форматы файлов Apple.
