...
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_ТОДО_ИТЕМ_ФЛАГС  <br/> |
...
|8,5  <br/> |ТодореЦипиентфлагжед  <br/> |Следует устанавливать только для черновика объекта Message, и это означает, что объект помечен для получателей.  <br/> |
