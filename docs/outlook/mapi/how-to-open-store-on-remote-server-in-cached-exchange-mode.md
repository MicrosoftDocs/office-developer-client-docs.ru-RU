...
В этом разделе приведен пример кода на языке C++, в котором показано, как использовать флаг **MDB_ONLINE** , чтобы открыть хранилище сообщений на удаленном сервере, когда microsoft Outlook 2010 или microsoft Outlook 2013 находится в режиме кэширования Exchange. 
...
В приведенном ниже примере кода показано, как вызывать **IMAPISession:: опенмсгсторе** с флагом **MDB_ONLINE** , установленным в параметре *ulFlags* , чтобы открыть хранилище по умолчанию на удаленном сервере. 
