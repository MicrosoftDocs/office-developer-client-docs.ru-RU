...
Указывает состояние выполнения задачи пользователем.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidTaskStatus  <br/> |
|Набор свойств:  <br/> |PSETID_Task  <br/> |
|Длинный ИД (КРЫШКА):  <br/> |0x00008101  <br/> |
|Тип данных:  <br/> |PT_LONG  <br/> |
|Область:  <br/> |Task  <br/> |
   
## <a name="remarks"></a>Примечания

Для этого свойства необходимо установить одно из следующих значений.
  
|**Значение**|**Описание**|
|:-----|:-----|
|0x00000000  <br/> |Пользователь не начал работу над задачей. Если установлено это значение, **значение dispidPercentComplete** ([PidLidPercentComplete)](pidlidpercentcomplete-canonical-property.md)должно быть 0,0.  <br/> |
|0x00000001  <br/> |Работа пользователя над этой задачей находится в процессе выполнения. Если установлено это значение, **значение dispidPercentComplete** должно быть больше 0,0 и меньше 1,0.  <br/> |
|0x00000002  <br/> |Работа пользователя над этой задачей завершена. Если установлено это значение, **значение dispidPercentComplete** должно быть 1,0, **dispidTaskDateCompleted** ([PidLidTaskDateCompleted)](pidlidtaskdatecompleted-canonical-property.md)должно быть текущей датой, а **dispidTaskComplete** ([PidLidTaskComplete](pidlidtaskcomplete-canonical-property.md)) должно иметь значение TRUE.  <br/> |
|0x00000003  <br/> |Пользователь ожидает другого пользователя.  <br/> |
