...
|||
|:-----|:-----|
|Связанные свойства:  <br/> |диспидтаскдатекомплетед  <br/> |
...
Если этот параметр задан, то у этого свойства должен быть компонент времени полуночи в местном часовом поясе, преобразованный в формат UTC.
