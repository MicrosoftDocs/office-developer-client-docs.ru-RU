...
Указывает, ответил ли назначаемая задача на запрос задачи.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |dispidTaskAccepted  <br/> |
|Набор свойств:  <br/> |PSETID_Task  <br/> |
|Длинный ИД (КРЫШКА):  <br/> |0x00008108  <br/> |
|Тип данных:  <br/> |PT_BOOLEAN  <br/> |
|Область:  <br/> |Task  <br/> |
   
## <a name="remarks"></a>Примечания

Клиент устанавливает для этого свойства false для новой задачи или устанавливает для этого свойства true, когда задача принимается или отклоняется. Если свойство не замечено, предполагается значение FALSE.
