...
Клиент задает это свойство FALSE для новой задачи, или клиент задает это свойство TRUE, когда задача принимается или отклоняется. Если свойство остается неустановленным, предполагается значение FALSE.
