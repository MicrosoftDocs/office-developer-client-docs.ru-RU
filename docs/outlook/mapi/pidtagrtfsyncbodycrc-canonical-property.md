...
Функция [RTFSync](rtfsync.md) вычисляет CRC, используя только символы, которые она считает значимыми для сообщения. Например, некоторые пробелы и другие игнорируемые символы опущены из CRC. 
