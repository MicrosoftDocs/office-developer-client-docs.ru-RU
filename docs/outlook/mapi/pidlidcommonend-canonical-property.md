...
|Длинный ИД (КРЫШКА):  <br/> |0x00008517  <br/> |
|Тип данных:  <br/> |PT_SYSTIME  <br/> |
|Область:  <br/> |Общие сообщения  <br/> |
   
## <a name="remarks"></a>Примечания

Это свойство указывает время окончания для элемента. Оно должно быть больше или равно значению свойства **dispidCommonStart** ([PidLidCommonStart).](pidlidcommonstart-canonical-property.md)
  
Это значение должно быть эквивалентом свойства **dispidTaskDueDate** [(PidLidTaskDueDate)](pidlidtaskduedate-canonical-property.md)в UTC.
