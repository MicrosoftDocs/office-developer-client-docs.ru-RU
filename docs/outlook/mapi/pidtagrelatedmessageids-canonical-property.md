...
Содержит список идентификаторов сообщений, к которым связано сообщение.
...
Идентификаторы используют те же правила строительства, что и **для свойства** [PR_SEARCH_KEY (PidTagSearchKey).](pidtagsearchkey-canonical-property.md)
