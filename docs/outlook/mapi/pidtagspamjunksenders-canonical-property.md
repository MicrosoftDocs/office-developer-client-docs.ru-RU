...
Содержит разделенный точками с запятой список адресов электронной почты и доменов, которые содержат заблокированных отправителей.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |PR_SPAM_JUNK_SENDERS_W  <br/> |
|Длинный идентификатор (крышка):  <br/> |0x041A  <br/> |
