...
Содержит значительные символы, которые отображаются в начале текста сообщения.
...
Функция [RTFSync использует](rtfsync.md) текстовый тег, чтобы указать начало текста сообщения. При внесении изменений в текст тег используется для поиска начала предыдущего текста. 
