...
Это свойство устанавливается клиентом для монопольного использования клиента. 
...
Сервер должен сохранить значение этого свойства, если оно было установлено клиентом. Сервер должен игнорировать его во время оценки и обработки правил.
