...
Содержит массив значений денежных единиц, которые используются для описания свойства типа PT_MV_CURRENCY. 
...
Сведения о PT_MV_CURRENCY приведены в разделе [список типов свойств](property-types.md). 
