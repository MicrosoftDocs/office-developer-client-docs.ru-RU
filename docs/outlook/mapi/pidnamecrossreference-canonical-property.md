...
Содержит значение поля загона Xref [RFC3282].
...
Чтобы установить значение этого свойства, клиенты MIME должны записать нужное значение в поле загона XRef. Читатели MIME должны скопировать значение поля загона XRef в значение этого свойства.
