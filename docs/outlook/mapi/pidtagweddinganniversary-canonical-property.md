...
Содержит дату юбилея по случаю свадьбы пользователя.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_ВЕДДИНГ_АННИВЕРСАРИ  <br/> |
...
Это свойство определяется пользователем или организацией пользователя.
