...
Содержит URL-адрес личной домашней страницы пользователя.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |PR_PERSONAL_HOME_PAGE, PR_PERSONAL_HOME_PAGE_A PR_PERSONAL_HOME_PAGE_W  <br/> |
|Идентификатор:  <br/> |0x3A50  <br/> |
