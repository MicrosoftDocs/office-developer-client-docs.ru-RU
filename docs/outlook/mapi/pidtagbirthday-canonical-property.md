...
Это свойство является одним из свойств, обеспечивающих идентификацию и доступ к информации о контакте. Эти свойства определяются пользователем и организацией пользователя. 
