...
Содержит дату и время сгенерирований отчета о доставке.
...
Это свойство должно быть заданной поставщиком магазина сообщений, получающей исходное сообщение и генерирующей отчет. 
