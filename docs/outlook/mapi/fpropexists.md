...
Если тег свойства в параметре _улпроптаг_ имеет тип PT_UNSPECIFIED, функция **фпропексистс** выполняет поиск в соответствии с идентификатором свойства. В противном случае сравнение выполняется для всего тега свойства, включая тип. 
