...
Содержит дополнительные сведения об именоваваемом свойстве, используемом в сообщении о связанных с папками сведениях (FAI).
