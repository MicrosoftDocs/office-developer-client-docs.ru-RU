...
Это свойство должно быть задано для сообщения ФАИ. Это свойство служит той же цели, что и **PR_RULE_ACTIONS** ([PidTagRuleActions](pidtagruleactions-canonical-property.md)), но содержит дополнительные сведения о версии правила и именованных свойствах, хранящихся в действии правила, а также сведения о действиях, выполняемых этим правилом. Все строковые значения, содержащиеся в любой части буфера действий, используемого для хранения действий, должны быть представлены в формате Юникод.
