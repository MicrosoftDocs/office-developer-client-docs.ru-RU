...
Содержит тип адреса первоначально предназначенного получателя автозаявливаемого сообщения.
...
Эти свойства являются одним из свойств адресов для первоначально предназначенного получателя сообщений. Он должен быть задат автоматическим агентом, переададовав сообщение.
