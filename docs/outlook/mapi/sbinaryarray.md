...
Структура **сбинаряррай** используется для описания свойств типа PT_MV_BINARY. 
  
Дополнительные сведения о PT_MV_BINARY приведены в разделе [список типов свойств](property-types.md).
