...
|Длинный ИД (КРЫШКА):  <br/> |0x00008113  <br/> |
...
|**Значение**|**Описание**|
|:-----|:-----|
|0x00000000  <br/> |Эта задача была создана в соответствие с задачей, которая была внедрена в отклонение задачи, но не найдена локально.  <br/> |
|0x00000001  <br/> |Задача не назначена.  <br/> |
|0x00000002  <br/> |Задача является копией назначенной задачи.  <br/> |
|0x00000003  <br/> |Задача является копией назначенной задачи.  <br/> |
|0x00000004  <br/> |Задача является копией отклоненной задачи.  <br/> |
