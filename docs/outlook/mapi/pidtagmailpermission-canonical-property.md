...
Содержит true, если пользователю сообщения разрешено отправлять и получать сообщения. 
...
Установите для этого свойства false в корпоративном каталоге, где для некоторых записей не включена электронная почта. 
