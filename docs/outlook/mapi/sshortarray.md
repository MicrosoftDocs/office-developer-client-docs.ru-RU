...
Содержит массив целочисленных значений без знака, которые используются для описания свойства типа PT_MV_SHORT.
...
Более подробную информацию о PT_MV_SHORT и других типах свойств можно узнать в статье [типы свойств](property-types.md). 
