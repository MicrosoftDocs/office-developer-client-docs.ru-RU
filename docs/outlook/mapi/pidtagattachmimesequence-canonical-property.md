...
Содержит последовательность MIME-номера вложения сообщения MIME.
...
|Область:  <br/> |Свойства вложения сообщения  <br/> |
   
## <a name="remarks"></a>Примечания

Это свойство используется для поддержки MHTML. Он представляет номер последовательности вложения в родительской составной части MIME сообщения MIME.
