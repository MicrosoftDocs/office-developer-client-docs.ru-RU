...
Содержит причины, по которым сообщение не было получено, в том, что форма является частью отчета о не доставке.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |PR_NON_RECEIPT_REASON  <br/> |
...
Причиной может быть, например, то, что сообщение было отклонено.
