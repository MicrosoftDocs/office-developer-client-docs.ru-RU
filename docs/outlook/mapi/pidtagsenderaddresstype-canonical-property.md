...
Содержит тип электронного адреса отправителя сообщения.
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_СЕНДЕР_АДДРТИПЕ, ПР_СЕНДЕР_АДДРТИПЕ_А, ПР_СЕНДЕР_АДДРТИПЕ_В  <br/> |
...
Эти свойства являются примерами свойств адреса для отправителя сообщения. Он должен быть задан поставщиком исходящей транспортировки, который никогда не должен распространять какие бы то ни было существующие значения.
