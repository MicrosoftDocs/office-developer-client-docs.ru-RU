...
Реализует объект рекомендации по обработке уведомлений. Указатель на объект по приему рекомендации передается в вызов  методу Консультирование поставщика услуг, механизму, используемом для регистрации для уведомления. 
  
|||
|:-----|:-----|
|Файл заголовка:  <br/> |Mapidefs.h  <br/> |
|Подвергается:  <br/> |Советы по объектам раковины  <br/> |
