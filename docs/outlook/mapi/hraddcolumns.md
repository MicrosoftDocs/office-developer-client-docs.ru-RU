...
> [in] Указатель на **структуру SPropTagArray,** которая содержит массив тегов свойств для свойств, которые будут добавлены или перенесены в начало таблицы. 
...
> [in] Указатель на **функцию MAPIFreeBuffer.** Используется для бесплатной памяти. 
...
Функция **HrAddColumns** эквивалентна использованию **HrAddColumnsEx** с  _помощью lpfnFilterColumns,_ задаваемой NULL. 
