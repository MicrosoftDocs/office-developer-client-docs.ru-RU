...
Содержит имя помощника по администрированию получателя. 
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |PR_ASSISTANT, PR_ASSISTANT_A PR_ASSISTANT_W  <br/> |
|Идентификатор:  <br/> |0x3A30  <br/> |
...
[Каноническое свойство PidTagAssistantTelephoneNumber](pidtagassistanttelephonenumber-canonical-property.md)
