...
|Длинный ИД (КРЫШКА):  <br/> |0x00008502  <br/> |
|Тип данных:  <br/> |PT_SYSTIME  <br/> |
|Область:  <br/> |Reminder  <br/> |
   
## <a name="remarks"></a>Примечания

Для объектов календаря это свойство представляет время, когда пользователь будет с опозданием, которое является временем начала встречи. Клиенты должны установить значение в UTC.
