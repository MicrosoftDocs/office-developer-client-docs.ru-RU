...
Содержит номер телефона помощника по администрированию получателя. 
  
|||
|:-----|:-----|
|Связанные свойства:  <br/> |PR_ASSISTANT_TELEPHONE_NUMBER, PR_ASSISTANT_TELEPHONE_NUMBER_A PR_ASSISTANT_TELEPHONE_NUMBER_W  <br/> |
|Идентификатор:  <br/> |0x3A2E  <br/> |
...
Номер телефона предназначен для помощника, указанного в свойстве **PR_ASSISTANT** ([PidTagAssistant](pidtagassistant-canonical-property.md)). 
