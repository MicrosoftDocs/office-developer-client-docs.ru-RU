...
|||
|:-----|:-----|
|Связанные свойства:  <br/> |ПР_АССИСТАНТ_ТЕЛЕФОНЕ_НУМБЕР, ПР_АССИСТАНТ_ТЕЛЕФОНЕ_НУМБЕР_А, ПР_АССИСТАНТ_ТЕЛЕФОНЕ_НУМБЕР_В  <br/> |
...
Номер телефона предназначен для помощника, указанного в свойстве **пр_ассистант** ([PidTagAssistant](pidtagassistant-canonical-property.md)). 
