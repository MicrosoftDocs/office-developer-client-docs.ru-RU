...
Содержит массив двойной точности, используемый для описания свойства типа PT_MV_DOUBLE.
...
Дополнительные сведения о PT_MV_DOUBLE приведены в разделе [список типов свойств](property-types.md).
