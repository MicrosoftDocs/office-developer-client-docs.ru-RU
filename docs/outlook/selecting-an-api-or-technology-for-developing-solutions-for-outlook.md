...
description: В этой статье описываются интерфейсы API и технологии, которые можно использовать для расширения Outlook 2013 и Outlook 2016 и поможет вам выбрать соответствующий API или технологий для сценария.
ms.openlocfilehash: e78e96f776b8f7c584dbd82163f41d0f5d8c80f6
ms.sourcegitcommit: 0cf39e5382b8c6f236c8a63c6036849ed3527ded
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 08/23/2018
ms.locfileid: "22593426"
---
...
В этой статье описываются интерфейсы API и технологии, которые можно использовать для расширения Outlook 2013 и Outlook 2016 и поможет вам выбрать соответствующий API или технологий для сценария.
...
|Available information  <br/> |Information about developing and posting Надстройки Office is available at [Build apps for Office and SharePoint](http://msdn.microsoft.com/en-us/office/apps/fp160950.aspx). Specific documentation for mail apps is available at [Надстройки Outlook](http://msdn.microsoft.com/library/71e64bc9-e347-4f5d-8948-0a47b5dd93e6%28Office.15%29.aspx).  <br/> |
|Developer and deployment licensing  <br/> |Refer to [Лицензирование надстроек Office и SharePoint](http://msdn.microsoft.com/library/3e0e8ff6-66d6-44ff-b0c2-59108ebd9181%28Office.15%29.aspx) for information about the app license framework for Надстройки Office.  <br/> |
...
|Deployment methods  <br/> |You can publish mail apps to the Магазин Office or to an Exchange catalog that makes the app available to users on that Exchange Server. Administrators or users can then choose to install a mail app from the Магазин Office or Exchange catalog, by using either the Exchange Admin Center (EAC) or by running remote Windows PowerShell cmdlets. You can access the EAC from the Outlook Backstage view or Outlook Web App, or by directly signing into the EAC for your mailbox.  <br/> For more information, see [Развертывание и установка надстроек Outlook для тестирования](http://msdn.microsoft.com/library/d6eea4c4-bb21-4f24-bcba-1eccbb4e12dd%28Office.15%29.aspx).  <br/> |
...
|Managed implementation  <br/> |The Outlook PIA enables the Outlook object model to be used in a managed-code environment, which is supported by a rich set of class libraries and support technologies that address many limitations of VBA and COM add-ins. The PIA is a COM wrapper that acts as a bridge between the managed and COM environments. For more information, see [Причины использования Outlook PIA](http://msdn.microsoft.com/library/5cc9085e-7c97-4698-8cb9-e33e427c02e7%28Office.15%29.aspx).  <br/> |
...
> [!NOTE]
> [!Примечание] MAPI is a mature mechanism used to access information in Exchange or in a personal folders (.pst) file, and MAPI provides some capabilities that are not available in any other API. However, MAPI does not work well outside an intranet, maintains an open connection for the duration of the MAPI session, and can be difficult to learn. MAPI does not enforce Outlook business logic, so you must take special care to ensure that Outlook business logic is maintained. 
...
- You can use add-ins on Outlook 2013 and Exchange Server 2013, as well as earlier versions of Outlook and Exchange. С другой стороны почтовые приложения работают с Outlook и Exchange, начиная с Outlook 2013 и Exchange Server 2013, но не более ранних версий.
...
> [!NOTE]
> [!Примечание] For more information about the scenarios, click the boxes in the following figures. 
...
](http://msdn.microsoft.com/library/6ea4babf-facf-4018-ef5a-4a484e55153a%28Office.15%29.aspx)[![Настройка полей, форм и свойств элемента](media/odc_ol15_ta_SelectingTech_Fig2-3.gif)
...
](http://msdn.microsoft.com/library/7b569709-5da8-a950-a0fb-9d64b520a21b%28Office.15%29.aspx)[![Встроенный ответ в области чтения](media/odc_ol15_ta_SelectingAPI_Fig5-2.gif)
...
For more information and code samples, see the [Справочник по MAPI для Outlook](http://msdn.microsoft.com/library/3d980b86-7001-4869-9780-121c6bfc7275%28Office.15%29.aspx) and [MFCMAPI](http://mfcmapi.codeplex.com/).
...
> [!NOTE]
> [!Примечание] The discussion of automating Outlook in this section and the next is outside the scope of Надстройки Office, which are intended to extend the functionality of the Office client or web application but not to automate it. 
...
## <a name="see-also-office-add-ins"></a>См. также: надстроек Office
<a name="OLSelectAPI_AdditionalResourcesApps"> </a>

[Обзор платформы надстроек Office](http://msdn.microsoft.com/library/e64de870-ce22-4331-92e7-76d35279bf91%28Office.15%29.aspx) provides a good introduction of Надстройки Office, including the architecture and development life cycle. 
  
See [Надстройки Outlook](http://msdn.microsoft.com/library/71e64bc9-e347-4f5d-8948-0a47b5dd93e6%28Office.15%29.aspx) for a detailed roadmap of resources about developing mail apps. 
  
## <a name="see-also-object-model-and-pia"></a>См. также: объектная модель и основная сборка ВЗАИМОДЕЙСТВИЯ
...
- [Получение сведений для нескольких учетных записей](http://msdn.microsoft.com/library/af587ee2-429a-252f-ecb6-2f058b9a37a8%28Office.15%29.aspx)
    
- [Управление несколькими учетными записями Exchange в Outlook 2010 (машинный перевод)](http://msdn.microsoft.com/library/b5a80da9-102d-4617-8a06-49ded01a237a%28Office.15%29.aspx)
...
- [Отображение групп, в которых состоит руководитель](http://msdn.microsoft.com/library/2f0ff92c-e026-4f62-c039-fbda9aaf1546%28Office.15%29.aspx)
    
- [Отображение имени и номера офиса каждого руководителя из списка рассылки Exchange](http://msdn.microsoft.com/library/abc26854-62db-be7f-4025-46acbcb42541%28Office.15%29.aspx)
...
- [Вложение файла в почтовый элемент](http://msdn.microsoft.com/library/1d94629b-e713-92cb-32de-c8910612e861%28Office.15%29.aspx)
...
- [Создание надстройки C++ для Outlook 2010](http://msdn.microsoft.com/library/70b308e7-d713-4a26-9892-5021f7320674%28Office.15%29.aspx)
    
- [Введение во взаимодействие между COM и .NET](http://msdn.microsoft.com/library/6b2d099a-ec6f-4099-aaf6-e61003fe5a32%28Office.15%29.aspx)
    
- [Причины использования Outlook PIA](http://msdn.microsoft.com/library/5cc9085e-7c97-4698-8cb9-e33e427c02e7%28Office.15%29.aspx)
    
- [Рекомендации по разработке управляемых надстроек для Outlook](http://msdn.microsoft.com/library/a03246f6-2ca5-4fcb-8e63-a11cfbc8d9a0%28Office.15%29.aspx)
    
- [Получение и выполните вход в экземпляр Outlook](http://msdn.microsoft.com/library/ef369364-6500-2759-3ef4-ed4411112e96%28Office.15%29.aspx)
...
- [Получение и перечисление выделенных бесед](http://msdn.microsoft.com/library/3bba1e98-b2eb-c53d-354a-bdd899b65a59%28Office.15%29.aspx)
...
- [Реализация оболочки для инспекторов и отслеживание событий уровня элемента в каждом инспекторе](http://msdn.microsoft.com/library/8021dd2b-c36c-492b-b281-783e85140ad8%28Office.15%29.aspx)
...
- [Эффективное получение и задание пользовательских свойств в папке контактов в Outlook 2010 (машинный перевод)](http://msdn.microsoft.com/library/bb49f7a6-ec0a-483a-a27e-e843c6af781b%28Office.15%29.aspx)
...
- [Эффективность фильтрации элементы типа контакт в папке Контакты в Outlook 2010 (машинный перевод)](http://msdn.microsoft.com/library/b8dd39e7-d716-4acd-873b-d2b0faaff30d%28Office.15%29.aspx)
...
- [Создание правила для перемещения определенных сообщений в папку](http://msdn.microsoft.com/library/e72fa307-8224-c2d2-1318-a18cd8e9f22f%28Office.15%29.aspx)
...
- [Изменения завершения работы Outlook 2010](http://msdn.microsoft.com/library/1b154d46-8d13-4c65-91e3-180b22603d03%28Office.15%29.aspx)
...
- [Программирование модуля "Решения" Outlook 2010](http://msdn.microsoft.com/library/5989a3da-2f2a-4abd-87b0-cc0e1560dd59%28Office.15%29.aspx)
...
- [Создание области формы](http://msdn.microsoft.com/library/695b95a5-c795-cb4a-8d35-ba12b0007b1f%28Office.15%29.aspx)
...
- [Реализация области формы для отображения заголовков сообщений электронной почты в Outlook 2010 (машинный перевод)](http://msdn.microsoft.com/library/243a4e64-d4ea-4cfc-871e-af19d622fb1b%28Office.15%29.aspx)
...
- [Ориентация решений пользовательского интерфейса на выпуски 2007 и 2010 системы Microsoft Office](http://msdn.microsoft.com/library/98726fb2-5d5c-44be-80c3-cfef926471f9%28Office.15%29.aspx)
...
- [Расширение интерфейса пользователя в Outlook 2010](http://msdn.microsoft.com/library/00b504b0-e897-43b9-8615-44276166823f%28Office.15%29.aspx)
...
- [Настройка контекстного меню карточки контакта в Outlook 2010 (машинный перевод)](http://msdn.microsoft.com/library/8513c8de-15d7-4396-8ced-f5f56f4cd9b3%28Office.15%29.aspx)
...
- [Добавление папки для решения конкретных решениях модулю в Outlook 2010 (машинный перевод)](http://msdn.microsoft.com/library/9709af57-1577-4497-8c9c-3d239353e2ed%28Office.15%29.aspx)
    
- [SolutionsModule](http://msdn.microsoft.com/library/4597765e-a95d-bf07-2ac4-103218ebc696%28Office.15%29.aspx) object 
    
## <a name="see-also-auxiliary-apis"></a>См. также: вспомогательных API
...
- [Определить, является ли элемент Outlook был изменен, но не сохраняются (Outlook дополнительные справочные материалы по)](auxiliary/how-to-determine-if-outlook-item-has-been-modified-but-not-saved.md)
...
## <a name="see-also-primary-references-resources-and-code-samples"></a>См. также: основные справочники, ресурсы и примеры кода
...
- [Справочник по MAPI для Outlook](http://msdn.microsoft.com/library/3d980b86-7001-4869-9780-121c6bfc7275%28Office.15%29.aspx)   
...
- PIA code samples: [Инструкции (справочник по основной сборке взаимодействия для Outlook 2013)](http://msdn.microsoft.com/library/ff647d52-bd32-4945-afa4-5b97d9a0d7dd%28Office.15%29.aspx)  
- [Примеры использования интерфейса MAPI (EN)](http://msdn.microsoft.com/library/641659f2-3c0a-43af-96f1-2521b4b06680%28Office.15%29.aspx)
