...
|**Элементы** <br/> |**Окно** <br/> |Возвращает объект **Window** , соответствующий переданное значение индекса. Это свойство не может осуществляться непосредственно. Чтобы вернуть объект **Window** , используйте **Windows [(uint) index]**.  <br/> |
