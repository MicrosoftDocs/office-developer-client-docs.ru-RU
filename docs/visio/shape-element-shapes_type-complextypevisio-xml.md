...
|Образец  <br/> |XSD:unsignedInt  <br/> |необязательный  <br/> |Идентификатор основной элемент, из которого фигуры наследует его данных.  <br/> |Значения типа xsd:unsignedInt.  <br/> |
