...
Возвращает случайный номер плавающей точки от 0.0 до 1.0. Каждый раз при оценке функции возвращается другой номер, который в соответствии с системными часами составляет один раз в минуту. 
...
Эту функцию можно использовать для создания эффектов анимации, установив свойства фигур случайным значениям.
  
## <a name="example"></a>Пример

RAND( ) 
  
Возвращает десятичной фракции, например 0.3503. 
