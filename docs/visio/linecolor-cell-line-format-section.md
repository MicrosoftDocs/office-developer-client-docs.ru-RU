...
Чтобы установить цвет линии, введите число от 0 до 23, которое является индексом в коллекцию цветов линии. Вы можете просмотреть коллекцию цветов линий в  диалоговом окне **"Линия"** (на вкладке "Главная" в группе "Фигура" щелкните **"Строка"** и "Вес" **и** выберите "Дополнительные  **строки").** Вы также можете установить значение LineColor в **диалоговом** окне "Линия". 
...
Вы можете установить прозрачность цвета линии в ячейке LineColorTrans.
