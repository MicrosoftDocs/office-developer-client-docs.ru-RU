...
---
# <a name="characterrowtype-complextype-visio-xml"></a>Чарактерров_типе complexType (XML для Visio)
...
|:-----|:-----|:-----|
|[Cell](cell-element-character-sectionvisio-xml.md) <br/> |[Целл_типе](cell_type-complextypevisio-xml.md) <br/> ||
