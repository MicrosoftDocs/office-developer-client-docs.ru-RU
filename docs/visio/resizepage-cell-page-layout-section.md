...
Определяет, следует ли увеличивать страницу, чтобы прикрыть рисунок после раскладки фигур, используя  диалоговое окно **Configure**  **Layout**(на вкладке Дизайн, в группе **Макет,** щелкните Страницу повторного макета, а затем нажмите кнопку Дополнительные параметры макета).
  
|**Значение**|**Описание**|
|:-----|:-----|
| TRUE  <br/> | Увеличение страницы.  <br/> |
| FALSE  <br/> | Не расширяй страницу.  <br/> |
