...
|:-----|:-----|:-----|
|AutoGen  <br/> |Указывает, является ли автоматически создавать точку подключения. Значение 1 указывает точку подключения создается автоматически.  <br/> |Отсутствуют.  <br/> |
...
|Запрос  <br/> |Этот атрибут зарезервирован для будущего использования.  <br/> |Отсутствуют.  <br/> |
