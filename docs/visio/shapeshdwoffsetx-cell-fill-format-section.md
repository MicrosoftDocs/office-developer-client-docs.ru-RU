...
description: Определяет расстояние в единицах страницы, которое тень фигуры смещена горизонтально от фигуры.
...
Определяет расстояние в единицах страницы, которое тень фигуры смещена горизонтально от фигуры.
  
## <a name="remarks"></a>Примечания

Это значение соответствует значению в параметре **X Offset** в диалоговом окне **Shadow** (на вкладке **Главная** в группе **Shape** нажмите кнопку **Тень** и нажмите кнопку **Параметры тени).**
  
Чтобы получить ссылку на ячейку ShapeShdwOffsetX по имени из другой формулы или из программы с помощью свойства **CellsU,** используйте: 
