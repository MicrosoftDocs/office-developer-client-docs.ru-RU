---
title: Элемент ShowPageBreaks (Window_Type complexType) (XML для Visio)
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="showpagebreaks-element-window_type-complextype-visio-xml"></a>Элемент ShowPageBreaks (Window_Type complexType) (XML для Visio)
