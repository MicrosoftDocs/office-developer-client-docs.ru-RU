...
Определяет интервал остановок вкладки по умолчанию в текстовом блоке. 
  
## <a name="remarks"></a>Примечания

Значение по умолчанию — 0,5 дюйма для документов, созданных в имперских единицах, и 1,5 сантиметра для документов, созданных в метрических единицах.
