...
Скрывает текст для фигуры. Вы можете просматривать текст, изменять свойства и применять стили к тексту в текстовом блоке, хотя изменения будут отображаться только после сброса HideText в FALSE (0).
