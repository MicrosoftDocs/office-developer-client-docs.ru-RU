...
Определяет направление перехода строки для прыжков строки, происходящих на горизонтальном динамическом соединители для фигуры.
  
|**Значение**|**Направление перехода строки**|**Константа автоматизации**|
|:-----|:-----|:-----|
| 0  <br/> | По умолчанию страницы  <br/> |**visLOJumpDirXDefault** <br/> |
| 1  <br/> | Up  <br/> |**visLOJumpDirXUp** <br/> |
| 2  <br/> | Down  <br/> |**visLOJumpDirXDown** <br/> |
   
## <a name="remarks"></a>Примечания

Чтобы установить горизонтальное  направление по умолчанию для всех переходов соединительщика на странице, используйте ячейку PageLineJumpDirX в разделе Макет страницы. 
