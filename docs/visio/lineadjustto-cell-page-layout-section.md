...
Определяет, какие динамические соединители выровнены друг над другом.
  
|**Значение**|**Корректировка**|**Константа автоматизации**|
|:-----|:-----|:-----|
|0  <br/> |Стиль маршрутки по умолчанию  <br/> |**visPLOLineAdjustToDefault** <br/> |
|1   <br/> |Линии, близкие друг к другу  <br/> |**visPLOLineAdjustToAll** <br/> |
