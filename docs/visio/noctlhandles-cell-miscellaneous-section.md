...
Переключает отображение ручки управления для выбранной фигуры.
  
|**Значение**|**Описание**|
|:-----|:-----|
| TRUE  <br/> | Ручки управления не отображаются при выборе фигуры.  <br/> |
| FALSE  <br/> | При выборе фигуры отображаются ручки управления.  <br/> |
