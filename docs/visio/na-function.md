...
Используйте функцию NA в ячейке ShapeSheet, где отсутствуют сведения, чтобы значение ячейки по умолчанию не использовало в расчетах.
...
NA — это значение ошибки, которое означает "нет доступного значения".
