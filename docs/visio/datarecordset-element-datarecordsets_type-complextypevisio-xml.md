...
---
# <a name="datarecordset-element-datarecordsetstype-complextype-visio-xml"></a>Элемент Датарекордсетс_типе complexType (complexType) (' XML ' Visio ')
...
|ИД  <br/> |XSD: Унсигнединт  <br/> |Обязательный  <br/> |Идентификатор набора записей данных, уникальный в пределах документа.  <br/> |Значения типа XSD: Унсигнединт.  <br/> |
