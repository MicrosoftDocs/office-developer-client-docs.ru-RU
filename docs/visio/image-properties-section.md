...
Содержит значения гамма, яркости, контраста, размытия, резкости и нешума для растровых изображений (изображение, состоящее из точек) и отображается в окне таблицы свойств фигуры только для таких объектов.
