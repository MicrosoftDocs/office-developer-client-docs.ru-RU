...
Определяет, локализованы ли фигуры при копировании между документами.
  
|**Значение**|**Описание**|
|:-----|:-----|
| TRUE  <br/> | Локализовать фигуру на языке документа назначения.  <br/> |
| FALSE  <br/> | Не локализовать форму на основе языка документа назначения (по умолчанию).  <br/> |
   
## <a name="remarks"></a>Примечания

Чтобы получить ссылку на ячейку LocalizeMerge по имени из другой формулы или из программы с помощью свойства **CellsU,** используйте: 
