---
title: Элемент Cell (строка RelMoveTo) (Visio XML)
manager: soliver
ms.date: 03/09/2015
...
description: Содержит координаты X или Y первой вершины фигуры или координаты X или Y первой вершины после разрыва пути относительно высоты и ширины фигуры.
...
---
# <a name="cell-element-relmoveto-row-visio-xml"></a>Элемент Cell (строка RelMoveTo) (Visio XML)

Содержит координаты X или Y первой вершины фигуры или координаты X или Y первой вершины после разрыва пути относительно высоты и ширины фигуры.
...
|:-----|:-----|:-----|
|[Элемент Row (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[RelMoveTo_Type](relmoveto_type-complextypevisio-xml.md) <br/> |Содержит координаты X или Y первой вершины фигуры или координаты X или Y первой вершины после разрыва пути относительно высоты и ширины фигуры.  <br/> |
...
|:-----|:-----|:-----|
|X  <br/> |Если **строка RelMoveTo** является первой строкой в разделе, ячейка **X** представляет x-координату первой вершины фигуры относительно ширины фигуры. Если **строка RelMoveTo** отображается между двумя строками, ячейка X представляет координату **X** первой вершины после разрыва пути.  <br/> |[RelMoveTo Row (Geometry Section)](relmoveto-row-geometry-section.md) <br/> |
|Да  <br/> |Если **строка RelMoveTo** является первой строкой в разделе, ячейка Y представляет координату **Y** первой вершины фигуры относительно высоты фигуры. Если **строка RelMoveTo** отображается между двумя строками, ячейка Y представляет координату **Y** первой вершины после разрыва пути.  <br/> |[RelMoveTo Row (Geometry Section)](relmoveto-row-geometry-section.md) <br/> |
