...
|:-----|:-----|:-----|
|[Элемент Row (геометрия)](row-element-geometry-sectionvisio-xml.md) <br/> |[RelMoveTo_Type](relmoveto_type-complextypevisio-xml.md) <br/> |Содержит координаты x или y первой вершины фигуры, а также координаты x или y первой вершины после разрыва в контуре относительно высоты и ширины фигуры.  <br/> |
