...
Определяет, появится ли тег действия, когда пользователь перемещает указатель по тегу, когда выбрана фигура или все время.
...
|:-----|:-----|:-----|
| 0  <br/> | Отображается при приостановке мыши над тегом (по умолчанию).  <br/> |**visSmartTagDispModeMouseOver** <br/> |
...
Теги действий не отображаются на печатных или опубликованных выводах. 
  
Если тег действия определяется для страницы и эта ячейка содержит значение 1, тег никогда не отображается, так как страница не может быть выбрана. 
...
|||
|:-----|:-----|
| Имя ячейки:  <br/> | SmartTags.  *имя*  . DisplayMode, где SmartTags. *имя* — название строки тегов действий.  <br/> |
