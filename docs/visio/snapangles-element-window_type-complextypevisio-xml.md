---
title: Элемент SnapAngles (Window_Type complexType) (XML для Visio)
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="snapangles-element-window_type-complextype-visio-xml"></a>Элемент SnapAngles (Window_Type complexType) (XML для Visio)
