...
---
# <a name="cell-element-arcto-row-visio-xml"></a>Элемент Cell (строка ArcTo) (Visio XML)

Содержит координату x, координату Y или яс цикловой дуги.
...
|:-----|:-----|:-----|
|[Элемент Row (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[ArcTo_Type](arcto_type-complextypevisio-xml.md) <br/> |Содержит координаты x и y и лук цикловой дуги.  <br/> |
   
### <a name="child-elements"></a>Дочерние элементы

|**Элемент**|**Тип**|**Описание**|
|:-----|:-----|:-----|
|[RefBy](refby-element-cell_type-complextypevisio-xml.md) <br/> |[RefBy_Type](refby_type-complextypevisio-xml.md) <br/> |Содержит координату x, координату y или лук цикловой дуги.  <br/> |
...
|:-----|:-----|:-----|
|A  <br/> |Расстояние от средней точки дуги до средней точки ее разоряемой.  <br/> |[ArcTo Row (Geometry Section)](arcto-row-geometry-section.md) <br/> |
|X  <br/> |X-координата конечной вершины дуги.  <br/> |[ArcTo Row (Geometry Section)](arcto-row-geometry-section.md) <br/> |
|Да  <br/> |Y-координата конечной вершины дуги.  <br/> |[ArcTo Row (Geometry Section)](arcto-row-geometry-section.md) <br/> |
