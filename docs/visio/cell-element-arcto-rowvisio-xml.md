...
---
# <a name="cell-element-arcto-row-visio-xml"></a>Элемент Cell (ArcTo Row) (Visio XML)
...
|:-----|:-----|:-----|
|[Элемент Row (Геометрия)](row-element-geometry-sectionvisio-xml.md) <br/> |[ArcTo_Type](arcto_type-complextypevisio-xml.md) <br/> |Содержит x- и y-координаты и нос круговой дуги.  <br/> |
   
### <a name="child-elements"></a>Дочерние элементы

|**Элемент**|**Тип**|**Описание**|
|:-----|:-----|:-----|
|[RefBy](refby-element-cell_type-complextypevisio-xml.md) <br/> |[RefBy_Type](refby_type-complextypevisio-xml.md) <br/> |Содержит координаты x, координаты y или лук круговой дуги.  <br/> |
...
|:-----|:-----|:-----|
|A  <br/> |Расстояние от середины дуги до середины аккорда.  <br/> |[ArcTo Row (Geometry Section)](arcto-row-geometry-section.md) <br/> |
