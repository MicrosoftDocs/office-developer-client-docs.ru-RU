...
|:-----|:-----|:-----|
|A  <br/> |Расстояние от среднего дуги по центру его кабеля.  <br/> |[Строка ArcTo (раздел геометрии)](arcto-row-geometry-section.md) <br/> |
|X   <br/> |X координата конца вершины дугу.  <br/> |[Строка ArcTo (раздел геометрии)](arcto-row-geometry-section.md) <br/> |
|Да  <br/> |Окончания вершина дуги по оси y.  <br/> |[Строка ArcTo (раздел геометрии)](arcto-row-geometry-section.md) <br/> |
