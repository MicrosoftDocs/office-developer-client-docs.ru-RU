...
Указывает описательный или инструктивный текст, который отображается как подсказка при приостановке мыши над значением в окне **"Данные** фигуры". 
...
|||
|:-----|:-----|
| Имя ячейки:  <br/> | Реквизит.  *Имя*  . Запрос,  *где Name*  — имя строки  <br/> |
