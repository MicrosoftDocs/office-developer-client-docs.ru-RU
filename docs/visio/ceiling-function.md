...
Округляет число от 0 (ноль) к следующему экземпляру  _из_ нескольких. Если  _не_ указано несколько, число округлит от 0 до следующего числа. 
...
| _multiple_ <br/> |Обязательна  <br/> |**Number** <br/> |Кратное к округлу.  <br/> |
