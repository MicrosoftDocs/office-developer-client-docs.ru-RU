...
|:-----|:-----|:-----|:-----|
| _angle_ <br/> |Обязательна  <br/> |**Числовой** <br/> |Угол, под которым будет получаться параболический тангенс.  <br/> |
...
Функция TANH использует радианы, если не указать другую единицу измерения в *углу.* 
