...
Определяет, можно ли добавить фигуру в группу, перенанося ее в группу.
...
Вы также можете установить это значение, выбрав  фигуру, щелкнув вкладку "Поведение" на вкладке "Разработчик", а затем выбрав фигуру "Добавить в группы" по **установленной** кнопке. [](run-in-developer-mode-display-the-developer-tab.md) 
  
Помимо включения этого поведения для фигуры, необходимо также включить группу, чтобы принимать фигуры, которые перетаскивание в нее. Для этого выберите группу,  щелкните [](run-in-developer-mode-display-the-developer-tab.md) "Поведение" на вкладке "Разработчик" и выберите "Принять отброшенные фигуры".  Это значение хранится в ячейке IsDropTarget в разделе "Свойства группы". 
