...
Указывает, отображается ли гиперссылка в меню ярлыка для фигуры или страницы. 
  
|**Значение**|**Описание**|
|:-----|:-----|
|TRUE  <br/> |Гиперссылка не появляется в качестве элемента меню в меню ярлыка.  <br/> |
|FALSE  <br/> |Гиперссылка появляется как элемент меню в меню ярлыка (по умолчанию).  <br/> |
...
|||
|:-----|:-----|
|Имя ячейки:  <br/> |Гиперссылка. *имя*  . Невидимый, где  *имя Hyperlink .name*  — это имя строки  <br/> |
