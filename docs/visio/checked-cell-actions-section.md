...
Указывает, проверяется ли элемент в меню ярлыка или тега действий.
...
|**Значение**|**Описание**|
|:-----|:-----|
|TRUE  <br/> |Отображается контрольный знак.  <br/> |
|FALSE  <br/> |Контрольный знак не отображается (по умолчанию).  <br/> |
...
|||
|:-----|:-----|
|Имя ячейки:  <br/> |Действия. *имя*  . Проверено, где действия. *имя*  — это имя строки Действия  <br/> |
   
Чтобы получить ссылку на ячейку Checked by index из программы, используйте свойство **CellsSRC** со следующими аргументами: 
