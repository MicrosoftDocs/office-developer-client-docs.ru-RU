...
---
# <a name="cell-element-lineto-row-visio-xml"></a>Элемент Cell (строка LineTo) (XML в Visio)
...
|:-----|:-----|:-----|
|[Элемент Row (геометрия)](row-element-geometry-sectionvisio-xml.md) <br/> |[LineTo_Type](lineto_type-complextypevisio-xml.md) <br/> |Содержит координаты x или y конечной вершины сегмента прямой линии.  <br/> |
...
|:-----|:-----|:-----|
|X  <br/> |Координата x конечной вершины сегмента прямой линии.  <br/> |[LineTo Row (Geometry Section)](lineto-row-geometry-section.md) <br/> |
|Да  <br/> |Координата y конечной вершины сегмента прямой линии.  <br/> |[LineTo Row (Geometry Section)](lineto-row-geometry-section.md) <br/> |
