...
Определяет, можно ли изменить вариант темы, примененный к странице или фигуре, в качестве boolean.
  
|||
|:-----|:-----|
|TRUE  <br/> |Текущий вариант, примененный к странице или фигуре, изменить нельзя.  <br/> |
|FALSE  <br/> |Вариант страницы или фигуры можно изменить.  <br/> |
