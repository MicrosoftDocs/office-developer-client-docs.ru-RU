...
---
# <a name="ellipsetype-complextype-visio-xml"></a>Еллипсе_типе complexType (XML для Visio)
...
|:-----|:-----|:-----|
|[Cell](cell-element-ellipse-rowvisio-xml.md) <br/> |[Целл_типе](cell_type-complextypevisio-xml.md) <br/> ||
