...
---
# <a name="actionstype-complextype-visio-xml"></a>Актионс_типе complexType (XML для Visio)
...
|:-----|:-----|:-----|
|[Row](row-element-actions-sectionvisio-xml.md) <br/> |[Актионсров_типе](actionsrow_type-complextypevisio-xml.md) <br/> ||
