...
---
# <a name="connectiontype-complextype-visio-xml"></a>Коннектион_типе complexType (XML для Visio)
...
|:-----|:-----|:-----|
|[Row](row-element-connection-sectionvisio-xml.md) <br/> |[Коннектионров_типе](connectionrow_type-complextypevisio-xml.md) <br/> ||
