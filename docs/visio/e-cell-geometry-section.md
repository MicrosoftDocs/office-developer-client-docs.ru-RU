...
Содержит несвязаную рациональную формулу B-spline (NURBS).
  
## <a name="remarks"></a>Примечания

Чтобы получить ссылку на ячейку E по имени из другой формулы или из программы, использующей свойство **CellsU,** используйте: 
  
|||
|:-----|:-----|
| Имя ячейки:  <br/> | Геометрия  *i*  . E  *j*            where  *i*  and  *j*  = <1>, 2, 3...  <br/> |
