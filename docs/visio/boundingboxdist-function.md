...
|:-----|:-----|:-----|:-----|
| _Index_ <br/> |Обязательна  <br/> |**Number** <br/> |Часть ограничительной рамки фигуры для измерения и возврата. Возможные значения приведены в разделе remarks.  <br/> |
...
|Прикрепление фигуры к верхнему краю  <br/> |4   <br/> |
|По нижнему краю до фигуры контакта  <br/> |5   <br/> |
|Центр ограничительной рамки для PinX  <br/> |6   <br/> |
|Центр ограничительной рамки для PinY  <br/> |7   <br/> |
