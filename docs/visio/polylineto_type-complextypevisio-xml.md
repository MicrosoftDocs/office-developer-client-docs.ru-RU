...
---
# <a name="polylinetotype-complextype-visio-xml"></a>Полилинето_типе complexType (XML для Visio)
...
|:-----|:-----|:-----|
|[Cell](cell-element-polylineto-rowvisio-xml.md) <br/> |[Целл_типе](cell_type-complextypevisio-xml.md) <br/> ||
