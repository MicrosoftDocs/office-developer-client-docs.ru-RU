---
title: Элемент HeaderLeft (HeaderFooter_Type complexType) (XML для Visio)
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="headerleft-element-headerfooter_type-complextype-visio-xml"></a>Элемент HeaderLeft (HeaderFooter_Type complexType) (XML для Visio)
