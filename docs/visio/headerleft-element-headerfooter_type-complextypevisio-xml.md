...
---
# <a name="headerleft-element-headerfooter_type-complextype-visio-xml"></a>Элемент HeaderLeft (HeaderFooter_Type complexType) (Visio XML)

Содержит текстовую строку, которая отображается в левой части загона документа.
