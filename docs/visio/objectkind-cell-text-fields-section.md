...
| 1  <br/> |Горизонтальная по вертикали  <br/> |**visTFOKHorizontaInVertical** <br/> |
   
## <a name="remarks"></a>Примечания

Текстовые поля могут быть одним из следующих типов:
  
- Стандарт, указывающий, что поле было вставлено по категории полей.
    
- Горизонтальная по вертикали, указывающая, что поле является горизонтальным текстовым набором в вертикальном тексте.
