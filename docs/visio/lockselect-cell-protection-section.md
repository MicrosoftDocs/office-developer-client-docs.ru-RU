...
|**Значение**|**Описание**|
|:-----|:-----|
| TRUE  <br/> | Не удается выбрать фигуру.  <br/> |
| FALSE  <br/> | Фигуру можно выбрать.  <br/> |
   
## <a name="remarks"></a>Примечания

Чтобы lockSelect вступил в силу, в диалоговом окне "Защита документа" должен быть выбран соответствующий контроль.   
