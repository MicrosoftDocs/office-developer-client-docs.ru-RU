...
## <a name="remarks"></a>Примечания
 ...
 Это значение по умолчанию по  умолчанию для имени, найденного в поле Имя пользователя на общей вкладке диалогового окна **Visio Параметры** (щелкните вкладку  **Файл,** щелкните Параметры, а затем нажмите кнопку **Общие**).  
  
Чтобы получить ссылку на ячейку Name по имени из другой формулы или из программы с помощью свойства **CellsU,** используйте: 
  
|||
|:-----|:-----|
| Имя ячейки:  <br/> | Reviewer.Name ,  *где*  *i*  = <1>, 2, 3...  <br/> |
