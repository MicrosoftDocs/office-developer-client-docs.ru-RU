...
|1  <br/> |Подгонка страницы для рисования содержимого  <br/> |**visTight** <br/> |
|2  <br/> |Стандартный  <br/> |**visStandard** <br/> |
|3  <br/> |Настраиваемый размер страницы  <br/> |**visCustom** <br/> |
|4   <br/> |Пользовательский масштабный размер рисования  <br/> |**visLogical** <br/> |
...
Чтобы установить размер рисунка, используйте диалоговое окно  **Установки** страницы (щелкните стрелку установки страницы на вкладке **Design)** или вручную перенастройте страницу с помощью мыши. 
