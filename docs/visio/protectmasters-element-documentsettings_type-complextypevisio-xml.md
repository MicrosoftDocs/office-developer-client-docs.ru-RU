...
Указывает, не мешает ли пользователю создавать, редактировать или удалять мастер-фигуры. Пользователь по-прежнему может создавать новые фигуры из мастер-формы, независимо от этого параметра. 
  
Диапазон возможных значений для этого элемента : "0" или "1". Значение "0" указывает, что пользователи могут создавать, редактировать или удалять мастер-фигуры. Значение "1" указывает на то, что пользователи не могут создавать, изменять или удалять мастер-фигуры.
