...
description: Настраивает контрастность ток-изображения. Уменьшите контрастность изображения, введите значение от 0 до 49 % или увеличив контраст, введите значение от 51% до 100%. Значение по умолчанию — 50%.
...
Настраивает контрастность ток-изображения. Уменьшите контрастность изображения, введите значение от 0 до 49 % или увеличив контраст, введите значение от 51% до 100%. Значение по умолчанию — 50%.
