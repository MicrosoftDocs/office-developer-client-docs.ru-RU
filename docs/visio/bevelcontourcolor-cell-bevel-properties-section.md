...
description: Определяет цвет контура bevel в значении RGB или определяется активной темой.
...
Определяет цвет контура bevel в значении RGB или определяется активной темой.
  
## <a name="remarks"></a>Примечания

Чтобы получить ссылку на ячейку **BevelContourColor** по имени из другой формулы, по значению **атрибута N** элемента **Cell** или из программы с использованием свойства **CellsU,** используйте: 
