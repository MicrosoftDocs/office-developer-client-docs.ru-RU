...
---
# <a name="showrulers-element-window_type-complextype-visio-xml"></a>Элемент ShowRulers (Window_Type ComplexType) (Visio XML)

Указывает, показаны ли линейки в окне рисования.
