...
Указывает, можно ли печатать фигуры, принадлежащие слои.
  
|**Значение**|**Описание**|
|:-----|:-----|
|TRUE  <br/> |Фигуры можно печатать.  <br/> |
|FALSE  <br/> |Фигуры невозможно печатать.  <br/> |
   
## <a name="remarks"></a>Примечания

Это значение также можно установить  с помощью параметра "Печать" в  диалоговом  **окне** "Свойства слоя" (на вкладке "Главная" в группе редактирования щелкните "Слои" и выберите "Свойства уровня"). 
