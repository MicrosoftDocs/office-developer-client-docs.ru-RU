...
Определяет  *Y-компонент*  для требуемого вектора выравнивания совпадающих точек подключения. Он также используется для ориентировки присоединенной ногой динамического соединителя. Эта ячейка принимает значение с плавающей за точкой. 
...
|Индекс ячейки:  <br/> |**visCnnctDirY** (неширимые строки)           **visCnnctB** (расширенные строки)  <br/> |
