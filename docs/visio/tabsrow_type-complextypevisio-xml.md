...
---
# <a name="tabsrowtype-complextype-visio-xml"></a>Табсров_типе complexType (XML для Visio)
...
|:-----|:-----|:-----|
|[Cell](cell-element-tabs-sectionvisio-xml.md) <br/> |[Целл_типе](cell_type-complextypevisio-xml.md) <br/> ||
