...
|:-----|:-----|:-----|:-----|
| _число_ <br/> |Обязательна  <br/> |**Числовой** <br/> |Число, квадратный корень которого требуется найти.  <br/> |
...
Если _число_ отрицательно, функция SQRT возвращает значение ошибки #NUM!. 
