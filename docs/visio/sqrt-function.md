...
Возвращает квадратный корневой корень номера. 
...
|:-----|:-----|:-----|:-----|
| _число_ <br/> |Обязательный  <br/> |**Числовой** <br/> |Номер, квадратный корень которого необходимо найти.  <br/> |
...
Если  _число_ отрицательное, функция SQRT возвращает значение ошибки #NUM!. 
