...
description: Включает и выключает отображение прямоугольника выбора для выбранной формы.
...
Включает и выключает отображение прямоугольника выбора для выбранной формы.
  
|**Значение**|**Описание**|
|:-----|:-----|
| TRUE  <br/> | Прямоугольник выбора не отображается при выборе фигуры.  <br/> |
| FALSE  <br/> | Прямоугольник выбора отображается при выборе фигуры.  <br/> |
   
## <a name="remarks"></a>Примечания

Чтобы получить ссылку на ячейку NoAlignBox по имени из другой формулы или из программы с помощью свойства **CellsU,** используйте: 
