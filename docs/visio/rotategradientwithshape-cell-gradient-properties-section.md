...
Определяет, вращается ли градиент заполнения с фигурой в 2D-повороте в виде boolean.
  
|**Значение**|**Описание**|
|:-----|:-----|
|TRUE  <br/> |Градиент вращается с фигурой, когда фигура вращается вокруг штыря вращения. "Верхняя часть" градиента параллельна с ручкой вращения.  <br/> |
|FALSE  <br/> |Градиент не вращается вместе с фигурой, когда фигура вращается вокруг штыря вращения. "Верхняя часть" градиента параллельна полотну рисования.  <br/> |
