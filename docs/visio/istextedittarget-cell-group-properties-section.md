...
|FALSE  <br/> |Текст добавляется в фигуру в группе в верхней части порядка стека.  <br/> |
   
## <a name="remarks"></a>Примечания

Вы также можете установить это значение, выбрав  группу, щелкнув "Поведение" на вкладке "Разработчик", а затем выбрав "Изменить текст" в **группе.** [](run-in-developer-mode-display-the-developer-tab.md) 
  
Группы, созданные в версиях, более ранних, чем Visio 2000, имеют значение false по умолчанию. Начиная с Visio версии 2000, значение по умолчанию — TRUE. 
  
Чтобы получить ссылку на ячейку IsTextEditTarget по имени из другой формулы или из программы с помощью свойства **CellsU,** используйте: 
