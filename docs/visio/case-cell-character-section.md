...
Определяет случай текста фигуры. Все капитальные (верхние) буквы (1) и начальные закавказные буквы (2) не изменяют внешний вид текста, который был введен во всех закавляемой букве. Текст должен быть вписано в нижние буквы, чтобы эти параметры показали эффект.
  
|**Значение**|**Описание**|**Константа автоматизации**|
|:-----|:-----|:-----|
| 0  <br/> | Нормальный случай  <br/> |**visCaseNormal** <br/> |
| 1  <br/> | Все капитальные (верхние) буквы  <br/> |**visCaseAllCaps** <br/> |
