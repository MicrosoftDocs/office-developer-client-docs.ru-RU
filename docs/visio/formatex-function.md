...
| _сркунит_ <br/> |Необязательна  <br/> |**String** <br/> | Единицы измерения, используемые для вычисления выражения (в, cm и т. д.).  <br/> |
| _дстунит_ <br/> |Необязательна  <br/> |**String** <br/> |Единица, используемая для результата выражения (in, cm и т. д.).  <br/> |
| _langID_ <br/> |Необязательна  <br/> |**Number** <br/> |Язык, используемый при форматировании изображений даты и времени в системе Microsoft Office.  <br/> |
| _калид_ <br/> |Необязательна  <br/> |**Number** <br/> |Календарь, используемый при форматировании изображений даты и времени в системе Microsoft Office.  <br/> |
