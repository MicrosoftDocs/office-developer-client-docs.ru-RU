...
Указывает, имеет ли строка стрелку или другой формат конца линии в последней вершине.
...
Это значение также можно установить в диалоговом  окне  **"Строка"** (на вкладке "Главная" в группе "Фигура" щелкните **"Строка",**"Стрелки" и "Стрелки").  Размер стрелки устанавливается в ячейке EndArrowSize.
