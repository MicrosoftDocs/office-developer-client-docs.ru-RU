...
---
# <a name="tabstype-complextype-visio-xml"></a>Табс_типе complexType (XML для Visio)
...
|:-----|:-----|:-----|
|[Row](row-element-tabs-sectionvisio-xml.md) <br/> |[Табсров_типе](tabsrow_type-complextypevisio-xml.md) <br/> ||
