...
---
# <a name="issues_type-complextype-visio-xml"></a>Issues_Type complexType (XML для Visio)
...
|:-----|:-----|:-----|
|[Проблема](issue-element-issues_type-complextypevisio-xml.md) <br/> |[Issue_Type](issue_type-complextypevisio-xml.md) <br/> ||
