...
| _num_chars_opt_ <br/> |Необязательный  <br/> |**Числовой** <br/> |Количество символов, которые нужно извлечь.  <br/> |
...
Если  _num_chars_opt_ больше длины текста, left возвращает весь текст. Если  _num_chars_opt_ опущен, предполагается, что это 1. 
