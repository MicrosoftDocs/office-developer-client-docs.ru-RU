...
|:-----|:-----|:-----|
|[Элемент Row (раздел "данные фигуры")](row-element-shape-data-sectionvisio-xml.md) <br/> |[Data_Type фигуры](propertyrow_type-complextypevisio-xml.md) <br/> |Задает одну запись данных фигуры для связывания данных с фигурой.  <br/> |
