...
Определяет, следует ли фигура параллельному повороту, повороту перспективы или повороту косой точки в виде одного или того же друг другу в виде 0–6. 
  
|**Значение**|**Описание**|
|:-----|:-----|
|0  <br/> |Фигура не имеет поворота.  <br/> |
|1   <br/> |Фигура имеет параллельный поворот.  <br/> |
|2   <br/> |Фигура имеет поворот перспективы.  <br/> |
|3   <br/> |Фигура имеет левый верхний поворот косой оси.  <br/> |
|4   <br/> |Фигура имеет правый верхний поворот косой оси.  <br/> |
|5   <br/> |Фигура имеет левый нижний поворот косой оси.  <br/> |
|6   <br/> |Фигура имеет правый нижний поворот косой оси.  <br/> |
   
## <a name="remarks"></a>Примечания

Чтобы получить ссылку на ячейку **RotationType** по имени из другой формулы, по значению атрибута **N** элемента **Cell** или из программы, использующей свойство **CellsU,** используйте: 
