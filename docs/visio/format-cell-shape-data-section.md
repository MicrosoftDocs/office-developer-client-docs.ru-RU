...
|:-----|:-----|:-----|
| String  <br/> | нуль  <br/> | Формат рисунка, соответствующий типу данных.  <br/> |
...
| Список переменных  <br/> | 4   <br/> | Элементы, которые будут отображаться в списке через точку с запятой.  <br/> |
| Дата или время  <br/> | 5   <br/> | Формат рисунка, соответствующий типу данных.  <br/> |
| Длительность  <br/> | 6   <br/> | Формат рисунка, соответствующий типу данных.  <br/> |
