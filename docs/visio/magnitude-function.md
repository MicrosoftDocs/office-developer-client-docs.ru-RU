...
|:-----|:-----|:-----|:-----|
| _Константа_ <br/> |Обязательный  <br/> |**Number** <br/> |Константа, на которой умножается подъем.  <br/> |
| _Определенно_ <br/> |Обязательный  <br/> |**Number** <br/> |Подъем.  <br/> |
| _Константб_ <br/> |Обязательный  <br/> |**Number** <br/> |Константа, на которую умножается выполнение.  <br/> |
| _З_ <br/> |Обязательный  <br/> |**Number** <br/> |Запуск.  <br/> |
