...
Указывает, может ли фигура участвовать в операции замены (в качестве целевой или заменяемой фигуры). 
  
|**Значение**|**Описание**|
|:-----|:-----|
|TRUE  <br/> |Фигуру нельзя заменить или использовать в качестве замены.  <br/> Для фигуры на холсте кнопка "Изменить **фигуру"** отключена при выборе фигуры.  <br/> Для фигуры на трафарете она не появляется в  качестве замены при нажатии кнопки "Изменить фигуру".  <br/> |
