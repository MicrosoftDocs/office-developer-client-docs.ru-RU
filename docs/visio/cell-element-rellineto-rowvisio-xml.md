...
---
# <a name="cell-element-rellineto-row-visio-xml"></a>Элемент Cell (строка RelLineTo) (Visio XML)
...
|:-----|:-----|:-----|
|[Элемент Row (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[RelLineTo_Type](rellineto_type-complextypevisio-xml.md) <br/> |Содержит координаты x или y конечной вершины прямого сегмента относительно ширины и высоты фигуры.  <br/> |
...
|:-----|:-----|:-----|
|X  <br/> |X-координата конечной вершины прямого сегмента относительно ширины фигуры.  <br/> |[RelLineTo Row (Geometry Section)](rellineto-row-geometry-section.md) <br/> |
