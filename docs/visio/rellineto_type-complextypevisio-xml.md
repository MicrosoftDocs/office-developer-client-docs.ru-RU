...
---
# <a name="rellinetotype-complextype-visio-xml"></a>Реллинето_типе complexType (XML для Visio)
...
|:-----|:-----|:-----|
|[Cell](cell-element-rellineto-rowvisio-xml.md) <br/> |[Целл_типе](cell_type-complextypevisio-xml.md) <br/> ||
