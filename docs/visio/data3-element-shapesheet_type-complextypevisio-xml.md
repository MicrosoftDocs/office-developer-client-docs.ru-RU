---
title: Элемент Data3 (ShapeSheet_Type complexType) (Visio XML)
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="data3-element-shapesheet_type-complextype-visio-xml"></a>Элемент Data3 (ShapeSheet_Type complexType) (Visio XML)
