...
Определяет, может ли пользователь добавлять, удалять или изменять данные фигур в пользовательском  интерфейсе с помощью диалоговых окон "Определение данных фигуры" или ярлыка для окна **"Данные** фигуры". 
  
|**Значение**|**Описание**|
|:-----|:-----|
|TRUE  <br/> |Команда **"Определение данных фигуры"** в ярлыковом меню в окне **"Данные** фигуры" отключена.  <br/> |
|FALSE  <br/> |Команда **"Определение данных фигуры"** в ярлыковом меню в окне **"Данные** фигуры" включена (по умолчанию).  <br/> |
   
## <a name="remarks"></a>Примечания

Значение TRUE не мешает пользователю изменять значение элемента данных фигуры или раздел "Данные фигуры" в окне Таблицы фигур. 
