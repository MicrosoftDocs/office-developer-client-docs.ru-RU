...
|:-----|:-----|:-----|
|[Элемент Row (Раздел Царапины)](row-element-scratch-sectionvisio-xml.md) <br/> |[ScratchRow_Type](scratch_type-complextypevisio-xml.md) <br/> |Указывает область работы для ввода и тестирования формул, на которые могут ссылаться другие ячейки.  <br/> |
...
|:-----|:-----|:-----|
|A  <br/> |Ячейка нуля, которую можно использовать для ввода или тестирования формул.  <br/> |[Scratch Section](scratch-section.md) <br/> |
|B  <br/> |Ячейка нуля, которую можно использовать для ввода или тестирования формул.  <br/> |[Scratch Section](scratch-section.md) <br/> |
|C  <br/> |Ячейка нуля, которую можно использовать для ввода или тестирования формул.  <br/> |[Scratch Section](scratch-section.md) <br/> |
|D  <br/> |Ячейка нуля, которую можно использовать для ввода или тестирования формул.  <br/> |[Scratch Section](scratch-section.md) <br/> |
|X  <br/> |Ячейка нуля, которую можно использовать для ввода или тестирования формул.  <br/> |[Scratch Section](scratch-section.md) <br/> |
|Да  <br/> |Ячейка нуля, которую можно использовать для ввода или тестирования формул.  <br/> |[Scratch Section](scratch-section.md) <br/> |
