...
Содержит строку, описываемую тегом действия, который отображается в качестве подсказки, когда пользователь нанося указатель на тег.
...
|||
|:-----|:-----|
| Имя ячейки:  <br/> | SmartTags.  *name*  . Описание, где smartTags. *имя* — название строки тегов действий.  <br/> |
