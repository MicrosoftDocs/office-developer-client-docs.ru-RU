...
Содержит строку, описывающую тег действия, который отображается как всплывающая подсказка, когда пользователь наводит указатель мыши на тег.
...
|||
|:-----|:-----|
| Имя ячейки:  <br/> | SmartTags.  *Name (имя* ). Description, где SmartTags. *имя* — название строки тегов действий.  <br/> |
...
| Индекс ячейки:  <br/> |**Виссмарттагдескриптион** <br/> |
