...
Возвращает последний символ или символ в текстовой строке в зависимости от количества символов, которые вы указываете.
...
| _num_chars_opt_ <br/> |Необязательный  <br/> |**Number** <br/> |Количество символов, которые необходимо извлечь. По умолчанию используется значение 1.  <br/> |
...
Если  _num_chars_opt_ больше длины текста, право возвращает весь текст. Если  _num_chars_opt_ опущен, предполагается, что это будет 1. 
