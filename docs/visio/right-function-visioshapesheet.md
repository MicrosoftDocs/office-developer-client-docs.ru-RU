...
| _num_chars_opt_ <br/> |Необязательна  <br/> |**Number** <br/> |Число знаков, которое необходимо извлечь. По умолчанию используется значение 1.  <br/> |
...
Если _num_chars_opt_ больше длины текста, то право возвращает весь текст. Если параметр _num_chars_opt_ опущен, предполагается, что он равен 1. 
