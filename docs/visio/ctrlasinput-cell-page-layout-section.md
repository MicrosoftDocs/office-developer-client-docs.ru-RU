...
Определяет, какая фигура является родительской при использовании фигур с окнами управления. Эта ячейка задает поведение для всех фигур на странице рисования.
  
|**Значение**|**Описание**|
|:-----|:-----|
| TRUE  <br/> | За установите фигуру, к которую подключено handle-контроля, в качестве родительского.  <br/> |
| FALSE  <br/> | Значение по умолчанию. За установите фигуру, содержаную handle для управления, в качестве родительского.  <br/> |
