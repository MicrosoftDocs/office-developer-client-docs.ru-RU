...
|:-----|:-----|:-----|
|[Pages](pages-elementvisio-xml.md) <br/> |[Pages_Type](pages_type-complextypevisio-xml.md) <br/> |Содержит **элементы Страницы** для документа.  <br/> |
...
|BackPage  <br/> |xsd:unsignedInt  <br/> |необязательный  <br/> |ID фоновой страницы этой страницы.  <br/> |Значения типа xsd:unsignedInt.  <br/> |
...
|ReviewerID  <br/> |xsd:unsignedInt  <br/> |необязательный  <br/> |ID рецензента, связанный с наложением разметки.  <br/> |Значения типа xsd:unsignedInt.  <br/> |
