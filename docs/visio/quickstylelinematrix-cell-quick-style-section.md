...
Определяет стиль строки "Быстрый стиль", наследуемый фигурой, в виде integer от 0 до 6. 
  
## <a name="remarks"></a>Примечания

Чтобы получить ссылку на ячейку **QuickStyleLineMatrix** по имени из другой формулы, по значению атрибута **N** элемента **Cell** или из программы, использующей свойство **CellsU,** используйте: 
