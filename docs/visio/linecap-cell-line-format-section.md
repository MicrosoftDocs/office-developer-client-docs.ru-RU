...
Указывает, скруглили ли строки, квадрат или расширенные строки.
  
|**Значение**|**Стиль окончания строки**|
|:-----|:-----|
|0  <br/> |Rounded  <br/> |
|1   <br/> |Square  <br/> |
|2   <br/> |Долго  <br/> |
...
Вы также можете установить значение этой ячейки в диалоговом окне **"Линия"** (на вкладке "Главная" в группе "Фигура" щелкните  **"Строка",**"Стрелки" и "Стрелки").  
