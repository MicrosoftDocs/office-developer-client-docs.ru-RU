---
title: Элемент Протектбкгндс (Документсеттингс_типе complexType) (XML для Visio)
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="protectbkgnds-element-documentsettingstype-complextype-visio-xml"></a>Элемент Протектбкгндс (Документсеттингс_типе complexType) (XML для Visio)
...
|||
|:-----|:-----|
|**Тип элемента** <br/> |[Протектбкгндс_типе](protectbkgnds_type-complextypevisio-xml.md) <br/> |
