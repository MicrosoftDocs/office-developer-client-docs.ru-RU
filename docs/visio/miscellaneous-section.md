...
В продуктах Visio версии 5,0 этот раздел включал в себя ячейки **обжинтеракт** и **обжбехавиор** . Теперь поведение в ячейке **обжинтеракт** сопоставлено со следующими ячейками в разделе Макет фигуры: **ShapeFixedCode**, **ShapePermeableX**, **ShapePermeableY**и **ShapePermeablePlace**. Теперь поведение в ячейке Обжбехавиор сопоставлено с ячейками **ConFixedCode** и **ShapeRouteStyle** . 
  
В продуктах на японском языке Visio версии 5,0 в этом разделе включена ячейка **вертикалтекст** . В продуктах Visio версии 2000 и более поздних версиях значение этой ячейки хранится в ячейке **TextDirection** в разделе **Формат текстового блока** . 
