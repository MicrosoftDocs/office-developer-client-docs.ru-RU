...
Указывает язык, на котором было вписано значение данных фигуры. 
  
## <a name="remarks"></a>Примечания

Список языков, поддерживаемых Microsoft Office системных приложений, см. в разделе [DocLangID](doclangid-cell-document-properties-section.md) Cell (Раздел свойств документов). 
  
Чтобы получить ссылку на ячейку LangID по имени из другой формулы или из программы с помощью свойства **CellsU,** используйте: 
  
|||
|:-----|:-----|
| Имя ячейки:  <br/> | Prop.  *имя*  . LangID, где Prop.  *имя*  — это имя строки  <br/> |
