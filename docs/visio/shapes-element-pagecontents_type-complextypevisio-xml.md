...
---
# <a name="shapes-element-pagecontentstype-complextype-visio-xml"></a>Элемент фигур (PageContents_Type complexType) ('Visio XML»)
...
|:-----|:-----|:-----|
|[MasterContents](mastercontents-elementvisio-xml.md) <br/> |[PageContents_Type](pagecontents_type-complextypevisio-xml.md) <br/> |Задает сведения о фигурах в главный в веб-документ.  <br/> |
|[PageContents](pagecontents-elementvisio-xml.md) <br/> |[PageContents_Type](pagecontents_type-complextypevisio-xml.md) <br/> |Задает сведения о фигурах в главный в веб-документ.  <br/> |
