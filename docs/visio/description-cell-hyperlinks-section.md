...
Используйте эту ячейку для хранения комментариев о гиперссылке; например, "Ссылка на наш веб-сайт цен".
  
Вы также можете установить значение этой  ячейки в диалоговом окне "Гиперссылки" (щелкните **"Гиперссылка"** на вкладке **"Вставка").** 
...
|||
|:-----|:-----|
| Имя ячейки:  <br/> | Гиперссылка.  *Name*  . Описание гиперссылки.  *Имя*  — имя строки гиперссылки  <br/> |
