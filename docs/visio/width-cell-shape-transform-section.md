...
Содержит ширину выбранной фигуры в единицах документа. По умолчанию для определения ширины фигуры 1-D используется следующая формула:
  
= SQRT ((EndX-BeginX) ^ 2 + (Енди-Begin) ^ 2)
  
## <a name="remarks"></a>Примечания

Чтобы получить ссылку на ячейку Width по имени из другой формулы или из программы с помощью свойства **CellsU** , используйте следующее: 
