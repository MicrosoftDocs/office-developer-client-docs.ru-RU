...
---
# <a name="actiontagtype-complextype-visio-xml"></a>Актионтаг_типе complexType (XML для Visio)
...
|:-----|:-----|:-----|
|[Row](row-element-action-tag-sectionvisio-xml.md) <br/> |[Актионтагров_типе](actiontagrow_type-complextypevisio-xml.md) <br/> ||
