...
Представляет строку, которая передает сведения, используемые при разрешении URL-адреса, например координаты карты изображения. Например, в ячейке ExtraInfo "x=41 &amp; y=7" указывает координаты карты изображения.
...
|||
|:-----|:-----|
| Имя ячейки:  <br/> | Гиперссылка.  *name*  . ExtraInfo, где гиперссылка.  *name*  — это имя строки  <br/> |
