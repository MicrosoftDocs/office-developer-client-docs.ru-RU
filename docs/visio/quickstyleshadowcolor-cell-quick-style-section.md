...
Определяет цвет темы, который использует тени фигуры, в виде integer от 0 до 7.
  
|||
|:-----|:-----|
|Значение  <br/> |Описание  <br/> |
|0  <br/> |Цвет теней фигуры наследуется от цвета темной темы.  <br/> |
|1   <br/> |Цвет тени фигуры наследуется от цвета светлой темы.  <br/> |
|2   <br/> |Цвет теней фигуры наследуется от цвета темы Accent 1.  <br/> |
|3   <br/> |Цвет теней фигуры наследуется от цвета темы Accent 2.  <br/> |
|4   <br/> |Цвет теней фигуры наследуется от цвета темы Accent 3.  <br/> |
|5   <br/> |Цвет теней фигуры наследуется от цвета темы Accent 4.  <br/> |
|6   <br/> |Цвет теней фигуры наследуется от цвета темы Accent 5.  <br/> |
|7   <br/> |Цвет теней фигуры наследуется от цвета темы Accent 6.  <br/> |
