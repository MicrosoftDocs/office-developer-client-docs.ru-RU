---
title: Элемент CustomMenusFile (DocumentSettings_Type complexType) (XML для Visio)
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="custommenusfile-element-documentsettings_type-complextype-visio-xml"></a>Элемент CustomMenusFile (DocumentSettings_Type complexType) (XML для Visio)
