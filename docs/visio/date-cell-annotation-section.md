...
В поле комментарий в пользовательском интерфейсе отображается только дата.
  
Чтобы получить ссылку на ячейку Date по имени из другой формулы или из программы с помощью свойства **CellsU** , используйте: 
  
|||
|:-----|:-----|
| Имя ячейки:  <br/> | Аннотация. Date [ *i* ], где *i* = <1>, 2, 3...  <br/> |
...
| Индекс ячейки:  <br/> |**Висаннотатиондате** <br/> |
