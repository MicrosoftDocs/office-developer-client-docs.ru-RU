...
Определяет размер размытия для тени фигуры в пунктах (от 0,00 до 100,00). 
  
## <a name="remarks"></a>Примечания

Чтобы получить ссылку на ячейку **ShapeShdwBlur** по имени из другой формулы, по значению атрибута **N** элемента **Cell** или из программы, использующей свойство **CellsU,** используйте: 
