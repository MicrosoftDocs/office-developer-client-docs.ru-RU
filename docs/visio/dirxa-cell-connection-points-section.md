...
Определяет  *x-компонент*  для необходимого вектора выравнивания точки подключения. Ячейка DirX/A также используется для ориентирования прикрепленной ногой динамического соединиттеля. Эта ячейка принимает значение плавающей точки. 
  
## <a name="remarks"></a>Примечания

Чтобы получить ссылку на ячейку DirX/A по имени из другой формулы или из программы с помощью свойства **CellsU,** используйте: 
...
| Индекс ячейки:  <br/> |**visCnnctDirX** (не расширенные строки)           **visCnnctA** (расширенные строки)  <br/> |
