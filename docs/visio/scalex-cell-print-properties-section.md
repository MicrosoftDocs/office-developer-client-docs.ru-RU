...
Это значение используется только в том случае, если значение ячейки OnPage false. Ячейки ScaleX и ScaleY всегда имеют одно и то  же значение,  соответствующее значению  в вкладке Настройка  печати в диалоговом окне Установка страницы (на вкладке Design щелкните стрелку **установки** страницы). 
