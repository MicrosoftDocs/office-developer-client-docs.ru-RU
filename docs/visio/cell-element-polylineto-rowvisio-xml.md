...
---
# <a name="cell-element-polylineto-row-visio-xml"></a>Элемент Cell (строка для Microsoft LineTo) (XML в Visio)

Содержит координаты x или y последней точки ломаной линии или формулы ломаной линии.
...
|:-----|:-----|:-----|
|[Элемент Row (геометрия)](row-element-geometry-sectionvisio-xml.md) <br/> |[PolylineTo_Type](polylineto_type-complextypevisio-xml.md) <br/> |Содержит координаты x или y последней точки ломаной линии или формулы ломаной линии.  <br/> |
...
|:-----|:-----|:-----|
|X  <br/> |Координата x конечной вершины ломаной линии.  <br/> |[PolylineTo Row (Geometry Section)](polylineto-row-geometry-section.md) <br/> |
|Да  <br/> |Координата y конечной вершины ломаной линии.  <br/> |[PolylineTo Row (Geometry Section)](polylineto-row-geometry-section.md) <br/> |
|A  <br/> |Формула ломаной линии.  <br/> |[PolylineTo Row (Geometry Section)](polylineto-row-geometry-section.md) <br/> |
