...
---
# <a name="cell-element-polylineto-row-visio-xml"></a>Элемент Cell (строка PolyLineTo) (Visio XML)

Содержит координаты X или Y последней точки многолинейной или многолинейной формулы.
...
|:-----|:-----|:-----|
|[Элемент Row (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[PolylineTo_Type](polylineto_type-complextypevisio-xml.md) <br/> |Содержит координаты X или Y последней точки многолинейной или многолинейной формулы.  <br/> |
...
|:-----|:-----|:-----|
|X  <br/> |X-координата конечной вершины многолинейной линии.  <br/> |[PolylineTo Row (Geometry Section)](polylineto-row-geometry-section.md) <br/> |
|Да  <br/> |Y-координата конечной вершины многолинейной линии.  <br/> |[PolylineTo Row (Geometry Section)](polylineto-row-geometry-section.md) <br/> |
|A  <br/> |Многолинейная формула.  <br/> |[PolylineTo Row (Geometry Section)](polylineto-row-geometry-section.md) <br/> |
