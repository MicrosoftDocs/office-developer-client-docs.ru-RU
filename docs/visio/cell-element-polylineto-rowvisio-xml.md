...
---
# <a name="cell-element-polylineto-row-visio-xml"></a>Элемент Cell (PolyLineTo Row) (Visio XML)
...
|:-----|:-----|:-----|
|[Элемент Row (Геометрия)](row-element-geometry-sectionvisio-xml.md) <br/> |[PolylineTo_Type](polylineto_type-complextypevisio-xml.md) <br/> |Содержит x или y-координаты последней точки полилиновой или полилиновой формулы.  <br/> |
...
|:-----|:-----|:-----|
|X  <br/> |X-координата конечной вершины полилина.  <br/> |[PolylineTo Row (Geometry Section)](polylineto-row-geometry-section.md) <br/> |
|Да  <br/> |Y-координата конечной вершины полилиновой линии.  <br/> |[PolylineTo Row (Geometry Section)](polylineto-row-geometry-section.md) <br/> |
|A  <br/> |Формула полилинов.  <br/> |[PolylineTo Row (Geometry Section)](polylineto-row-geometry-section.md) <br/> |
