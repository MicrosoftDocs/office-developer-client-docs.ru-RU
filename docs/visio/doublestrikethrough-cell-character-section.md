...
Определяет, отформатирован ли текст двойным зачеркиванием.
  
## <a name="remarks"></a>Примечания

Чтобы получить ссылку на ячейку DoubleStrikethrough по имени из другой формулы или из программы с помощью свойства **CellsU** , используйте следующее: 
...
| Индекс ячейки:  <br/> |**висчарактердаублестрикесраугх** <br/> |
