...
Представляет число шрифта, используемого для формата текста при указании настраиваемой строки маркера, а значение в ячейке Bullet не является нулем. 
  
## <a name="remarks"></a>Примечания

Номера шрифтов зависят от шрифтов, установленных в системе. Если значение 0 и имеется настраиваемая строка маркера, используемый шрифт будет таким же, как и шрифт первого символа абзаца.
