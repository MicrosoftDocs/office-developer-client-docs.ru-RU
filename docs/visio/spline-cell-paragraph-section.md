...
Определяет расстояние между одной строкой текста и следующей строкой в процентах, где 100 % — это высота текстовой строки.
  
|**Значение**|**Описание**|
|:-----|:-----|
| \>0  <br/> | Абсолютное расстояние, независимо от размера шрифта  <br/> |
| =0  <br/> | Установите сплошной (интервал = 100 % от размера шрифта)  <br/> |
| \<0  <br/> | Процент от размера шрифта (например, -120% дает 120 % интервала)  <br/> |
...
|||
|:-----|:-----|
| Имя ячейки:  <br/> | Para. SpLine [  *i*  ] где  *i*  = <1>, 2, 3...  <br/> |
