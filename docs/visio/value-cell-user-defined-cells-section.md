...
Указывает значение для соответствующей пользовательской ячейки.
  
## <a name="remarks"></a>Примечания

Чтобы сослаться на это значение в другой ячейке, укажите пользовательское имя, введенное в метке строки User.Row.
  
Чтобы получить ссылку на ячейку Value по имени из другой формулы или из программы с помощью свойства **CellsU,** используйте: 
  
|||
|:-----|:-----|
| Имя ячейки:  <br/> | Пользователь.  *Name*  . Значение, где пользователь.  *Имя*  — это имя строки  <br/> |
