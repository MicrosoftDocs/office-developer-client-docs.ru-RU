...
Указывает тип бумаги, на которой будет печататься страница.
  
## <a name="remarks"></a>Примечания

Этот параметр соответствует  параметру "Размер  бумаги" в диалоговом окне "Настройка печати"  (на вкладке "Конструктор" щелкните стрелку "Настройка страницы", а затем на вкладке "Настройка печати" нажмите кнопку "Настройка").    
  
Числимые значения в этой ячейке соотнося со константами (с префиксом DMPAPER), определенными для выбора бумаги в файле Microsoft Windows wingdi.h. 
