...
---
# <a name="comments-element-comments_type-complextype-visio-xml"></a>Элемент Comments (Comments_Type ComplexType) (Visio XML)

Указывает свойства, используемые для идентификации авторов и комментариев на рисунке.
