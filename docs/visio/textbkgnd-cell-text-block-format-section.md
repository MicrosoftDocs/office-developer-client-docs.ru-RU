...
Ячейка TextBkgnd может иметь любое значение от 0 до 24 или 255. Значения 0 и 255 *(visTxtBlklOpaque)* указывают на прозрачный текстовый фон. 
  
Чтобы ввести настраиваемый цвет, используйте функцию RGB или HSL плюс одну, например RGB (255 127 255)+1. Значение настраиваемого цвета — это цвет RGB, и RGB *(r, g, b*)+1, а не номер будут показаны в окне ShapeSheet. Пользовательские цвета, используемые в числовом режиме, имеют значения 25 и выше. 
  
Можно установить прозрачность цвета фона текста в ячейке TextBkgndTrans.
