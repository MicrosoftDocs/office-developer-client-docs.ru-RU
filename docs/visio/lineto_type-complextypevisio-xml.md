...
---
# <a name="linetotype-complextype-visio-xml"></a>Линето_типе complexType (XML для Visio)
...
|:-----|:-----|:-----|
|[Cell](cell-element-lineto-rowvisio-xml.md) <br/> |[Целл_типе](cell_type-complextypevisio-xml.md) <br/> ||
