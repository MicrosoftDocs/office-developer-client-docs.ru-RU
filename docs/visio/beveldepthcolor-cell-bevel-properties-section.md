...
Определяет цвет глубины bevel, как значение RGB или определяется активной темой.
  
## <a name="remarks"></a>Примечания

Чтобы получить ссылку на ячейку **BevelDepthColor** по имени из другой формулы, по значению атрибута **N** элемента **Cell** или из программы с использованием свойства **CellsU,** используйте: 
