...
|:-----|:-----|:-----|:-----|:-----|
|ActiveRecordsetID  <br/> |xsd:unsignedInt  <br/> |необязательный  <br/> |ID активного регистратора данных в окне **Внешние** данные при закрытии окна, чтобы его можно было восстановить при следующем открываемом окне.  <br/> |Значения типа xsd:unsignedInt.  <br/> |
|DataWindowOrder  <br/> |xsd:string  <br/> |необязательный  <br/> |Порядок записей данных, отображаемого на вкладке окна **внешних** данных. Упорядоченный список ID-наборов данных, разделенных полу-двоеточиями.  <br/> |Значения типа xsd:string.  <br/> |
|NextID  <br/> |xsd:unsignedInt  <br/> |Обязательный  <br/> |Следующий доступный ID для нового наборов записей данных.  <br/> |Значения типа xsd:unsignedInt.  <br/> |
