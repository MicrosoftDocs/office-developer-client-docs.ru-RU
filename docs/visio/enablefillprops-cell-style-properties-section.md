...
|**Value**|**Описание**|
|:-----|:-----|
|TRUE  <br/> |Включить свойства заливки.  <br/> |
|FALSE  <br/> |Исключите свойства заливки.  <br/> |
   
## <a name="remarks"></a>Комментарии

Чтобы получить ссылку на ячейку EnableFillProps по имени из другой формулы или из программы с помощью свойства **CellsU** , используйте следующее: 
...
|Индекс ячейки:  <br/> |**Висстилеинклудесфилл** <br/> |
