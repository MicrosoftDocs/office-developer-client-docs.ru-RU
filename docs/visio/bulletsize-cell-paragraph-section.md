...
Указывает размер пули. 
  
## <a name="remarks"></a>Примечания

Это значение может быть задано для заранее заданных или настраиваемых пуль в виде процента или определенного значения. 
  
Если значение нулевое (0), пуля имеет тот же размер шрифта, что и размер первого символа в абзаце. Если значение составляет процент, пуля имеет размер в процентах от размера шрифта первого символа в абзаце. Отрицательные цифры рассматриваются как проценты.
