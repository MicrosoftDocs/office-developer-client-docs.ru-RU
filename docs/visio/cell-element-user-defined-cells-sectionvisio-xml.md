...
---
# <a name="cell-element-user-defined-cells-section-visio-xml"></a>Элемент Cell (User-defined Cells Section) (Visio XML)

Одно свойство определенного пользователем фрагмента информации, на которое могут ссылаться другие ячейки и средства надстройки.
...
|:-----|:-----|:-----|
|[Элемент Row (User-defined Cells Section)](row-element-user-defined-cells-sectionvisio-xml.md) <br/> |[UserRow_Type](userrow_type-complextypevisio-xml.md) <br/> |Одно свойство определенного пользователем фрагмента информации, на которое могут ссылаться другие ячейки и средства надстройки.  <br/> |
...
|:-----|:-----|:-----|
|Prompt  <br/> |Указывает описательный запрос или комментарий для пользовательской ячейки.  <br/> |[Prompt Cell (User-Defined Cells Section)](prompt-cell-user-defined-cells-section.md) <br/> |
|Значение  <br/> |Указывает значение для соответствующей пользовательской ячейки.  <br/> |[Value Cell (User-Defined Cells Section)](value-cell-user-defined-cells-section.md) <br/> |
