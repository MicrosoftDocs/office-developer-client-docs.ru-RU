...
|:-----|:-----|:-----|:-----|
| _Index_ <br/> |Обязательна  <br/> |**Целое число** <br/> |Край ограничительной рамки фигуры, для которой необходимо получить координаты. Возможные значения приведены в разделе remarks.  <br/> |
