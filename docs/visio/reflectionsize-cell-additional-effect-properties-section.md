...
Чтобы получить ссылку на ячейку **ReflectionSize** по имени из другой формулы, по значению атрибута **N** элемента **ячейки** или из программы с помощью свойства **CellsU** , используйте: 
...
| Индекс ячейки:  <br/> |**Висрефлектионсизе** <br/> |
