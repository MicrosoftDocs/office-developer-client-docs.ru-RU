...
Определяет расстояние, на которое объект смещен по горизонтали от начала границы объекта. По умолчанию используется значение 0. Панорамирование объекта с помощью средства **crop** изменяет это значение. 
