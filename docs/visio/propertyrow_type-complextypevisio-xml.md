...
---
# <a name="propertyrowtype-complextype-visio-xml"></a>Пропертиров_типе complexType (XML для Visio)
...
|:-----|:-----|:-----|
|[Cell](cell-element-shape-data-sectionvisio-xml.md) <br/> |[Целл_типе](cell_type-complextypevisio-xml.md) <br/> ||
