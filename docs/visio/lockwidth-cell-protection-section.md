...
Блокирует ширину фигуры, чтобы ее ширина оставалась неизменной при ее размере.
...
Чтобы получить ссылку на ячейку LockWidth по имени из другой формулы или из программы с помощью свойства **CellsU,** используйте: 
