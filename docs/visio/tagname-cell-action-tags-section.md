...
Имя тега действия, который используется в качестве ключа для связи тега действий с его действиями.
...
## <a name="remarks"></a>Замечания
 ...
 Ячейка TagName в разделе Теги действий работает вместе с ячейкой TagName в разделе Действия, чтобы связать тег действия с его действиями. Строки в разделе Действия также имеют ячейку TagName, а строки с тем же значением ячейки TagName, что и эта ячейка, определяют действия, которые необходимо принять для этого тега действий. 
...
|||
|:-----|:-----|
| Имя ячейки:  <br/> | SmartTags.  *имя*  . TagName, где SmartTags. *имя* — название строки тегов действий.  <br/> |
