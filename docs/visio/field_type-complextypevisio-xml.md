...
---
# <a name="fieldtype-complextype-visio-xml"></a>Фиелд_типе complexType (XML для Visio)
...
|:-----|:-----|:-----|
|[Row](row-element-field-sectionvisio-xml.md) <br/> |[Фиелдров_типе](fieldrow_type-complextypevisio-xml.md) <br/> ||
