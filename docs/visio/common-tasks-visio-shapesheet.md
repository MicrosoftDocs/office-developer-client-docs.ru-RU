...
На этой странице навигации приведены ссылки на статьи с обзором возможностей программирования в Visio. Щелкните ссылки ниже или воспользуйтесь ОГЛАВЛЕНИем, чтобы перейти к следующим разделам:
...
- [Ссылка на ячейку в формуле](reference-a-cell-in-a-formula.md)
    
- [Запуск в режиме разработчика (отображение вкладки "Разработчик")](run-in-developer-mode-display-the-developer-tab.md)
    
- [Отображение объекта в окне таблицы свойств фигуры](show-an-object-in-the-shapesheet-window.md)
    
- [Ввод новой формулы для ячейки](type-a-new-formula-for-a-cell.md)
