...
|FALSE  <br/> |В меню над этим действием (по умолчанию) не вставляется сепаратор.  <br/> |
...
|||
|:-----|:-----|
|Имя ячейки:  <br/> |Действия. *имя*. BeginGroup, где действия. *имя* — это имя строки Действия  <br/> |
