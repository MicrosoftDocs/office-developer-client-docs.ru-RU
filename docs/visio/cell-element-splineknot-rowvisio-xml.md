...
---
# <a name="cell-element-splineknot-row-visio-xml"></a>Элемент Cell (SplineKnot Row) (Visio XML)
...
|:-----|:-----|:-----|
|[Элемент Row (Геометрия)](row-element-geometry-sectionvisio-xml.md) <br/> |[SplineKot_Type](splineknot_type-complextypevisio-xml.md) <br/> |Содержит x или y-координаты для точки управления spline или узла spline.  <br/> |
...
|:-----|:-----|:-----|
|X  <br/> |X-координата точки управления.  <br/> |[SplineKnot Row (Geometry Section)](splineknot-row-geometry-section.md) <br/> |
|Да  <br/> |Y-координата точки управления.  <br/> |[SplineKnot Row (Geometry Section)](splineknot-row-geometry-section.md) <br/> |
|A  <br/> |Один из узлов spline (кроме последнего или первых двух).  <br/> |[SplineKnot Row (Geometry Section)](splineknot-row-geometry-section.md) <br/> |
