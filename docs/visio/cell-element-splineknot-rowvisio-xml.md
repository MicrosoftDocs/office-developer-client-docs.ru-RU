...
---
# <a name="cell-element-splineknot-row-visio-xml"></a>Элемент Cell (строка SplineKnot) (Visio XML)

Содержит координаты X или Y для точки управления сплайна или загона сплайна.
...
|:-----|:-----|:-----|
|[Элемент Row (Geometry)](row-element-geometry-sectionvisio-xml.md) <br/> |[SplineKot_Type](splineknot_type-complextypevisio-xml.md) <br/> |Содержит координаты X или Y для точки управления сплайна или загона сплайна.  <br/> |
...
|:-----|:-----|:-----|
|X  <br/> |X-координата контрольной точки.  <br/> |[SplineKnot Row (Geometry Section)](splineknot-row-geometry-section.md) <br/> |
|Да  <br/> |Y-координата контрольной точки.  <br/> |[SplineKnot Row (Geometry Section)](splineknot-row-geometry-section.md) <br/> |
|A  <br/> |Одна из подмайок сплайна (кроме последней или первой).  <br/> |[SplineKnot Row (Geometry Section)](splineknot-row-geometry-section.md) <br/> |
