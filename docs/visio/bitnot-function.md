...
Возвращает 16-битный двоичный номер, в котором каждый бит имеет 1, только если соответствующий бит в двоичном номере имеет 0. В противном случае для бита устанавливается 0.
...
|:-----|:-----|:-----|:-----|
| _двоичный номер_ <br/> |Обязательна  <br/> |**Числовой** <br/> |16-битный двоичный номер.  <br/> |
