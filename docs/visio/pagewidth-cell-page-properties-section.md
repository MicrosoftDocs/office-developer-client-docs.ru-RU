...
Определяет ширину напечатанной страницы в единицах рисования.
  
## <a name="remarks"></a>Примечания

Ширину страницы можно также установить на вкладке **Размер** страницы в  диалоговом окне Установка страницы (на вкладке Дизайн, щелкните стрелку установки страницы) или вручную переостановив размер страницы с помощью мыши.   Для этого перетащите край страницы, удерживая клавишу CTRL. 
