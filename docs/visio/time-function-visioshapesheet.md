...
|:-----|:-----|:-----|:-----|
| _час_ <br/> |Обязательный  <br/> |**Числовой** <br/> |Компонент часа.  <br/> |
| _за_ <br/> |Обязательный  <br/> |**Числовой** <br/> |Минута комонент.  <br/> |
| _Втор_ <br/> |Обязательный  <br/> |**Числовой** <br/> |Второй компонент.  <br/> |
