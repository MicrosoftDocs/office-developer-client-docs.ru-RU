...
|:-----|:-----|:-----|:-----|
| _шапенаме! TheText_ <br/> |Обязательна  <br/> ||Ссылка на ячейку с именем TheText в целевой фигуре.  _Шапенаме!_ — имя фигуры, из которой требуется получить текст.  <br/> |
...
|4   <br/> |Преобразование вкладок в один пробел.  <br/> |
