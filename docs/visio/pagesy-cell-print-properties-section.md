...
Определяет количество страниц принтера, на которых страница рисунка помещается вертикально. 
  
## <a name="remarks"></a>Примечания

Это значение используется, только если для ячейки OnPage установлено значение TRUE. 
