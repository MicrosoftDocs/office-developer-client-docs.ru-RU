...
Определяет направление переходов по вертикальным динамическим соединителям на странице рисования, к которой не применено локальное направление перехода.
