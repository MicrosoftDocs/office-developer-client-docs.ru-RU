...
description: Указывает, можно ли просматривать страницу рисования в браузере с помощью служб Visio в Microsoft SharePoint Server 2013.
...
Указывает, можно ли просматривать страницу рисования в браузере с помощью служб Visio в Microsoft SharePoint Server 2013.
