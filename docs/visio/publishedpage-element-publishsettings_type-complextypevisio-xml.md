...
---
# <a name="publishedpage-element-publishsettings_type-complextype-visio-xml"></a>Элемент PublishedPage (PublishSettings_Type ComplexType) (Visio XML)

Указывает, просматривается ли страница рисования в браузере с Visio служб в Microsoft SharePoint Server 2013 г.
...
|:-----|:-----|:-----|:-----|:-----|
|ID  <br/> |xsd:unsignedInt  <br/> |Обязательный  <br/> |Идентификатор страницы рисования.  <br/> |Значения типа xsd:unsignedInt.  <br/> |
