...
Контролирует, является ли действие в теге действия или меню ярлыка только для чтения. 
...
Если действие только для чтения, оно отображается в теге действия или в меню ярлыка, но выбрать его невозможно. Он не приглушенный, а отображается на цветном фоне, как метка. Чтобы элемент меню казался неохваченным, используйте ячейку Отключена. 
...
|||
|:-----|:-----|
|Имя ячейки:  <br/> |Действия. *имя*  . Действия ReadOnlywhere.  *имя*  — это имя строки Действия  <br/> |
