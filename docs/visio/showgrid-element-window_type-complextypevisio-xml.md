...
description: Указывает, отображается ли сетки в окне документа.
ms.openlocfilehash: a34ba3503cc8995554f1f6d696b27a6a4be37359
ms.sourcegitcommit: ef717c65d8dd41ababffb01eafc443c79950aed4
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 10/04/2018
ms.locfileid: "25386232"
---
# <a name="showgrid-element-windowtype-complextype-visio-xml"></a>Элемент ShowGrid (Window_Type complexType) ('Visio XML»)

Указывает, отображается ли сетки в окне документа.
