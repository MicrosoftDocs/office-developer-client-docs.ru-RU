...
|:-----|:-----|:-----|:-----|
| _число_ <br/> |Обязательна  <br/> |**Number** <br/> |Число, которое требуется округлить.  <br/> |
| _нумберофдигитс_ <br/> |Обязательна  <br/> |**Number** <br/> |Число десятичных разрядов точности.  <br/> |
