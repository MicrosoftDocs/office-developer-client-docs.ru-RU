...
> [!NOTE]
> Рекомендуется использовать функцию [FONT,](font-function.md) аналогичную **функции FONTTOID.** В Microsoft Visio 2013 функция **FONT** была представлена для **замены FONTTOID**. 
...
|:-----|:-----|:-----|:-----|
| _font_name_ <br/> |Обязательно  <br/> |**Строка** <br/> |Имя шрифта.  <br/> |
