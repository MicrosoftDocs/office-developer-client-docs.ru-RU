...
---
# <a name="lower-function"></a>Функция СТРОЧН
...
|:-----|:-----|:-----|:-----|
| _expression_ <br/> |Обязательный  <br/> |**Может отличаться** <br/> | Строка, ссылка на ячейку или выражение; результат преобразуется в строку, который затем преобразуется в нижний регистр.  <br/> |
