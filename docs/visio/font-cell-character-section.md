...
Представляет число шрифта, используемого для формата текста. Номера шрифтов различаются в зависимости от шрифтов, установленных в системе. Номер 0 представляет шрифт по умолчанию, который обычно является Arial.
...
Чтобы получить ссылку на ячейку шрифта по индексу из программы, используйте свойство **CellsSRC** со следующими аргументами: 
