...
Определяет шаблон заполнения для тени фигуры.
...
Чтобы установить шаблон заполнения, введите число от 0 до 40, которое является индексом в коллекцию шаблонов. Вы можете просмотреть коллекцию шаблонов заполнения в диалоговом окне **Заполнение** (на вкладке **Главная,** в группе **Shape** нажмите кнопку **Заполнить** и нажмите **кнопку Параметры заполнения).**
  
Чтобы получить ссылку на ячейку ShdwPattern по имени из другой формулы или из программы с помощью свойства **CellsU,** используйте: 
