...
Возвращает текущую дату и время, например 27.09.2010 в 12:03:30.
  
## <a name="example-2"></a>Пример 2

FORMAT (NOW(),"dd MMM., yyyy hh:mm")
  
Возвращает текущую дату и время, отформатированные как 27 сентября 2010 г. 12:03.
  
## <a name="example-3"></a>Пример 3

NOW()+2EW.
  
Возвращает текущую дату и время плюс две недели, например 10/11/10 12:03:30.
