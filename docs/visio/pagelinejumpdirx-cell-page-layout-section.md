...
Определяет направление переходов по горизонтальным динамическим соединитетелям на странице рисования, к которой не применено локальное направление перехода.
