...
Возвращает остаток (модуль), который приводит к разделу числа на дивизор.
...
|:-----|:-----|:-----|:-----|
| _число_ <br/> |Обязательна  <br/> |**Number** <br/> |Подмайка.  <br/> |
| _divisor_ <br/> |Обязательна  <br/> |**Number** <br/> |Дивизор.  <br/> |
...
Результат имеет тот же знак, что и дивизор. A #DIV/0! если дивизор имеет 0, возвращается ошибка. 
