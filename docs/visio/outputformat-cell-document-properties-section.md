...
Определяет формат выходных данных для рисования. Страницы рисования обычно форматированы для печати (по умолчанию); однако можно выбрать другие форматы выходных данных.
