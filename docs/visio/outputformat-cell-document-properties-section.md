...
Определяет формат вывода для рисунка. Страницы рисования обычно форматированы для печати (по умолчанию); однако вы можете выбрать другие форматы вывода.
  
|**Значение**|**Формат вывода**|
|:-----|:-----|
| 0  <br/> | Печать (по умолчанию)  <br/> |
| 1  <br/> | PowerPoint слайд-шоу  <br/> |
| 2  <br/> | Выход HTML или GIF  <br/> |
   
## <a name="remarks"></a>Примечания

Чтобы получить ссылку на ячейку OutputFormat по имени из другой формулы или из программы с помощью свойства **CellsU,** используйте: 
