...
Определяет уровень прозрачности для цвета фона текстового блока фигуры.
...
Значения округлются до ближайшей половины процента. Значение 100% полностью прозрачно. Хотя фигура с полностью прозрачным текстовым фоном отображается на странице документа так же, как фигура без фона текста, она взаимодействует с другими объектами на странице так же, как если бы ее прозрачность была 0%.
  
Это значение также можно установить с помощью  ползунок  на вкладке "Шрифт" диалогового окна "Текст" (на вкладке "Главная" щелкните стрелку **"Шрифт").**  
