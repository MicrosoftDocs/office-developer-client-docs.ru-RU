...
|:-----|:-----|:-----|:-----|
| _expr_opt_ <br/> |Optional  <br/> |**Разные** <br/> |Выражение, которое заменяется значение или выражение, назначаемое для связанной ячейки в ВЫРАЖЕНИЕ_МНОЖЕСТВА функции. Если не указано, его начальное значение равно 0 (ноль).  <br/> |
