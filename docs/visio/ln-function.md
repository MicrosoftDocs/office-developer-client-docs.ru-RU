...
Возвращает натуральный логарифм числа. Число должно быть положительным, а LN Возвращает значение ошибки #NUM.
...
|:-----|:-----|:-----|:-----|
| _число_ <br/> |Обязательна  <br/> |**Числовой** <br/> | Число, натуральный логарифм которого требуется найти.  <br/> |
