...
Возвращает естественный логарифм числа. Число должно быть положительным, иначе LN возвращает значение ошибки #NUM.
...
|:-----|:-----|:-----|:-----|
| _число_ <br/> |Обязательна  <br/> |**Числовой** <br/> | Номер, естественный логарифм которого вы хотите найти.  <br/> |
