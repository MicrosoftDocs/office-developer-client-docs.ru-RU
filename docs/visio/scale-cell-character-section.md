...
Управляет шириной шрифта. Значение по умолчанию для этой ячейки — 100%.
  
## <a name="remarks"></a>Примечания

Установите процент от 1% до 99 %, чтобы уменьшить ширину шрифта. Установите его от 101% до 600 %, чтобы увеличить ширину шрифта.
