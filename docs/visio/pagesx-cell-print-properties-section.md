...
Определяет количество страниц принтера, на которых страница рисунка помещается горизонтально. 
  
## <a name="remarks"></a>Примечания

Это значение используется, только если для ячейки OnPage установлено значение TRUE. 
  
Чтобы получить ссылку на ячейку PagesX по имени из другой формулы или из программы с помощью свойства **CellsU,** используйте: 
