...
Позволяет создать настраиваемый стиль маркеров. 
  
## <a name="remarks"></a>Примечания

Введите стиль в качестве строки (в кавычках). Например, можно ввести строку "ooo".
  
Вы также можете установить значение этой ячейки, щелкнув правой кнопкой мыши фигуру, указав на **форматирование,** щелкнув текст **и** щелкнув вкладку **"Маркеры".** 
