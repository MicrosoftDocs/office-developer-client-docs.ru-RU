...
|**Значение**|**Описание**|
|:-----|:-----|
| TRUE  <br/> | Путь не заполняется, даже если заполнены другие пути в фигуре.  <br/> |
| FALSE  <br/> | Заливка фигуры применяется к пути, даже если она не закрыта.  <br/> |
   
## <a name="remarks"></a>Примечания

Если для шаблона заливки фигуры установлено ни одно (0), ни один из его путей не заполняется. Эта ячейка используется для выборочного отключения заливки для пути в фигуре.
