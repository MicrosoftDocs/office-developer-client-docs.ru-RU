...
Если тег действия отключен, он вообще не появится до повторного включения. 
...
|||
|:-----|:-----|
| Имя ячейки:  <br/> | SmartTags.  *имя*  . Отключено, где SmartTags. *имя* — название строки тегов действий.  <br/> |
