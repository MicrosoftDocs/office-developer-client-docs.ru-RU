...
Предотвращает применение эффектов темы к фигуре. 
  
Соответствует параметру **"От тематических** эффектов" в диалоговом окне **Protection.** 
  
Чтобы передать ti ячейку LockThemeColors по имени из другой формулы или из программы, используя свойство **CellsU,** используйте: 
