...
Определяет тип Quick Style (2-мерный, 1-мерный или соединитатель), который наследует фигура. 
...
Чтобы получить ссылку на **ячейку QuickStyleType** по имени из другой формулы, по значению атрибута **N** элемента **Cell** или из программы с использованием свойства **CellsU,** используйте: 
