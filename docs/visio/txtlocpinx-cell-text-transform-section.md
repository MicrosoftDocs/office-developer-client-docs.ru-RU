...
Определяет  *x-координату*  центра вращения текстового блока относительно начала текстового блока. Формула по умолчанию: 
  
= TxtWidth \* 0.5
  
Эта формула оценивается до горизонтального центра текстового блока.
