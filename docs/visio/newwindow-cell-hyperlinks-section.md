...
| FALSE  <br/> | Значение, используемое по умолчанию. Не открывайте новое окно для гиперссылки.  <br/> |
   
## <a name="remarks"></a>Примечания

Чтобы получить ссылку на ячейку NewWindow по имени из другой формулы или из программы с помощью свойства **CellsU** , используйте следующее: 
  
|||
|:-----|:-----|
| Имя ячейки:  <br/> | Гиперссылки.  *Name (имя* ). NewWindow, где гиперссылка.  *Name* — имя строки  <br/> |
...
| Индекс ячейки:  <br/> |**вишлинкневвин** <br/> |
