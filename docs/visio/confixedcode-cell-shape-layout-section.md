...
Определяет, когда соединителю необходимо перенаупределять.
  
|**Значение**|**Описание**|**Константа автоматизации**|
|:-----|:-----|:-----|
|0  <br/> |Свободное перенастройка  <br/> |**visSLOConFixedRerouteFreely** <br/> |
|1   <br/> |Перенастройка по мере необходимости (перенастройка вручную)  <br/> |**visSLOConFixedRerouteAsNeeded** <br/> |
|2   <br/> |Никогда не перенабеть  <br/> |**visSLOConFixedRerouteNever** <br/> |
|3   <br/> |Перенастройка на перекрестной передаче  <br/> |**visSLOConFixedRerouteOnCrossover** <br/> |
...
Чтобы получить ссылку на ячейку ConFixedCode по имени из другой формулы или из программы, использующей свойство **CellsU,** используйте: 
