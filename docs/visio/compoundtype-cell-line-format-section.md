...
Определяет сложный тип линии фигуры. 
  
|**Значение**|**Описание**|
|:-----|:-----|
|0  <br/> |Простой  <br/> |
|1  <br/> |Двойное с плавающей точкой  <br/> |
|2  <br/> |Толстый тонкий  <br/> |
|3  <br/> |Тонкий толстый  <br/> |
|4   <br/> |Triple  <br/> |
   
## <a name="remarks"></a>Примечания

Чтобы получить ссылку на ячейку **CompoundType** по имени из другой формулы, по значению атрибута **N** элемента **Cell** или из программы с использованием свойства **CellsU,** используйте: 
