---
title: Кустомменусфиле_типе complexType (' Visio XML ')
manager: soliver
ms.date: 03/09/2015
...
ms.locfileid: "32282868"
---
# <a name="custommenusfiletype-complextype-visio-xml"></a>Кустомменусфиле_типе complexType (' Visio XML ')
