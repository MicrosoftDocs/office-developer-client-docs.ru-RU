...
Определяет, где стиль отображается в пользовательском интерфейсе Microsoft Visio.
  
|**Значение**|**Описание**|
|:-----|:-----|
| TRUE  <br/> | Показывать стиль только в **проводнике.**  <br/> |
| FALSE  <br/> | Отрисовка стиля в **проводнике.**  <br/> |
   
## <a name="remarks"></a>Примечания

При основании скрытого стиля новый стиль не наследует этот атрибут.
