...
Содержит формулу, которая будет выполняться, когда пользователь выбирает команду в меню ярлыка или тега действия.
...
Ячейка Action оценивается только в том случае, если действие происходит, а не при ввели формулу.
  
Чтобы получить ссылку на ячейку Action по имени из другой формулы или из программы с помощью свойства **CellsU,** используйте: 
  
|||
|:-----|:-----|
| Имя ячейки:  <br/> | Действия.  *name*  . Действие, в котором действия. *имя*  — это имя строки действий  <br/> |
