...
Ячейка события, которая оценивается при смене текста или текстовой композиции фигуры.
  
## <a name="remarks"></a>Примечания

Ячейки событий оцениваются только при событии, а не при вводе формулы. Ячейку TheText можно использовать для запуска пересчета, например для пересчета ширины и высоты текста с помощью функций TEXTWIDTH( ) и TEXTHEIGHT( ).
