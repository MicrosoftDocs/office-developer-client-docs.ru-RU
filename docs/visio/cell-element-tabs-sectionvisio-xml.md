...
---
# <a name="cell-element-tabs-section-visio-xml"></a>Элемент Cell (Раздел Вкладок) (Visio XML)
...
|:-----|:-----|:-----|
|[Элемент Row (Раздел Вкладки)](row-element-tabs-sectionvisio-xml.md) <br/> |[TabsRow_Type](tabsrow_type-complextypevisio-xml.md) <br/> |Указывает свойство, которое управляет положением остановки или выравниванием стоп-вкладок формы и стиля.  <br/> |
...
|:-----|:-----|:-----|
|Alignment  <br/> |Указывает выравнивание вкладок.  <br/> |[Alignment Cell (Tabs Section)](alignment-cell-tabs-section.md) <br/> |
|Position  <br/> |Указывает положение остановки вкладки. Положение вкладки не зависит от масштаба рисунка. Если рисунок масштабировать, положение вкладки остается таким же.  <br/> |[Position Cell (Tabs Section)](position-cell-tabs-section.md) <br/> |
