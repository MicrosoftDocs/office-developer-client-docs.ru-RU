...
---
# <a name="cell-element-tabs-section-visio-xml"></a>Элемент Cell (Tabs Section) (Visio XML)

Указывает свойство, которое управляет положением остановки или выравниванием табули для фигуры и стиля. 
...
|:-----|:-----|:-----|
|[Элемент Row (Раздел "Вкладки")](row-element-tabs-sectionvisio-xml.md) <br/> |[TabsRow_Type](tabsrow_type-complextypevisio-xml.md) <br/> |Указывает свойство, которое управляет положением остановки или выравниванием табули для фигуры и стиля.  <br/> |
...
|:-----|:-----|:-----|
|Выравнивание  <br/> |Указывает выравнивание вкладки.  <br/> |[Alignment Cell (Tabs Section)](alignment-cell-tabs-section.md) <br/> |
|Position  <br/> |Указывает положение остановки табули. Положение вкладки не зависит от масштаба рисунка. Если рисунок масштабировать, положение вкладки остается таким же.  <br/> |[Position Cell (Tabs Section)](position-cell-tabs-section.md) <br/> |
