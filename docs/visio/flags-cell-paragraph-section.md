...
Значение в этой ячейке соответствует параметру "Направление"  на вкладке "Абзац"  в текстовом диалоговом окне (на вкладке "Главная" щелкните стрелку шрифта), которое отображается, только если в диалоговом окне "Языковые параметры" добавлен язык, Microsoft Office использующий сложный текст **скриптов.**    (Нажмите **кнопку "Начните",** выберите "Все **программы", "Microsoft Office",** **Microsoft Office**"Инструменты" и **выберите Microsoft Office "Языковые параметры".**  
