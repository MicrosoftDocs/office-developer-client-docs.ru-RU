...
Определяет текущий угол поворота текстового блока относительно  *оси x*  фигуры. Значение по умолчанию — 0 градусов. 
  
## <a name="remarks"></a>Примечания

Чтобы получить ссылку на ячейку TxtAngle по имени из другой формулы или из программы с помощью свойства **CellsU,** используйте: 
