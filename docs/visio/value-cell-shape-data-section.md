...
Содержит значение элемента данных фигуры, вступив в диалоговое окно **Define Shape Data.** 
  
## <a name="remarks"></a>Примечания

Формулы, вступив в эту ячейку, переопределяются значениями, вписав их в диалоговое окно **Define Shape Data.** Это верно, даже если для защиты формулы используется функция GUARD. 
  
Чтобы получить ссылку на ячейку Value по имени из другой формулы или из программы с помощью свойства **CellsU,** используйте: 
  
|||
|:-----|:-----|
| Имя ячейки:  <br/> | Prop.  *Имя*  . Значение, в котором prop.  *Имя*  — это имя строки  <br/> |
