...
---
# <a name="rel-element-master_type-complextype-visio-xml"></a>Элемент rel (Master_Type complexType) (XML для Visio)
...
|:-----|:-----|:-----|
|[Master](master-element-masters_type-complextypevisio-xml.md) <br/> |[Master_Type](master_type-complextypevisio-xml.md) <br/> |Указывает один экземпляр главного XML-файла, хранящегося в документе.  <br/> |
