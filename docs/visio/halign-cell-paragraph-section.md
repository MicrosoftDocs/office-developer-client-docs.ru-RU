...
|:-----|:-----|:-----|
| 0  <br/> | Выравнивание слева  <br/> |**visHorzLeft** <br/> |
| 1  <br/> | Center  <br/> |**visHorzCenter** <br/> |
| 2  <br/> | Правильное выравнивание  <br/> |**visHorzRight** <br/> |
| 3  <br/> | Justify  <br/> |**visHorzJustify** <br/> |
| 4   <br/> | Force justify  <br/> |**visHorzForce** <br/> |
   
## <a name="remarks"></a>Примечания

Justify добавляет пространство между словами в каждой строке, за исключением последней строки абзаца, чтобы согласовать левую и правую стороны текста с полями.
  
Force оправдывает каждую строку в абзаце, включая последнюю.
