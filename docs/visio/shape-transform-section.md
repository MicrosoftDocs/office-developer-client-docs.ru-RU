...
Содержит общие сведения о положении фигуры: например, ее ширину, высоту, угол и центр поворота (контакт); было ли перевернуто фигуру; и как должна вести себя фигура при ее размере в группе.
