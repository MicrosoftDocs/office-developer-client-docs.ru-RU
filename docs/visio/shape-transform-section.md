...
---
# <a name="shape-transform-section"></a>Раздел "Преобразование фигуры"

Содержит общие размещения сведения о фигуры: для пример, ширина, высота, угол и центра вращения (ПИН-код); является ли фигура отразилось; и поведение фигуры при изменении размера в группе.
