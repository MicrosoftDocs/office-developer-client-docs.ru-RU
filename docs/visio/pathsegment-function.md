...
Возвращает номер сегмента на основе 1 по указанной процентной отметке по указанному пути.
...
| _travel_ <br/> |Обязательна  <br/> |64-разрядное число с плавающей запятой двойной точности. <br/> |Процент пройденного пути от точки начала до конечной точки. Должно быть от 0 до 1.  <br/> |
