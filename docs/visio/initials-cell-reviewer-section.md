...
Это значение по умолчанию передается  инициалам в поле Инициалы на вкладке General в диалоговом **окне Visio Параметры** (щелкните вкладку **Файл,** щелкните Параметры **и** нажмите кнопку **General).**  
