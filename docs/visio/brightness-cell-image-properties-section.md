...
Регулирует яркость изображения bitmap. Уменьшение яркости изображения путем ввода значения от 0% до 49% или увеличения яркости путем ввода значения от 51% до 100%. Значение по умолчанию — 50%.
