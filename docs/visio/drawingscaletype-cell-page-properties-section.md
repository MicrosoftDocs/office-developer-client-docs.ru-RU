...
Определяет масштаб рисования, выбранный в диалоговом окне "Настройка страницы" (щелкните стрелку "Настройка **страницы"** на вкладке **"Главная").**  
  
|**Значение**|**Описание**|**Константа автоматизации**|
|:-----|:-----|:-----|
| 0  <br/> | Без масштабирования  <br/> |**visNoScale** <br/> |
| 1   <br/> | Архитектурный масштаб  <br/> |**visArchitectural** <br/> |
| 2   <br/> | Масштаб инженерного проектирования  <br/> |**visEngineering** <br/> |
| 3   <br/> | Настраиваемый масштаб  <br/> |**visScaleCustom** <br/> |
| 4   <br/> | Метрика  <br/> |**visScaleMetric** <br/> |
| 5   <br/> | Машинный проектный масштаб  <br/> |**visScaleMechanical** <br/> |
