---
title: Кустомтулбарсфиле_типе complexType (XML для Visio)
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="customtoolbarsfiletype-complextype-visio-xml"></a>Кустомтулбарсфиле_типе complexType (XML для Visio)
