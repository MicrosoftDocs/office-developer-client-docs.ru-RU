...
|:-----|:-----|:-----|
|[Элемент Row (раздел "слой")](row-element-layer-sectionvisio-xml.md) <br/> |[LayerRow_Type](layerrow_type-complextypevisio-xml.md) <br/> |Задает одно свойство для слоя или его свойств для страницы.  <br/> |
...
|Печать  <br/> |Указывает, печатаются ли фигуры, принадлежащие слою, при печати документа.  <br/> |Нет.  <br/> |
|Доверие  <br/> |Указывает, могут ли другие фигуры привязываться к фигурам, назначенным для слоя.  <br/> |Нет.  <br/> |
|Состояние  <br/> |Указывает, является ли слой допустимым слоем для документа.  <br/> |Нет.  <br/> |
