...
---
# <a name="scratchrowtype-complextype-visio-xml"></a>Скратчров_типе complexType (XML для Visio)
...
|:-----|:-----|:-----|
|[Cell](cell-element-scratch-sectionvisio-xml.md) <br/> |[Целл_типе](cell_type-complextypevisio-xml.md) <br/> ||
