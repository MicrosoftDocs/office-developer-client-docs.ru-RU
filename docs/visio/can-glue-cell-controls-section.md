...
Определяет, можно ли приклеить handle-контроля к другим фигурам.
  
|**Значение**|**Описание**|
|:-----|:-----|
| TRUE  <br/> | Handle control can be glued.  <br/> |
| FALSE  <br/> | Handle control cannot be glued.  <br/> |
...
|||
|:-----|:-----|
| Имя ячейки:  <br/> | Controls.  *name*  . Элементы управления CanGluewhere.  *имя* — название строки элементов управления.  <br/> |
