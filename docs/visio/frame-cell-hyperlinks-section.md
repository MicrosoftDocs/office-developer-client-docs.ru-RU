...
Представляет имя целевого кадра, когда приложение открыто в качестве активного документа в приложении-контейнере. Значение по умолчанию — пустая строка.
...
|||
|:-----|:-----|
| Имя ячейки:  <br/> | Гиперссылка.  *name*  . Кадр, в котором находится гиперссылка.  *name*  — имя строки  <br/> |
