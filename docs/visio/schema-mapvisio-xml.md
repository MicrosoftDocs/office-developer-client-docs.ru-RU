...
---
# <a name="schema-map-visio-xml"></a><span data-ttu-id="4222d-103">Карта схемы (' Visio XML ')</span><span class="sxs-lookup"><span data-stu-id="4222d-103">Schema map ('Visio XML')</span></span>

<span data-ttu-id="4222d-104">В этом разделе показано определение схемы XML для формата файлов Visio 2013.</span><span class="sxs-lookup"><span data-stu-id="4222d-104">This topic shows the XML schema definition for the Visio 2013 file format.</span></span>
