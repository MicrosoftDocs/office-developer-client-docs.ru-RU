...
ms.locfileid: "25388527"
---
# <a name="schema-map-visio-xml"></a><span data-ttu-id="bc9ba-103">Карта схемы ('Visio XML»)</span><span class="sxs-lookup"><span data-stu-id="bc9ba-103">Schema map ('Visio XML')</span></span>

<span data-ttu-id="bc9ba-104">В этом разделе показано определение схемы XML для формат файлов Visio 2013.</span><span class="sxs-lookup"><span data-stu-id="bc9ba-104">This topic shows the XML schema definition for the Visio 2013 file format.</span></span>
