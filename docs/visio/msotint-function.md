...
Изменяет цвет, увеличив его luminosity на указанный процент.
...
| _deltaLum_ <br/> |Обязательна  <br/> |64-разрядное целое число. <br/> |Процентное соотношение меняется на белый (-100%) или черный (100%) из  _значения_ цвета.  <br/> |
