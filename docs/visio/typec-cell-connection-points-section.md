...
|2   <br/> |В &amp; направлении наружу  <br/> |**visCnnctTypeInwardOutward** <br/> |
   
## <a name="remarks"></a>Примечания

Вы также можете установить тип точки  подключения, выбрав средство соединители, выбрав фигуру и щелкнув правой кнопкой мыши точку подключения. Для этого необходимо запустить режим [разработчика.](run-in-developer-mode-display-the-developer-tab.md) 
...
|Индекс ячейки:  <br/> |**visCnnctType** (неширимые строки) **visCnnctC** (расширенные строки)  <br/> |
