...
Определяет цвет шрифта из быстрых стилей, наследуемый текстом фигуры от активной темы, в виде integer от 0 до 1. 
  
|||
|:-----|:-----|
|Значение  <br/> |Описание  <br/> |
|0  <br/> |Текст фигуры использует цвет темного шрифта.  <br/> |
|1   <br/> |Текст фигуры использует цвет шрифта Light.  <br/> |
   
## <a name="remarks"></a>Примечания

Чтобы получить ссылку на ячейку **QuickStyleFontColor** по имени из другой формулы, по значению атрибута **N** элемента **Cell** или из программы, использующей свойство **CellsU,** используйте: 
