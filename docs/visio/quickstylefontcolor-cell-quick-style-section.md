...
Определяет цвет шрифта из быстрых стилей, которые текст фигуры наследует от активной темы в виде целого числа от 0-1. 
...
| Индекс ячейки:  <br/> |**Вискуиккстилефонтколор** <br/> |
