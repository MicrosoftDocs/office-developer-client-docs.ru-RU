...
Указывает метку, которая отображается для пользователей в **окне "Данные** фигуры". Метка состоит из букв и цифр, включая символ подчеркиваия (_). 
  
## <a name="remarks"></a>Примечания

Приложение автоматически заключает строку Label в кавычках в ячейке, но кавычка не отображается в окне **"Данные** фигуры". 
...
|||
|:-----|:-----|
|Имя ячейки:  <br/> |Prop. *Name*  . Метка, в которой есть реквизит.  *Имя*  — это имя строки  <br/> |
