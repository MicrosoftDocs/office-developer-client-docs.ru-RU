---
title: Элемент GlueSettings (Виндов_типе complexType) (XML для Visio)
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="gluesettings-element-windowtype-complextype-visio-xml"></a>Элемент GlueSettings (Виндов_типе complexType) (XML для Visio)
