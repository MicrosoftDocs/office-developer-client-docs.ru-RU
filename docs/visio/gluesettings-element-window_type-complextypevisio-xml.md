---
title: Элемент GlueSettings (Window_Type complexType) (XML для Visio)
manager: soliver
ms.date: 03/09/2015
...
---
# <a name="gluesettings-element-window_type-complextype-visio-xml"></a>Элемент GlueSettings (Window_Type complexType) (XML для Visio)
