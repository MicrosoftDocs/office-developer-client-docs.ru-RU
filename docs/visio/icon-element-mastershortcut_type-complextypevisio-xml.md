...
---
# <a name="icon-element-mastershortcut_type-complextype-visio-xml"></a>Элемент Icon (MasterShortcut_Type complexType) (Visio XML)

Указывает двоичный значок MIME (multipurpose Internet Mail Extensions) в формате ICO для элемента MasterShortcut в документе.
...
|:-----|:-----|:-----|
|[MasterShortcut](mastershortcut-element-masters_type-complextypevisio-xml.md) <br/> |[MasterShortcut_Type](mastershortcut_type-complextypevisio-xml.md) <br/> |Указывает неиспользованный формат master.  <br/> |
