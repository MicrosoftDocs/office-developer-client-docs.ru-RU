...
Предотвращает применение цветов темы к фигуре. 
  
Значение ячейки LockThemeColors соответствует параметру "Цвета темы" в диалоговом окне **Защита.**  
  
Чтобы сослаться на ячейку LockThemeColors по имени из другой формулы или из программы, используя свойство **CellsU,** используйте: 
