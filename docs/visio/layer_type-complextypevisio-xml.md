...
---
# <a name="layertype-complextype-visio-xml"></a>Лайер_типе complexType (XML для Visio)
...
|:-----|:-----|:-----|
|[Row](row-element-layer-sectionvisio-xml.md) <br/> |[Лайерров_типе](layerrow_type-complextypevisio-xml.md) <br/> ||
