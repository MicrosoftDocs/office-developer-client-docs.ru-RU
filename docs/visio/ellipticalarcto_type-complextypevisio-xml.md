...
---
# <a name="ellipticalarctotype-complextype-visio-xml"></a>Еллиптикаларкто_типе complexType (XML для Visio)
...
|:-----|:-----|:-----|
|[Cell](cell-element-ellipticalarcto-rowvisio-xml.md) <br/> |[Целл_типе](cell_type-complextypevisio-xml.md) <br/> ||
