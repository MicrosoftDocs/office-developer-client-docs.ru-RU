...
---
# <a name="documentsheet-element-visiodocument_type-complextype-visio-xml"></a>Элемент DocumentSheet (VisioDocument_Type complexType) (XML для Visio)
...
|**Элемент**|**Тип**|**Описание**|
|:-----|:-----|:-----|
|[Cell](cell-elementvisio-xml.md) <br/> |[Cell_Type](cell_type-complextypevisio-xml.md) <br/> |Указывает ячейку в элементе DocumentSheet.  <br/> |
