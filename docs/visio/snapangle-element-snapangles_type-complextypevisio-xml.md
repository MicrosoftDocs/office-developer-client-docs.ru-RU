...
description: Содержит число с плавающей за точкой, указывающей угол прикрепления в градусах.
...
---
# <a name="snapangle-element-snapangles_type-complextype-visio-xml"></a>Элемент SnapAngle (SnapAngles_Type complexType) (Visio XML)

Содержит число с плавающей за точкой, указывающей угол прикрепления в градусах.
