...
Сохраняет локальное значение форматирования фигуры при применении темы, чтобы можно было восстановить локальное форматирование, если пользователь впоследствии удаляет тему.
...
Восстанавливает локальный формат цветовой заливки, который ранее применялся к фигуре при удалении текущей темы.
