...
Определяет, является ли строка детской вылетной строкой последней строки над ней, которая не является ребенком- вылетом. 
...
|||
|:-----|:-----|
|Имя ячейки:  <br/> |Действия. *имя*  . Действия FlyoutChildwhere.  *имя*  — это имя строки Действия  <br/> |
