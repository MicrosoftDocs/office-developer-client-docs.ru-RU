...
Разрешенные URIS должны соответствовать стандартам, предложенным в документе RFC 3987 — идентификаторы международных ресурсов (IRIS). Символы, зарезервированные в RFC 3986, не должны кодироваться в процентах. . Имена файлов не должны содержать следующие символы: \ / : ? \< \> | " или \* .  
...
Обратите внимание, что вертикальная черта, используемая как разделитель в этой спецификации, не входит в число символов, определенных в разделе 2.2 документа RFC 3986 как зарезервированные для возможного использования в качестве разделителей. Это сделано специально, чтобы расширить число символов, поддерживаемых аргументами команд URI без их кодирования с использованием символа процента. В сегментах зарезервированные символы \<command-argument\> RFC 3986 ":" и "/" являются частью данных аргумента, а не делегировок и поэтому включаются в состав нее.
