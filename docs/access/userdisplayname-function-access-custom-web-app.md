...
---
# <a name="userdisplayname-function-access-custom-web-app"></a>UserDisplayName Function (Пользовательское веб-приложение Access)

Возвращает отображаемую имя текущего пользователя.
