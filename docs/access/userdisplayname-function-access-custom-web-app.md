...
---
# <a name="userdisplayname-function-access-custom-web-app"></a>Функция UserDisplayName (Доступ к пользовательскому веб-приложению)

Возвращает имя отображения текущего пользователя.
...
Функция **UserDisplayName** доступна только в макросах пользовательского интерфейса (пользовательского интерфейса). 
