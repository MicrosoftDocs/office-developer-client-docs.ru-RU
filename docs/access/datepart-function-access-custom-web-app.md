...
---
# <a name="datepart-function-access-custom-web-app"></a>Функция DatePart (Доступ к настраиваемой веб-приложению)

Возвращает числовую величину, представляюную указанную дату указанной даты.
...
|:-----|:-----|
| *DatePart*  <br/> |Часть  *Date*  (значение даты или времени), для которой будет возвращена часть. Обратитесь к разделу Замечания для списка допустимых сокращений.  <br/> |
