...
Возвращает логарифм числа с базой 10.
...
|:-----|:-----|
| *NumericExpression*  <br/> |Положительное число, для которого нужно логарифм base-10.  <br/> |
   
## <a name="remarks"></a>Примечания

Функция **Log** позволяет изменить базу логарифма, а не использовать базовые 10. 
