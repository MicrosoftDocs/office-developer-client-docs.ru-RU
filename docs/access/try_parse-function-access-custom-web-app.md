...
---
# <a name="try_parse-function-access-custom-web-app"></a>Функция Try_Parse (пользовательское веб-приложение для Access)
 ...
 **Try_Parse** (*текстекспрессион*, *DataType*) 
...
**Try_Parse** только для преобразования из строки в типы даты/времени и Number. Для преобразования общих типов продолжайте использовать **Convert**. 
