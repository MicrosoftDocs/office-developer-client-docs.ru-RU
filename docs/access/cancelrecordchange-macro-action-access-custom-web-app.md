...
---
# <a name="cancelrecordchange-macro-action-access-custom-web-app"></a>CancelRecordChange Macro Action (пользовательское веб-приложение Access)

Действие **CancelRecordChange** можно использовать для отмены изменений, примененных к записи в блоке данных **[CreateRecord](createrecord-data-block-access-custom-web-app.md)** или **[EditRecord,](editrecord-data-block-access-custom-web-app.md)** прежде чем изменения будут зафиксированы. 
