...
---
# <a name="sqrt-function-access-custom-web-app"></a>Функция корень (приложение настраиваемых web Access)

Возвращает квадратный корень из указанного значения.
 ...
 **Корень** (*NumericExpression*) 
  
Функция **корень** содержит следующий аргумент. 
