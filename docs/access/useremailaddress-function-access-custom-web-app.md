...
---
# <a name="useremailaddress-function-access-custom-web-app"></a>Функция UserEmailAddress (приложение настраиваемых web Access)
...
Функция **UserEmailAddress** доступна только в макросы пользовательского интерфейса (UI). 
