---
title: Объекты базы данных (приложение настраиваемых web Access)
manager: kelbow
ms.date: 09/05/2017
...
- [Действия макроса SetProperty (приложение настраиваемых web Access)](setproperty-macro-action-access-custom-web-app.md)
