...
---
# <a name="eomonth-function-access-custom-web-app"></a>Функция EOMonth (пользовательское веб-приложение Access)
...
|:-----|:-----|
| *Дата*  <br/> |Дата начала в формате даты и времени или в принятом текстовом представлении даты.  <br/> |
...
Если  *дата*  плюс  *NumberOfMonth*  возвращает недействительные даты, **EOMonth** возвращает ошибку. 
