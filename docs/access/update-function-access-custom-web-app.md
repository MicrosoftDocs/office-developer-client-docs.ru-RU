...
---
# <a name="update-function-access-custom-web-app"></a>Функция обновления (доступ к настраиваемой веб-приложению)

Возвращает, была ли предпринята попытка операции INSERT или UPDATE на указанном поле.
...
|:-----|:-----|
| *Column*  <br/> |Имя поля для проверки операции INSERT или UPDATE.  <br/> |
   
## <a name="remarks"></a>Примечания

Функция **Update** возвращает TRUE независимо от успешной попытки INSERT или UPDATE. 
