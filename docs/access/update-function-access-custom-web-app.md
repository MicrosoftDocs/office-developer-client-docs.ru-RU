...
---
# <a name="update-function-access-custom-web-app"></a>Функции обновления (приложение настраиваемых web Access)

Возвращает попытка ли операция INSERT или UPDATE для указанного поля.
...
Функция **обновления** содержит следующие аргументы. 
  
|**Имя аргумента**|**Описание**|
|:-----|:-----|
| *Столбец*  <br/> |Имя поля для проверки для операций вставки и обновления.  <br/> |
   
## <a name="remarks"></a>Замечания

Функция **обновления** возвращает TRUE, независимо от того, при попытке вставки или обновления успешна. 
