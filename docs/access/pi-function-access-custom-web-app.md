---
title: Функция ПИ (приложение настраиваемых web Access)
manager: kelbow
ms.date: 09/05/2017
...
description: Возвращает значение пи.
