...
---
# <a name="cast-function-access-custom-web-app"></a>Функция приведения (приложение настраиваемых web Access)
...
**Преобразование** (*Выражения*, *тип данных*) 
  
|**Имя аргумента**|**Описание**|
|:-----|:-----|
| *Выражение*  <br/> |Допустимое выражение.  <br/> |
| *DataType*  <br/> |Тип данных.  <br/> |
