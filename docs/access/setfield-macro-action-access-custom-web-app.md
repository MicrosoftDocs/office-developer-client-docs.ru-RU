...
---
# <a name="setfield-macro-action-access-custom-web-app"></a>Действие SetField Macro (Доступ к настраиваемой веб-приложению)
...
|:-----|:-----|
|**Name** <br/> |Строка, определяемая полем.  <br/> |
|**Значение** <br/> |Выражение, которое указывает значение, которое необходимо назначить поле.  <br/> |
   
## <a name="remarks"></a>Примечания

Действие **SetField** нельзя использовать вне блока **[данных CreateRecord](createrecord-data-block-access-custom-web-app.md)** или **[EditRecord.](editrecord-data-block-access-custom-web-app.md)** 
