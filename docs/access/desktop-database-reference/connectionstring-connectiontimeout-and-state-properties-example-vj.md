...
---
# <a name="connectionstring-connectiontimeout-and-state-properties-example-vj"></a><span data-ttu-id="d4b62-102">Пример использования свойств ConnectionString, ConnectionTimeout и State (VJ++)</span><span class="sxs-lookup"><span data-stu-id="d4b62-102">ConnectionString, ConnectionTimeout, and State properties example (VJ++)</span></span>


<span data-ttu-id="d4b62-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="d4b62-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="d4b62-104">В этом примере показано, как использовать свойство [ConnectionString](connectionstring-property-ado.md) для открытия [объекта Подключения.](connection-object-ado.md)</span><span class="sxs-lookup"><span data-stu-id="d4b62-104">This example demonstrates different ways of using the [ConnectionString](connectionstring-property-ado.md) property to open a [Connection](connection-object-ado.md) object.</span></span> <span data-ttu-id="d4b62-105">Он также использует [свойство ConnectionTimeout](connectiontimeout-property-ado.md) для набора периода ожидания подключения, а свойство [state](state-property-ado.md) для проверки состояния подключений.</span><span class="sxs-lookup"><span data-stu-id="d4b62-105">It also uses the [ConnectionTimeout](connectiontimeout-property-ado.md) property to set a connection timeout period, and the [State](state-property-ado.md) property to check the state of the connections.</span></span> <span data-ttu-id="d4b62-106">Для запуска этой процедуры требуется функция GetState.</span><span class="sxs-lookup"><span data-stu-id="d4b62-106">The GetState function is required for this procedure to run.</span></span>
