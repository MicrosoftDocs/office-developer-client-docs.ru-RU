...
---
# <a name="addnew-method-example-vbscript"></a>Пример использования метода AddNew (VBScript)


**Область применения**: Access 2013, Office 2013

В этом примере используется метод [AddNew](addnew-method-ado.md), чтобы создать запись с указанным именем.

Используйте следующий пример на странице Active Server Page (ASP). Используйте **Поиск,** чтобы найти файл Adovbs.inc и разместить его в каталоге, который вы планируете использовать. Вырезать и ввести следующий код для Блокнот или другого редактора текста и сохранить его как **AddNewVBS.asp**. Результат можно просмотреть в любом клиентом браузере.

Для использования примера добавьте новую запись в htmL-форму. Щелкните **Добавить**. См. [пример метода Удаления для](delete-method-example-vbscript.md) удаления нежелательных записей.
