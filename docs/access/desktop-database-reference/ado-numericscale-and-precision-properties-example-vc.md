...
---
# <a name="ado-numericscale-and-precision-properties-example-vc"></a><span data-ttu-id="b4699-102">ADO NumericScale and Precision Properties Example (VC++)</span><span class="sxs-lookup"><span data-stu-id="b4699-102">ADO NumericScale and Precision Properties Example (VC++)</span></span>


<span data-ttu-id="b4699-103">**Применимо к**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="b4699-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="b4699-104">В этом примере с помощью свойства [NumericScale](numericscale-property-ado.md) и [точность](precision-property-ado.md) для отображения числовых масштаб и точность поля в таблице ***скидок*** базы данных ***Pubs*** .</span><span class="sxs-lookup"><span data-stu-id="b4699-104">This example uses the [NumericScale](numericscale-property-ado.md) and [Precision](precision-property-ado.md) properties to display the numeric scale and precision of fields in the ***Discounts*** table of the ***Pubs*** database.</span></span>
