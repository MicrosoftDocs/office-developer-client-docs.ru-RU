...
---
# <a name="status-property-example-vc"></a><span data-ttu-id="97c00-102">Пример использования свойства Status (VC++)</span><span class="sxs-lookup"><span data-stu-id="97c00-102">Status property example (VC++)</span></span>


<span data-ttu-id="97c00-103">**Применимо к**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="97c00-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="97c00-104">В этом примере используется свойство [состояние](status-property-ado-recordset.md) для отображения записи, которые были изменены в пакетной операции до пакета обновления.</span><span class="sxs-lookup"><span data-stu-id="97c00-104">This example uses the [Status](status-property-ado-recordset.md) property to display which records have been modified in a batch operation before a batch update has occurred.</span></span>
...
<span data-ttu-id="97c00-105">**StatusX.h**</span><span class="sxs-lookup"><span data-stu-id="97c00-105">**StatusX.h**</span></span>
