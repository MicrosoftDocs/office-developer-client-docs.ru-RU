...
---
# <a name="create-method-example-vc"></a><span data-ttu-id="41a67-102">Пример использования метода Create (VC++)</span><span class="sxs-lookup"><span data-stu-id="41a67-102">Create method example (VC++)</span></span>


<span data-ttu-id="41a67-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="41a67-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="41a67-104">В приведенном ниже коде показано, как создать новую базу данных Microsoft Jet с помощью метода [CREATE](create-method-adox.md) .</span><span class="sxs-lookup"><span data-stu-id="41a67-104">The following code shows how to create a new Microsoft Jet database with the [Create](create-method-adox.md) method.</span></span>
