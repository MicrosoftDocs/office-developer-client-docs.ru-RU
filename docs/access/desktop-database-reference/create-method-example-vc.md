...
ms.locfileid: "25482956"
---
# <a name="create-method-example-vc"></a><span data-ttu-id="5b5c9-102">Create Method Example (VC++)</span><span class="sxs-lookup"><span data-stu-id="5b5c9-102">Create Method Example (VC++)</span></span>


<span data-ttu-id="5b5c9-103">**Применимо к**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="5b5c9-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="5b5c9-104">Следующий код демонстрирует создание новой базы данных Microsoft Jet с помощью метода [Create](create-method-adox.md) .</span><span class="sxs-lookup"><span data-stu-id="5b5c9-104">The following code shows how to create a new Microsoft Jet database with the [Create](create-method-adox.md) method.</span></span>
