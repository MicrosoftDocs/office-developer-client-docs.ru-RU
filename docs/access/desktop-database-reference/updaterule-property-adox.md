...
Указывает действие, выполняемые при обновлении основного ключа.

## <a name="settings-and-return-values"></a>Параметры и значения возврата

Задает и возвращает **длинное** значение, которое может быть одной из констант [RuleEnum.](ruleenum.md) По умолчанию значение **adRINone**.

## <a name="remarks"></a>Примечания

Это свойство доступно только для чтения на [объектах Key,](key-object-adox.md) которые уже были приданы коллекции.
