...
## <a name="step-2-invoke-the-server-program"></a>Шаг 2: Вызовите программу сервера 
...
## <a name="step-5-datacontrol-is-made-usable"></a>Шаг 5. Предоставление доступа к объекту DataControl 
...
## <a name="step-6-changes-are-sent-to-the-server"></a>Шаг 6. Отправка изменений на сервер
