...
---
# <a name="addnew-method-example-vj"></a><span data-ttu-id="e557e-102">Пример использования метода AddNew (VJ++)</span><span class="sxs-lookup"><span data-stu-id="e557e-102">AddNew method example (VJ++)</span></span>


<span data-ttu-id="e557e-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="e557e-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="e557e-104">В этом примере используется метод [AddNew](addnew-method-ado.md), чтобы создать запись с указанным именем.</span><span class="sxs-lookup"><span data-stu-id="e557e-104">This example uses the [AddNew](addnew-method-ado.md) method to create a new record with the specified name.</span></span>
