...
ms.locfileid: "25888631"
---
# <a name="addnew-method-example-vj"></a><span data-ttu-id="b1959-102">Пример использования метода AddNew (VJ++)</span><span class="sxs-lookup"><span data-stu-id="b1959-102">AddNew method example (VJ++)</span></span>


<span data-ttu-id="b1959-103">**Применимо к**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="b1959-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="b1959-104">В этом примере используется метод [AddNew](addnew-method-ado.md) , чтобы создать новую запись с указанным именем.</span><span class="sxs-lookup"><span data-stu-id="b1959-104">This example uses the [AddNew](addnew-method-ado.md) method to create a new record with the specified name.</span></span>
