...
Указывает имя уровня участника.
...
Используйте свойство **LevelName,** чтобы получить имя уровня, к которому принадлежит член. Это соответствует свойству [Name](name-property-ado-md.md) объекта [Level.](level-object-ado-md.md)
