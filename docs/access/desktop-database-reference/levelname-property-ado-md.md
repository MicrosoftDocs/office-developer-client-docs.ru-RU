...
Используйте свойство **LevelName** для получения имени уровня, к которому принадлежит член. Это соответствует свойству [Name](name-property-ado-md.md) объекта [Level.](level-object-ado-md.md)
