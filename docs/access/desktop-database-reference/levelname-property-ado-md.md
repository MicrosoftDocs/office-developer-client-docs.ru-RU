...
Используйте свойство **LevelName** для получения имени уровня, к которому принадлежит элемент. Это соответствует свойству [Name](name-property-ado-md.md) объекта [Level](level-object-ado-md.md) .
