...
ms.locfileid: "25482048"
---
# <a name="resync-method-example-vj"></a><span data-ttu-id="6b3e5-102">Resync Method Example (VJ++)</span><span class="sxs-lookup"><span data-stu-id="6b3e5-102">Resync Method Example (VJ++)</span></span>


<span data-ttu-id="6b3e5-103">**Применимо к**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="6b3e5-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="6b3e5-104">В этом примере показано использование метода [выполнить повторную синхронизацию](resync-method-ado.md) для обновления данных в статических записей.</span><span class="sxs-lookup"><span data-stu-id="6b3e5-104">This example demonstrates using the [Resync](resync-method-ado.md) method to refresh data in a static recordset.</span></span>
