...
ms.locfileid: "25860450"
---
# <a name="resync-method-example-vj"></a><span data-ttu-id="48d0c-102">Пример использования метода Resync (VJ++)</span><span class="sxs-lookup"><span data-stu-id="48d0c-102">Resync method example (VJ++)</span></span>
...
<span data-ttu-id="48d0c-104">В этом примере показано использование метода [выполнить повторную синхронизацию](resync-method-ado.md) для обновления данных в статических записей.</span><span class="sxs-lookup"><span data-stu-id="48d0c-104">This example demonstrates using the [Resync](resync-method-ado.md) method to refresh data in a static recordset.</span></span>
