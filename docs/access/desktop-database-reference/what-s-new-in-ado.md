...
---
# <a name="whats-new-in-ado"></a>Новые возможности в ADO
...
**[Особых полей для документа источника поставщиков](records-and-provider-supplied-fields.md)**
...
<tr class="even">
<td><p><a href="https://msdn.microsoft.com/library/jj250128(v=office.15)">Размер</a></p></td>
...
<tr class="even">
<td><p><a href="open-method-ado-record.md">Открытие</a></p></td>
...
Примеры дополнены и содержит примеры кода, написанных на языке Microsoft Visual C++® и Microsoft Visual J++®. Можно скопировать и вставить этих примеров кода в редактора.
