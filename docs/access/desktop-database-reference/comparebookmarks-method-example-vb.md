...
---
# <a name="comparebookmarks-method-example-vb"></a>Пример использования метода CompareBookmarks (VB)


**Область применения**: Access 2013, Office 2013

В этом примере демонстрируется метод [CompareBookmarks.](comparebookmarks-method-ado.md) Относительное значение закладок редко требуется, если определенная закладка каким-либо образом не является специальной.

Назначь случайную строку наборов [записей,](recordset-object-ado.md) производных от таблицы ***"Авторы",*** в качестве цели поиска. Затем отобразить положение каждой строки относительно этой цели.
