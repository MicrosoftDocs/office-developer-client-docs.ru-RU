...
Указывает, является ли [параметр](parameter-object-ado.md) входным параметром, выходным параметром, входным и выходным параметром, или значением возврата из сохраненной процедуры.
...
<td><p>1</p></td>
<td><p>Значение, используемое по умолчанию. Указывает, что параметр представляет параметр ввода.</p></td>
</tr>
<tr class="even">
