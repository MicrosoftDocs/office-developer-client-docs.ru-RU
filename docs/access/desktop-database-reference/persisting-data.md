...
- [Дополнительные сведения о сохранения записей](more-about-recordset-persistence.md)

- [Сохранение фильтрацией и иерархические наборы записей](persisting-filtered-and-hierarchical-recordsets.md)
