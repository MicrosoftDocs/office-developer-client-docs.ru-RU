...
С помощью методов и свойств объекта **Record** можно выполнить следующие действия:
  ...
  - Откройте объект **Recordset** со строками, представляющими подкаталоги и файлы сущности, представленной **записью** , с методом [дочернего](getchildren-method-ado.md) элемента.
