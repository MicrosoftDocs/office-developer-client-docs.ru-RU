...
---
# <a name="addnew-method-example-vc"></a><span data-ttu-id="b47f5-102">Пример использования метода AddNew (VC++)</span><span class="sxs-lookup"><span data-stu-id="b47f5-102">AddNew method example (VC++)</span></span>


<span data-ttu-id="b47f5-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="b47f5-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="b47f5-104">В этом примере используется метод [AddNew](addnew-method-ado.md), чтобы создать запись с указанным именем.</span><span class="sxs-lookup"><span data-stu-id="b47f5-104">This example uses the [AddNew](addnew-method-ado.md) method to create a new record with the specified name.</span></span>
...
<span data-ttu-id="b47f5-105">**Аддневкс. h**</span><span class="sxs-lookup"><span data-stu-id="b47f5-105">**AddNewX.h**</span></span>
