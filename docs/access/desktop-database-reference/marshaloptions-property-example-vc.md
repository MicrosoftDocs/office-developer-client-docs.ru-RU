...
---
# <a name="marshaloptions-property-example-vc"></a><span data-ttu-id="d6ee8-102">Пример использования свойства MarshalOptions (VC++)</span><span class="sxs-lookup"><span data-stu-id="d6ee8-102">MarshalOptions property example (VC++)</span></span>


<span data-ttu-id="d6ee8-103">**Применимо к**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="d6ee8-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="d6ee8-104">В этом примере используется свойство [MarshalOptions](marshaloptions-property-ado.md) , чтобы указать, какие строки отправляются на сервер — всех или только измененные строк.</span><span class="sxs-lookup"><span data-stu-id="d6ee8-104">This example uses the [MarshalOptions](marshaloptions-property-ado.md) property to specify what rows are sent back to the server — All Rows or only Modified Rows.</span></span>
...
<span data-ttu-id="d6ee8-105">**MarshalOptionsX.h**</span><span class="sxs-lookup"><span data-stu-id="d6ee8-105">**MarshalOptionsX.h**</span></span>
