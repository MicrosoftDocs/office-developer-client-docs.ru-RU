...
Задает и возвращает значение **String.**

## <a name="remarks"></a>Примечания

Значение по умолчанию — это пустая строка ("").

Если ключ — это иностранный ключ, **то RelatedTable** — это имя таблицы, которая содержит ключ.
