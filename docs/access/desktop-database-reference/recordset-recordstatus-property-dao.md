...
Когда пользователь изменяет запись, **recordStatus** для этой записи автоматически изменяется на **dbRecordModified**. Аналогично, при добавлении или удалении записи **RecordStatus** отражает соответствующую константу. При использовании метода обновления **[](recordset-update-method-dao.md)** в пакетном режиме DAO будет отправлять соответствующую операцию на удаленный сервер для каждой записи на основе свойства **RecordStatus** записи.
