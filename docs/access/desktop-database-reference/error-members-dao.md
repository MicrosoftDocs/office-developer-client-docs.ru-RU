...
---
# <a name="error-members-dao"></a>Участники ошибки (DAO)
...
<td><p>Возвращает дескриптивную строку, связанную с ошибкой. Это свойство по умолчанию для объекта <strong>Error.</strong></p></td>
</tr>
<tr class="even">
<td><p><strong><a href="error-number-property-dao.md">Номер</a></strong></p></td>
<td><p>Возвращает числовую величину с указанием ошибки.</p></td>
</tr>
<tr class="odd">
<td><p><strong><a href="error-source-property-dao.md">Источник</a></strong></p></td>
<td><p>Возвращает имя объекта или приложения, которые изначально создали ошибку.</p></td>
</tr>
</tbody>
</table>
