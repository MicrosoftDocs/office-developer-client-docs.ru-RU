...
<td><p>Возвращает строку описания, связанную с ошибкой. Это свойство по умолчанию для объект <strong>Error</strong> .</p></td>
</tr>
<tr class="even">
<td><p><strong><a href="error-number-property-dao.md">Number</a></strong></p></td>
<td><p>Возвращает значение, указывающее ошибку.</p></td>
</tr>
<tr class="odd">
<td><p><strong><a href="error-source-property-dao.md">Источник</a></strong></p></td>
<td><p>Возвращает имя объекта или приложения, вызвавшего ошибку.</p></td>
</tr>
</tbody>
</table>
