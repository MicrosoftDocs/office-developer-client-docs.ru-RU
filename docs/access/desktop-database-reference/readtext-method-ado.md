...
|Параметр|Описание|
|:--------|:----------|
|*Нумчарс* |Необязательный атрибут. **Длинное** значение, задающее количество символов, считываемых из файла, или значение [стреамреаденум](streamreadenum.md) . Значение по умолчанию — **адреадалл**.|
