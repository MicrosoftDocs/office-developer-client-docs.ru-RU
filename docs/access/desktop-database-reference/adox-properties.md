---
title: Свойства ADOX (Справочник по базам данных Access на компьютере)
...
<td><p>Указывает объект <strong>подключения</strong> ADO, к которому принадлежит каталог.</p></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td><p><a href="clustered-property-adox.md">Сгруппирован</a></p></td>
...
<td><p>Указывает действие, выполняемое при удалении первичного ключа.</p></td>
</tr>
<tr class="even">
...
<td><p>Указывает Масштаб числового значения в столбце.</p></td>
</tr>
<tr class="even">
<td><p><a href="parentcatalog-property-adox.md">ParentCatalog</a></p></td>
<td><p>Задает родительский каталог таблицы или столбца для предоставления доступа к свойствам, зависящим от поставщика.</p></td>
</tr>
<tr class="odd">
<td><p><a href="precision-property-adox.md">Точности</a></p></td>
...
<td><p>Указывает, представляет ли индекс первичный ключ для таблицы.</p></td>
</tr>
<tr class="odd">
...
<td><p>Указывает последовательность сортировки для столбца (только столбцы индекса).</p></td>
</tr>
<tr class="even">
...
<tr class="odd">
<td><p><a href="https://docs.microsoft.com/office/vba/access/concepts/miscellaneous/type-property-keyadox">Тип (Key)</a></p></td>
...
<td><p>Указывает действие, выполняемое при обновлении первичного ключа.</p></td>
</tr>
</tbody>
</table>
