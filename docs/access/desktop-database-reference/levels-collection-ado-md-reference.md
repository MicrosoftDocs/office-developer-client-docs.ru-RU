...
---
# <a name="levels-collection-ado-md-reference"></a>Коллекция уровней (ссылка на ADO MD)

**Область применения**: Access 2013, Office 2013

- [Коллекция уровней (ADO MD)](levels-collection-ado-md.md)
- [Свойства, методы и события коллекции уровней (ADO MD)](levels-collection-properties-methods-and-events-ado-md.md)
