...
---
# <a name="cancel-method-example-vb"></a>Пример использования метода Cancel (VB)


**Область применения**: Access 2013, Office 2013

В этом примере метод [Отмена](cancel-method-ado.md) отмены выполнения команды на [объекте Подключения,](connection-object-ado.md) если подключение загружено.
