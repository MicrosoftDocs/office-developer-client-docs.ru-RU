...
---
# <a name="column-object-adox-reference"></a>Справочник по объекту Column (ADOX)

**Область применения**: Access 2013, Office 2013

- [Объект Column (ADOX)](column-object-adox.md)
- [Свойства, методы и события столбца (ADOX)](column-properties-methods-and-events-adox.md)
