...
Пример использования этих методов для работы с двоичными [данными приведен в](getchunk-method-ado.md) примерах [методов](appendchunk-method-ado.md) и методов AppendChunk в *справочнике программиста по ADO*.
