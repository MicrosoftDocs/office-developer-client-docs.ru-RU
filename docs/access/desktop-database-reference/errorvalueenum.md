...
> [!NOTE]
> <P>OLE DB ошибки могут передаваться в приложение ADO. Как правило их можно определить по код устройства Windows <EM>4</EM>. Например, 0x800<STRONG><EM>4</EM></STRONG>... Дополнительные сведения об этих номеров см из <EM>Справочник программиста OLE DB.</EM></P>
