...
Следующий код демонстрирует использование [процедуры](procedures-collection-adox.md) сбора метод [Append](append-method-adox-procedures.md) и объект [команды](command-object-ado.md) для создания новой процедуры в источнике данных.
