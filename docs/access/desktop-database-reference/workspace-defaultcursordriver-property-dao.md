...
---
# <a name="workspacedefaultcursordriver-property-dao"></a>Свойство Workspace.DefaultCursorDriver (DAO)
...
*выражение .* DefaultCursorDriver

*expression*: переменная, представляющая объект **Workspace**.

## <a name="remarks"></a>Заметки

Для параметра или возвращаемого значения можно установить одну из **[констант CursorDriverEnum.](cursordriverenum-enumeration-dao.md)**
