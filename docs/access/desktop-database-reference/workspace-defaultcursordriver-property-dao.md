...
Параметр или возвращаемое значение может быть установлено одно константы **[CursorDriverEnum](cursordriverenum-enumeration-dao.md)** .

Значение этого свойства влияет только на подключения, установленные после установки свойства. Изменение свойства **DefaultCursorDriver** не влияет на существующие подключения.
