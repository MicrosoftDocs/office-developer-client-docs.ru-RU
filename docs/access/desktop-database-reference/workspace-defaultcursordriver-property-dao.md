...
*выражения* . DefaultCursorDriver

*expression*: переменная, представляющая объект **Workspace**.

## <a name="remarks"></a>Примечания

Значение параметра или возврата можно установить в одной из констант **[CursorDriverEnum.](cursordriverenum-enumeration-dao.md)**
