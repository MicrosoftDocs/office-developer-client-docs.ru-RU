...
---
# <a name="workspacedefaultcursordriver-property-dao"></a>Свойство Workspace. Дефаулткурсордривер (DAO)
...
Этот параметр свойства влияет только на подключения, установленные после задания свойства. Изменение свойства **дефаулткурсордривер** не оказывает никакого действия для существующих подключений.
