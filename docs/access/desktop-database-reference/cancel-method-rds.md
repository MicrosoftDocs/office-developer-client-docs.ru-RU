...
При **вызове отмены** [для ReadyState](readystate-property-rds.md) автоматически устанавливается **adcReadyStateLoaded,** и [набор записей](recordset-object-ado.md) будет пустым.
