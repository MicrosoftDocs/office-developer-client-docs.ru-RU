...
<td><p>Указывает значения, которые будут добавлены в строку свойств команды (набора строк), отправляемых на сервер с помощью службы MS Remote. Значение по умолчанию для этой строки — vt_empty.</p></td>
</tr>
<tr class="odd">
...
<li><p>Обновление (явно или автоматически) с помощью свойства <strong>Resync</strong> .</p></li>
