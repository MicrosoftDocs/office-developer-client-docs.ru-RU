...
---
# <a name="catalog-object-adox-reference"></a>Справочник по объекту Catalog (ADOX)

**Область применения**: Access 2013, Office 2013

- [Объект Catalog (ADOX)](catalog-object-adox.md)
- [Свойства, методы и события каталога (ADOX)](catalog-properties-methods-and-events-adox.md)
