...
В рабочей области ODBCDirect можно открыть объект **Recordset** , содержащий несколько запросов на выборку в аргументе Source объекта **OpenRecordset**, или свойство **[SQL](querydef-sql-property-dao.md)** объекта "Select Query **[QueryDef](querydef-object-dao.md)** ", как показано в следующем примере.
