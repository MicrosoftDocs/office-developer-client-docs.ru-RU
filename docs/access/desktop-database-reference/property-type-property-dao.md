...
Параметр или возвращаемое значение является константой, указывающей операционный тип или тип данных. Для **[объекта Property](property-object-dao.md)** это свойство считыв или записывалось до тех пор, пока объект не будет придан коллекции или другому объекту, после чего он будет только для чтения.

Для объекта **Property** возможные параметры и значения возврата описаны в следующей таблице.
