...
Параметр в команде, выданной в базе данных, имеет [](parameters-collection-ado.md) доступ к коллекции Параметры объекта [Command](command-object-ado.md) по индексу и имени. Затем из коллекции [](recordset-object-ado.md) Полей этого объекта по индексу [](fields-collection-ado.md) и имени можно получить доступ к полям возвращаемого набору записей.
