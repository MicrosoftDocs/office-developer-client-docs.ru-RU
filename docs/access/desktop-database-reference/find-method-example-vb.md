...
---
# <a name="find-method-example-vb"></a>Пример использования метода Find (VB)


**Область применения**: Access 2013, Office 2013

В этом примере используется метод [Find](recordset-object-ado.md) объекта [Recordset](find-method-ado.md) для поиска и подсчета количества названий бизнеса в ***базе данных Pubs.*** В примере предполагается, что основной поставщик не поддерживает аналогичные функции.
