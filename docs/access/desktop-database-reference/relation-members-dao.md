...
<td><p>Задает или возвращает имя внешней таблицы в связи (только для рабочей области Microsoft Access). .</p></td>
</tr>
<tr class="even">
...
<td><p>Задает или возвращает значение объекта <strong>Relation,</strong> указывающее, следует ли учитывать это отношение при заполнении частичной реплики из полной реплики. (Только для баз данных яд баз данных Microsoft Access). Для чтения и записи, <strong>Boolean</strong>.</p></td>
</tr>
<tr class="even">
