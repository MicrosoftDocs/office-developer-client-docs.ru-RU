...
В этом примере [свойство MarshalOptions](marshaloptions-property-ado.md) указывает, какие строки отправляются обратно на сервер — все строки или только измененные строки.
