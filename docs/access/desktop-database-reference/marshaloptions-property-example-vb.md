...
---
# <a name="marshaloptions-property-example-vb"></a>Пример использования свойства MarshalOptions (VB)


**Область применения**: Access 2013, Office 2013

В этом примере свойство [MarshalOptions](marshaloptions-property-ado.md) используется для указания строк, которые отправляются обратно на сервер ( все строки или только измененные строки).
