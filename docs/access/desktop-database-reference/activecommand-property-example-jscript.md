...
---
# <a name="activecommand-property-example-jscript"></a><span data-ttu-id="3234d-102">Пример использования свойства ActiveCommand (JScript)</span><span class="sxs-lookup"><span data-stu-id="3234d-102">ActiveCommand property example (JScript)</span></span>
...
<span data-ttu-id="3234d-104">В этом примере демонстрируется [свойство ActiveCommand.](activecommand-property-ado.md)</span><span class="sxs-lookup"><span data-stu-id="3234d-104">This example demonstrates the [ActiveCommand](activecommand-property-ado.md) property.</span></span> <span data-ttu-id="3234d-105">Вырезать и вклеить следующий код для Блокнот или другого редактора текста и сохранить его как **ActiveCommandJS.asp**.</span><span class="sxs-lookup"><span data-stu-id="3234d-105">Cut and paste the following code to Notepad or another text editor, and save it as **ActiveCommandJS.asp**.</span></span>
