...
ms.locfileid: "25480165"
---
# <a name="activecommand-property-example-jscript"></a><span data-ttu-id="15f05-102">ActiveCommand Property Example (JScript)</span><span class="sxs-lookup"><span data-stu-id="15f05-102">ActiveCommand Property Example (JScript)</span></span>


<span data-ttu-id="15f05-103">**Применимо к**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="15f05-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="15f05-104">В этом примере демонстрируется свойство [ActiveCommand](activecommand-property-ado.md) .</span><span class="sxs-lookup"><span data-stu-id="15f05-104">This example demonstrates the [ActiveCommand](activecommand-property-ado.md) property.</span></span> <span data-ttu-id="15f05-105">Скопируйте и вставьте следующий код в блокноте или другом текстовом редакторе и сохраните файл с именем **ActiveCommandJS.asp**.</span><span class="sxs-lookup"><span data-stu-id="15f05-105">Cut and paste the following code to Notepad or another text editor, and save it as **ActiveCommandJS.asp**.</span></span>
