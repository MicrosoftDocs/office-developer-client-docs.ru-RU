...
В приведенном ниже коде показано, как обновить коллекцию [views](views-collection-adox.md) [каталога](catalog-object-adox.md). Это необходимо, прежде чем можно будет получить доступ к объектам [просмотра](view-object-adox.md) из **каталога** .
