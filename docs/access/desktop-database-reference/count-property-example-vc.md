...
В этом примере показано [свойство Count](count-property-ado.md) с двумя коллекциями в базе ***данных сотрудников.*** Свойство получает количество объектов в каждой коллекции и задает верхний предел для циклов, которые окрикируют эти коллекции. Еще один способ, чтобы оготать эти коллекции без использования свойства **Count,** состоит в использовании заявлений.
