...
---
# <a name="find-method-example-vj"></a>Пример использования метода Find (VJ++)


**Область применения**: Access 2013, Office 2013

В этом примере метод [](find-method-ado.md) Find объекта [Recordset](recordset-object-ado.md) используется для поиска и подсчета количества названий бизнеса в базе ***данных Pubs.*** В примере предполагается, что основной поставщик не поддерживает аналогичные функции.
