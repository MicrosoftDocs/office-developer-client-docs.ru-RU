...
В этом примере используется [](find-method-ado.md) метод Find объекта [Recordset](recordset-object-ado.md) для поиска и подсчета количества бизнес-названий в ***базе данных Pubs.*** В примере предполагается, что основной поставщик не поддерживает аналогичные функции.
