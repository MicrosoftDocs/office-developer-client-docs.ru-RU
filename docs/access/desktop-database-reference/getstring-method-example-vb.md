...
---
# <a name="getstring-method-example-vb"></a>Пример использования метода GetString (VB)
...
Предположим, что отладка проблемы с доступом к данным и быстрый простой способ печати текущего содержимого небольшого наборов [записей.](recordset-object-ado.md)
