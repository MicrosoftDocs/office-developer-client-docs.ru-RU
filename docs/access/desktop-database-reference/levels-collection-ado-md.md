...
---
# <a name="levels-collection-ado-md"></a>Коллекция Levels (ADO MD)
...
**Levels** — это стандартная коллекция ADO. С помощью свойств и методов коллекции можно выполнить следующие действия:
