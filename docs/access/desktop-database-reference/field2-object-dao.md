...
Объект **Field2** содержит все те же свойства и методы, что и **[объект Field.](field-object-dao.md)** Объект **Field2 содержит** несколько новых свойств и методов, поддерживаюных многомерные типы полей. Новые свойства и методы:
...
Чтобы сослаться на **объект Field2** в коллекции по его порядковому номеру или по параметру свойства **Name,** используйте любую из следующих форм синтаксиса:
...
С помощью тех же синтаксисных форм можно также сослаться на свойство **Value** объекта **Field2,** который создается и примыкает к коллекции **Fields.** Контекст ссылки на поле определяет, ссылается ли вы на объект **Field2** или свойство **Value** объекта **Field.**
