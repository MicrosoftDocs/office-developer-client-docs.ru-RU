...
Во время пакетной **обработки** свойство Status объекта **Recordset** предоставляет сведения об отдельных записях в **наборе записей.** Перед пакетным обновлением свойство **Status** объекта **Recordset** отражает сведения о записях, которые необходимо добавить, изменить и удалить. 
