...
Возвращает полностью или часть содержимого объекта **MEMO** или длинного объекта **BinaryField2** в коллекции Fields объекта **[](fields-collection-dao.md)** **[Recordset](recordset-object-dao.md)** .
