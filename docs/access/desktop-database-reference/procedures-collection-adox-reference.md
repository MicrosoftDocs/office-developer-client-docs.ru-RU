...
**Применимо к**: Access 2013, Office 2013
  ...
  - [Коллекция процедуры (ADOX)](procedures-collection-adox.md)

  - [Свойства коллекции процедуры, методы и события (ADOX)](procedures-collection-properties-methods-and-events-adox.md)
