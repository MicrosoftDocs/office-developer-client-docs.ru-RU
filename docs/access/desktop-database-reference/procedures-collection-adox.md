---
title: Коллекция процедуры (ADOX)
...
ms.locfileid: "25877893"
---
# <a name="procedures-collection-adox"></a>Коллекция процедуры (ADOX)
...
Остальные свойства и методы являются стандартными в семействах сайтов ADO. Вы можете выполнить указанные ниже действия.
  ...
  - Доступ к процедуре в коллекции с помощью свойства [элемента](item-property-ado.md) .

  - Возвращает число процедур, содержащихся в коллекции со свойством [Count](count-property-ado.md) .

  - Удаление процедуры из коллекции с помощью метода [Delete](delete-method-adox-collections.md) .
