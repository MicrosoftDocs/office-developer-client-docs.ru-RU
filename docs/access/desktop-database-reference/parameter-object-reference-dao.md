---
title: Параметр ссылку на объект (DAO)
...
ms.locfileid: "25920937"
---
# <a name="parameter-object-reference-dao"></a>Параметр ссылку на объект (DAO)

**Применимо к**: Access 2013, Office 2013

- [Параметр object (DAO)](parameter-object-dao.md)
- [Параметр члены (DAO)](parameter-members-dao.md)
