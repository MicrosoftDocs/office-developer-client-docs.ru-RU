...
Свойство **Connect** можно задать во время создания в службе [RDS. ](datacontrol-object-rds.md)Объектные теги объекта DataObject или во время выполнения в коде сценария (например, на языке VBScript).
