...
---
# <a name="view-object-adox-reference"></a>Просмотр ссылку на объект (ADOX)

**Применимо к**: Access 2013, Office 2013

- [Объект View (ADOX)](view-object-adox.md)
- [Просмотреть свойства, методы и события (ADOX)](view-properties-methods-and-events-adox.md)
