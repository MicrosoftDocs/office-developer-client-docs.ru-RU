...
---
# <a name="definedsize-property-example-vb"></a><span data-ttu-id="f08ef-102">Пример использования свойства DefinedSize (VB)</span><span class="sxs-lookup"><span data-stu-id="f08ef-102">DefinedSize property example (VB)</span></span>


<span data-ttu-id="f08ef-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="f08ef-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="f08ef-104">В этом примере показано свойство [DefinedSize](definedsize-property-adox.md) [столбца](column-object-adox.md).</span><span class="sxs-lookup"><span data-stu-id="f08ef-104">This example demonstrates the [DefinedSize](definedsize-property-adox.md) property of a [Column](column-object-adox.md).</span></span> <span data-ttu-id="f08ef-105">Код переопределит размер столбца "FirstName" таблицы **Employees** базы данных *Northwind* .</span><span class="sxs-lookup"><span data-stu-id="f08ef-105">The code will redefine the size of the FirstName column of the **Employees** table of the *Northwind* database.</span></span> <span data-ttu-id="f08ef-106">Затем отображается изменение значений [поля](field-object-ado.md) FirstName объекта [Recordset](recordset-object-ado.md) на основе таблицы **Employees (сотрудники** ).</span><span class="sxs-lookup"><span data-stu-id="f08ef-106">Then, the change in the values of the FirstName [Field](field-object-ado.md) of a [Recordset](recordset-object-ado.md) based on the **Employees** table is displayed.</span></span> <span data-ttu-id="f08ef-107">Обратите внимание, что по умолчанию поле FirstName заполняется пробелами после переопределения свойства **DefinedSize** .</span><span class="sxs-lookup"><span data-stu-id="f08ef-107">Note that by default, the FirstName field becomes padded with spaces after you redefine the **DefinedSize** property.</span></span>
