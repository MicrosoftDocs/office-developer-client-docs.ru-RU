...
Возвращает **вариант,** содержащий объект **Command.** Значение по умолчанию — это ссылка на объект null.

## <a name="remarks"></a>Заметки

Свойство **ActiveCommand** является только для чтения.

Если объект **Command** не использовался для создания текущего объекта **Recordset,** возвращается ссылка на объект **Null.**

Используйте это свойство, чтобы найти связанный **объект Command,** если вы получили только итоговые **объекты Recordset.**
