---
title: Справочник по объектам Property (ADO)
...
---
# <a name="property-object-ado-reference"></a>Справочник по объектам Property (ADO)

**Область применения**: Access 2013, Office 2013

- [Объект Property (ADO)](property-object-ado.md)
- [Свойства, методы и события свойств (ADO)](property-properties-methods-and-events-ado.md)
