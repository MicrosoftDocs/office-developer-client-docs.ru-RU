...
Содержит [объекты Position,](position-object-ado-md.md) которые определяют точку на оси.

## <a name="remarks"></a>Заметки

**Positions** — это стандартная коллекция ADO. С помощью свойств и методов коллекции можно сделать следующее:
