...
Создает новый объект **[Index](index-object-dao.md)** (только для рабочих пространств Microsoft Access). .

## <a name="syntax"></a>Синтаксис

*выражение .* CreateIndex(***Name***)
...
<td><p><strong>Строка,</strong> однозначно именовав новый <strong>объект Index.</strong> Сведения о <strong>допустимом</strong> имени индекса см. в свойстве <strong>Name.</strong></p></td>
</tr>
</tbody>
</table>
...
С помощью метода **CreateIndex** можно создать новый объект **Index** для **объекта TableDef.** Если опустить необязательные части имени при использовании **CreateIndex,** можно использовать соответствующий отчет о назначении, чтобы установить или сбросить свойство **Name** перед тем, как приместь новый объект в коллекцию. После того как вы добавили объект, вы можете или не сможете установить его свойство **Name** в зависимости от типа объекта, который содержит **коллекцию Indexes.** Дополнительные **сведения см.** в разделе о свойстве Name.
