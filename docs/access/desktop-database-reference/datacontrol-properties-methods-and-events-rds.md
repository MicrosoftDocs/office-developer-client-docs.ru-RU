...
---
# <a name="datacontrol-properties-methods-and-events-rds"></a>Свойства, методы и события элемента управления "элемент управления" (RDS)
...
- [Свойство FilterCriterion (RDS)](filtercriterion-property-rds.md)
- [Свойство FilterValue (RDS)](filtervalue-property-rds.md)
- [Свойство Handler (RDS)](handler-property-rds.md)
...
- [Свойство SQL (RDS)](https://docs.microsoft.com/office/vba/access/concepts/miscellaneous/sql-property-ado)
...
- [Событие OnError](onerror-event-rds.md)
- [Событие Онреадистатечанже](onreadystatechange-event-rds.md)
