...
В разделе система — это стандартный раздел для всех приложений на основе Windows Microsoft. Она предоставляет сведения по темам, поддерживаемых приложением. Для доступа к этой информации, код должен сначала вызвать **отношением с аргументом *раздел* ** и выполните оператор **DDERequest** с одним из следующих действий, предоставленных для аргумента *элемента* .
