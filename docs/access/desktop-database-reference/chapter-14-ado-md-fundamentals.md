...
Объекты данных Microsoft ActiveX (многомерные) (ADO MD) обеспечивают простой доступ к многомерным данным из таких языков, как Microsoft Visual Basic, Microsoft Visual C++ и Microsoft Visual J++. ADO MD расширяет объекты данных Microsoft ActiveX (ADO), включая объекты, специфичные для многомерных данных, например [Объекты CubeDef](cubedef-object-ado-md.md) и [Cellset.](cellset-object-ado-md.md) С помощью ADO MD можно просматривать многомерные схемы, запрашивать кубы и получать результаты.
...
В этом документе предполагается знание языка Visual Basic программирования и общие знания ADO и OLAP. Дополнительные сведения см. в руководстве [программиста ADO](ado-programmer-s-guide.md) и справочнике по OLE DB for OLAP Programmer. 
