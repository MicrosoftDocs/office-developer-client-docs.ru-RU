...
|Параметр|Описание|
|:--------|:----------|
|*аффектрекордс* |Необязательное. Значение [аффектенум](affectenum.md) , указывающее количество записей, на которые влияет метод **UpdateBatch** .|
