...
ms.locfileid: "25481500"
---
# <a name="status-property-example-vj"></a><span data-ttu-id="3e150-102">Status Property Example (VJ++)</span><span class="sxs-lookup"><span data-stu-id="3e150-102">Status Property Example (VJ++)</span></span>


<span data-ttu-id="3e150-103">**Применимо к**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="3e150-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="3e150-104">В этом примере используется свойство [состояние](status-property-ado-recordset.md) для отображения записи, которые были изменены в пакетной операции до пакета обновления.</span><span class="sxs-lookup"><span data-stu-id="3e150-104">This example uses the [Status](status-property-ado-recordset.md) property to display which records have been modified in a batch operation before a batch update has occurred.</span></span>
