...
В этом примере показано свойство [Type,](type-property-ado.md) отображая имя константы, соответствующее значению свойства **Type** всех объектов [Field](field-object-ado.md) в таблице ***Employees.*** Функция FieldType необходима для запуска этой процедуры.
