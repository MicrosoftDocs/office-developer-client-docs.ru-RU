...
В этом примере свойство [State](state-property-ado.md) используется для отображения сообщения при открытии асинхронных подключений и выполнении асинхронных команд.
