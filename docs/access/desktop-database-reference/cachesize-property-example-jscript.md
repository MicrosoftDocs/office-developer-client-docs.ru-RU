...
В этом примере свойство [CacheSize](cachesize-property-ado.md) используется для демонстрации разницы в производительности для операции, выполняемой с кэшом с 30 записями и без него. Включите следующий код в Блокнот или другой текстовый редактор и сохраните его как **CacheSizeJS.asp.**
