...
**Объекты** параметра позволяют изменять аргументы в часто запускаемом объекте **QueryDef** без повторнойкомплектации запроса.

С помощью свойств объекта **Parameter** можно установить параметр запроса, который можно изменить перед запуском запроса. Вы получаете перечисленные ниже возможности.

  - Чтобы вернуть имя параметра, используйте свойство **Name.**

  - Используйте свойство **Value** для набора или возврата значений параметров, которые будут использоваться в запросе.

  - Чтобы **вернуть** тип данных объекта Parameter, используйте свойство **Type.**

  - Используйте свойство **Direction** для набора или возврата параметра ввода, параметра вывода или обоих.
