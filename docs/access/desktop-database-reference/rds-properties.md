...
<tr class="even">
<td><p><a href="filtervalue-property-rds.md">Значение_фильтра</a></p></td>
<td><p>Указывает значение для фильтрации записей.</p></td>
</tr>
<tr class="odd">
<td><p><a href="handler-property-rds.md">Обработчик</a></p></td>
...
<tr class="odd">
<td><p><a href="sortdirection-property-rds.md">Направления сортировки</a></p></td>
