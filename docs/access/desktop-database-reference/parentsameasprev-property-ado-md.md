...
Указывает, является ли родитель этого члена позиции таким же, как и родитель непосредственно предшествующего члена.

## <a name="return-values"></a>Возвращаемые значения

Возвращает значение **Boolean** и является только для чтения.
