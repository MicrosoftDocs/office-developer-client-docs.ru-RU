---
title: Пример использования метода ConvertToString (VB)
...
ms.locfileid: "32295508"
---
# <a name="converttostring-method-example-vb"></a><span data-ttu-id="268e5-102">Пример использования метода ConvertToString (VB)</span><span class="sxs-lookup"><span data-stu-id="268e5-102">ConvertToString method example (VB)</span></span>


<span data-ttu-id="268e5-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="268e5-103">**Applies to**: Access 2013, Office 2013</span></span>
