...
---
# <a name="converttostring-method-example-vb"></a><span data-ttu-id="4dc5b-102">Пример использования метода ConvertToString (VB)</span><span class="sxs-lookup"><span data-stu-id="4dc5b-102">ConvertToString method example (VB)</span></span>


<span data-ttu-id="4dc5b-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="4dc5b-103">**Applies to**: Access 2013, Office 2013</span></span>
