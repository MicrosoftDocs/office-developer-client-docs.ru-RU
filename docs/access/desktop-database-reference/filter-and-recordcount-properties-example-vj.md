...
---
# <a name="filter-and-recordcount-properties-example-vj"></a><span data-ttu-id="60019-102">Пример использования свойств Filter и RecordCount (VJ++)</span><span class="sxs-lookup"><span data-stu-id="60019-102">Filter and RecordCount properties example (VJ++)</span></span>


<span data-ttu-id="60019-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="60019-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="60019-104">В этом примере свойство [Filter](filter-property-ado.md) используется для открытия нового объекта [Recordset](recordset-object-ado.md) на основе указанного условия, примененного к существующему **набору записей.**</span><span class="sxs-lookup"><span data-stu-id="60019-104">This example uses the [Filter](filter-property-ado.md) property to open a new [Recordset](recordset-object-ado.md) based on a specified condition applied to an existing **Recordset**.</span></span> <span data-ttu-id="60019-105">Свойство [RecordCount](recordcount-property-ado.md) используется для показа количества записей в двух **recordsets.**</span><span class="sxs-lookup"><span data-stu-id="60019-105">It uses the [RecordCount](recordcount-property-ado.md) property to show the number of records in the two **Recordsets**.</span></span> <span data-ttu-id="60019-106">Функция FilterField необходима для запуска этой процедуры.</span><span class="sxs-lookup"><span data-stu-id="60019-106">The FilterField function is required for this procedure to run.</span></span>
