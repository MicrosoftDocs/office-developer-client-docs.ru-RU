...
В этом примере свойство [Filter](filter-property-ado.md) используется для открытия нового [наборов записей](recordset-object-ado.md) на основе заданного условия, примененного к существующему **набору записей.** Свойство [RecordCount](recordcount-property-ado.md) использует для демонстрации количества записей в двух **записях.** Для запуска этой процедуры требуется функция FilterField.
