...
---
# <a name="filter-and-recordcount-properties-example-vj"></a><span data-ttu-id="665d4-102">Пример использования свойств Filter и RecordCount (VJ++)</span><span class="sxs-lookup"><span data-stu-id="665d4-102">Filter and RecordCount properties example (VJ++)</span></span>


<span data-ttu-id="665d4-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="665d4-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="665d4-104">В этом примере свойство [Filter](filter-property-ado.md) используется для открытия нового [наборов записей](recordset-object-ado.md) на основе заданного условия, примененного к существующему **набору записей.**</span><span class="sxs-lookup"><span data-stu-id="665d4-104">This example uses the [Filter](filter-property-ado.md) property to open a new [Recordset](recordset-object-ado.md) based on a specified condition applied to an existing **Recordset**.</span></span> <span data-ttu-id="665d4-105">Свойство [RecordCount](recordcount-property-ado.md) использует для демонстрации количества записей в двух **записях.**</span><span class="sxs-lookup"><span data-stu-id="665d4-105">It uses the [RecordCount](recordcount-property-ado.md) property to show the number of records in the two **Recordsets**.</span></span> <span data-ttu-id="665d4-106">Для запуска этой процедуры требуется функция FilterField.</span><span class="sxs-lookup"><span data-stu-id="665d4-106">The FilterField function is required for this procedure to run.</span></span>
