...
Код Microsoft JScript должен проверить свойство **Count** коллекции **errors** объекта **Connection.** Если значение больше 0, итерации по коллекции и печать значений, как на любом из других языков.
