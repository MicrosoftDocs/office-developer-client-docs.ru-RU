...
Код microsoft JScript должен проверить свойство **Count** **из** коллекции ошибок объекта **Подключения.** Если значение больше 0, итерировать в коллекции и распечатать значения, как это было бы на любом из других языков.
