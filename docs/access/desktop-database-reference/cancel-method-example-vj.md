...
---
# <a name="cancel-method-example-vj"></a><span data-ttu-id="cd8f6-102">Пример использования метода Cancel (VJ++)</span><span class="sxs-lookup"><span data-stu-id="cd8f6-102">Cancel method example (VJ++)</span></span>


<span data-ttu-id="cd8f6-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="cd8f6-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="cd8f6-104">В этом примере метод [Отмена](cancel-method-ado.md) отмены выполнения команды на [объекте Подключения,](connection-object-ado.md) если подключение загружено.</span><span class="sxs-lookup"><span data-stu-id="cd8f6-104">This example uses the [Cancel](cancel-method-ado.md) method to cancel a command executing on a [Connection](connection-object-ado.md) object if the connection is busy.</span></span>
