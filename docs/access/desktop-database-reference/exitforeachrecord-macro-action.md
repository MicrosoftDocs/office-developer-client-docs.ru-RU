...
---
# <a name="exitforeachrecord-macro-action"></a>Макрокоманда ExitForEachRecord


**Область применения**: Access 2013, Office 2013

Используйте действие **екситфореачрекорд** для немедленного выхода из блока данных **[ДляКаждойЗаписи](foreachrecord-data-block.md)** .
