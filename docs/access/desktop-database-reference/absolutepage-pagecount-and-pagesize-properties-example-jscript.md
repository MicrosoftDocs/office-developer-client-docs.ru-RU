...
В этом примере свойства AbsolutePage, PageCount и PageSize. Скопируйте и вставьте следующий код в блокноте или другом текстовом редакторе и сохраните файл с именем **AbsolutePageJS.asp**.
