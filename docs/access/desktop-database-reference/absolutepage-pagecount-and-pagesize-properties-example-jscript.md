...
ms.locfileid: "25479981"
---
# <a name="absolutepage-pagecount-and-pagesize-properties-example-jscript"></a><span data-ttu-id="35a39-102">AbsolutePage, PageCount, and PageSize Properties Example (JScript)</span><span class="sxs-lookup"><span data-stu-id="35a39-102">AbsolutePage, PageCount, and PageSize Properties Example (JScript)</span></span>

<span data-ttu-id="35a39-103">**Применимо к**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="35a39-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="35a39-104">В этом примере свойства AbsolutePage, PageCount и PageSize.</span><span class="sxs-lookup"><span data-stu-id="35a39-104">This example demonstrates the AbsolutePage, PageCount, and PageSize properties.</span></span> <span data-ttu-id="35a39-105">Скопируйте и вставьте следующий код в блокноте или другом текстовом редакторе и сохраните файл с именем **AbsolutePageJS.asp**.</span><span class="sxs-lookup"><span data-stu-id="35a39-105">Cut and paste the following code to Notepad or another text editor, and save it as **AbsolutePageJS.asp**.</span></span>
