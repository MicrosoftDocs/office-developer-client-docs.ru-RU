...
---
# <a name="parameters-collection-command-property-example-vc"></a><span data-ttu-id="f86a3-102">Коллекция параметров, пример свойства Command (VC++)</span><span class="sxs-lookup"><span data-stu-id="f86a3-102">Parameters Collection, Command property example (VC++)</span></span>


<span data-ttu-id="f86a3-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="f86a3-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="f86a3-104">В следующем коде показано, как использовать свойство [Command](command-property-adox.md) с объектом [Command](command-object-ado.md) для получения сведений о параметрах для процедуры.</span><span class="sxs-lookup"><span data-stu-id="f86a3-104">The following code demonstrates how to use the [Command](command-property-adox.md) property with the [Command](command-object-ado.md) object to retrieve parameter information for the procedure.</span></span>
