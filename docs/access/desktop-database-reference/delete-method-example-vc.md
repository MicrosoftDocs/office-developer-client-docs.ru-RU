...
---
# <a name="delete-method-example-vc"></a><span data-ttu-id="ff53f-102">Пример использования метода Delete (VC++)</span><span class="sxs-lookup"><span data-stu-id="ff53f-102">Delete method example (VC++)</span></span>


<span data-ttu-id="ff53f-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="ff53f-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="ff53f-104">В этом примере метод [Delete](delete-method-ado-recordset.md) используется для удаления указанной записи из [recordset.](recordset-object-ado.md)</span><span class="sxs-lookup"><span data-stu-id="ff53f-104">This example uses the [Delete](delete-method-ado-recordset.md) method to remove a specified record from a [Recordset](recordset-object-ado.md).</span></span>
...
<span data-ttu-id="ff53f-105">**DeleteX.h**</span><span class="sxs-lookup"><span data-stu-id="ff53f-105">**DeleteX.h**</span></span>
