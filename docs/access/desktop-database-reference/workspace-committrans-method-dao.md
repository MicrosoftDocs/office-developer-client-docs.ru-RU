...
## <a name="example"></a><span data-ttu-id="d31f5-153">Пример</span><span class="sxs-lookup"><span data-stu-id="d31f5-153">Example</span></span>
