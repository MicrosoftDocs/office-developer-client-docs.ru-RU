...
Указывает источник данных в ячейках.

## <a name="settings-and-return-values"></a>Параметры и возвращаемые значения

Задает или возвращает variant **и** считывать и записывать для закрытых объектов [Cellset](cellset-object-ado-md.md) и только для чтения открытых **объектов Cellset.** Variant **должен** содержать допустимую **строку,** например запрос MDX.
