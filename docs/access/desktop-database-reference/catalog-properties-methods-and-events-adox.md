...
- [Коллекция Procedures](procedures-collection-adox.md)
- [Коллекция Tables](tables-collection-adox.md)
...
- [Метод SetObjectOwner](https://docs.microsoft.com/office/vba/access/concepts/miscellaneous/setobjectowner-method-adox)
