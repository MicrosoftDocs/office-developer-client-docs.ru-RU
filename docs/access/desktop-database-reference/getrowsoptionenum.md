---
title: GetRowsOptionEnum (ссылка на настольные базы данных)
...
Указывает количество записей, которые необходимо получить из [recordset.](recordset-object-ado.md)
...
<td><p>–1</p></td>
<td><p>Извлекает остальные записи в <strong></strong>Наборе записей либо из текущей позиции, либо из закладки, указанной параметром <em>Start</em> метода <a href="getrows-method-ado.md">GetRows.</a></p></td>
</tr>
</tbody>
</table>
