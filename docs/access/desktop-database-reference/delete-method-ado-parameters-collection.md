...
|Параметр|Описание|
|:--------|:----------|
|*Индекс* |**Строка,** которая содержит имя удаляемого объекта или порядковую позицию (индекс) объектов в коллекции.|

## <a name="remarks"></a>Заметки

Использование метода **Delete** в коллекции позволяет удалить один из объектов в коллекции. Этот метод доступен только в коллекции **Parameters** объекта [Command.](command-object-ado.md) При вызове метода **Delete** необходимо использовать свойство [Name](parameter-object-ado.md) объекта [Parameter](name-property-ado.md) или его индекс коллекции— объектная переменная не является допустимым аргументом.
