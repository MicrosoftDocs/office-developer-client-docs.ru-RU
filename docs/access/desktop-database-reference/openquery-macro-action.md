...
> [!NOTE]
> <P>Это действие доступно только в среде базы данных Access (MDB- или .accdb). Посмотреть <STRONG>OpenView</STRONG>, <STRONG>ОткрытьСохраненнуюПроцедуру</STRONG>или <STRONG>ОткрытьФункцию</STRONG> действия при использовании среды проекта Microsoft Access (файлы с расширением ADP).</P>
