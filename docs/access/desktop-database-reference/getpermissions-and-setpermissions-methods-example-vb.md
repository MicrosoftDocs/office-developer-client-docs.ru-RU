...
---
# <a name="getpermissions-and-setpermissions-methods-example-vb"></a>Пример использования методов GetPermissions и SetPermissions (VB)


**Применимо к**: Access 2013, Office 2013

В этом примере показаны методы [GetPermissions](getpermissions-method-adox.md) и [SetPermissions](setpermissions-method-adox.md) . Приведенный ниже код предоставляет полный доступ для таблицы заказов пользователю с правами администратора.
