...
В этих трех примерах  показано, как можно совместно использовать методы [Сохранить](save-method-ado.md) и Открыть.

Предположим, что вы собираетесь в командировку и хотите взять таблицу из базы данных. Перед входом вы можете получить доступ к данным в виде [наборов записей](recordset-object-ado.md) и сохранить их в транспортируемых формах. По прибытии в пункт назначения вы можете получить доступ к **Набору записей** в качестве локального отключенного **наборов записей.** Внося изменения в **Набор записей,** затем сохраните его снова вместе с изменениями. Наконец, когда вы возвращаетесь домой, вы снова подключаетесь к базе данных и обновляете ее с помощью изменений, внесенных на дороге.
