...
---
# <a name="save-and-open-methods-example-vj"></a>Пример использования методов Save и Open (VJ++)


**Область применения**: Access 2013, Office 2013

В этих трех примерах показано, как можно использовать методы [Save](save-method-ado.md) и **Open** вместе.

Предположим, что вы собираетесь в бизнес-поездку и хотите взять таблицу из базы данных. Прежде чем перейти, вы можете получить доступ к данным как к [набору записей](recordset-object-ado.md) и сохранить их в транспортируемых формах. Когда вы поступаете в место назначения, вы можете получить доступ к **набору записей** как к локальному отключенным **набору записей.** Вы изменяете набор **записей, а** затем сохраняете его еще раз вместе с изменениями. Наконец, когда вы вернетесь домой, вы снова подключаетесь к базе данных и обновляете ее с помощью изменений, внесенных в пути.
