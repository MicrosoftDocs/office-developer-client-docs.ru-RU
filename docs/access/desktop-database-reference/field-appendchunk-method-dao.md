...
Применит данные из строки к объекту Memo или Long Binary **[Field](field-object-dao.md)** в **[Наборе записей.](recordset-object-dao.md)**
...
<td><p>Выражение Variant (String subtype) или переменная, содержащая данные, которые необходимо примыкать к <strong>объекту Field.</strong></p></td>
</tr>
</tbody>
</table>
