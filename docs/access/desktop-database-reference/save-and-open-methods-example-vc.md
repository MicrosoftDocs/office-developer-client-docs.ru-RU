...
Предположим, что вы собираетесь в бизнес-поездку и хотите взять таблицу из базы данных. Прежде чем перейти, вы можете получить доступ к данным как к [набору записей](recordset-object-ado.md) и сохранить их в транспортируемых формах. Когда вы поступаете в место назначения, вы можете получить доступ к **набору записей** как к локальному отключенным **набору записей.** Внося изменения в **набор записей,** сохраните его еще раз. Наконец, когда вы вернетесь домой, вы снова подключаетесь к базе данных и обновляете ее с помощью изменений, внесенных в пути.
