...
## <a name="time--date-functions"></a>Функции time _Амп_ Date
...
<tr class="odd">
<td><p>CONVERT</p></td>
<td><p>Строковые литералы могут быть преобразованы в следующие типы данных: СКЛ_ФЛОАТ, СКЛ_ДАУБЛЕ, СКЛ_НУМЕРИК, СКЛ_ИНТЕЖЕР, СКЛ_РЕАЛ, СКЛ_СМАЛЛИНТ, СКЛ_ВАРЧАР и СКЛ_ДАТЕТИМЕ.</p></td>
</tr>
</tbody>
</table>
