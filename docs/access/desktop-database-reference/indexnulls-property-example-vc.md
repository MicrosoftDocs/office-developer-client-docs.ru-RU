...
---
# <a name="indexnulls-property-example-vc"></a><span data-ttu-id="6845d-102">Пример использования свойства IndexNulls (VC++)</span><span class="sxs-lookup"><span data-stu-id="6845d-102">IndexNulls property example (VC++)</span></span>


<span data-ttu-id="6845d-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="6845d-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="6845d-104">В этом примере показано свойство [IndexNulls](indexnulls-property-adox.md) [индекса.](index-object-adox.md)</span><span class="sxs-lookup"><span data-stu-id="6845d-104">This example demonstrates the [IndexNulls](indexnulls-property-adox.md) property of an [Index](index-object-adox.md).</span></span> <span data-ttu-id="6845d-105">Код создает новый индекс и задает значение **IndexNulls** на основе ввода пользователя.</span><span class="sxs-lookup"><span data-stu-id="6845d-105">The code creates a new index and sets the value of **IndexNulls** based on user input.</span></span> <span data-ttu-id="6845d-106">Затем индекс **примещается** к таблице **сотрудников** [в](table-object-adox.md) *каталоге Northwind.* [](catalog-object-adox.md)</span><span class="sxs-lookup"><span data-stu-id="6845d-106">Then, the **Index** is appended to the **Employees** [Table](table-object-adox.md) in the *Northwind* [Catalog](catalog-object-adox.md).</span></span> <span data-ttu-id="6845d-107">Новый индекс **применяется** к набору [записей](recordset-object-ado.md) на основе таблицы **"Сотрудники"** и открывается **набор** записей.</span><span class="sxs-lookup"><span data-stu-id="6845d-107">The new **Index** is applied to a [Recordset](recordset-object-ado.md) based on the **Employees** table, and the **Recordset** is opened.</span></span> <span data-ttu-id="6845d-108">В таблицу **Employees** добавляется новая запись со значением **Null** в проиндексации поля.</span><span class="sxs-lookup"><span data-stu-id="6845d-108">A new record is added to the **Employees** table, with a **Null** value in the indexed field.</span></span> <span data-ttu-id="6845d-109">Отобразить эту новую запись зависит от параметра свойства **IndexNulls.**</span><span class="sxs-lookup"><span data-stu-id="6845d-109">Whether this new record is displayed depends on the setting of the **IndexNulls** property.</span></span>
...
<span data-ttu-id="6845d-110">**IndexNullX.h**</span><span class="sxs-lookup"><span data-stu-id="6845d-110">**IndexNullX.h**</span></span>
