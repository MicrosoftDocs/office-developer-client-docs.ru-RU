...
---
# <a name="addnew-method-example-jscript"></a><span data-ttu-id="4cde8-102">AddNew Method Example (JScript)</span><span class="sxs-lookup"><span data-stu-id="4cde8-102">AddNew Method Example (JScript)</span></span>

<span data-ttu-id="4cde8-103">**Применимо к**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="4cde8-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="4cde8-104">В этом примере используется метод [AddNew](addnew-method-ado.md) , чтобы создать новую запись с указанным именем.</span><span class="sxs-lookup"><span data-stu-id="4cde8-104">This example uses the [AddNew](addnew-method-ado.md) method to create a new record with the specified name.</span></span> <span data-ttu-id="4cde8-105">Скопируйте и вставьте следующий код в блокноте или другом текстовом редакторе и сохраните файл с именем **AddNewJS.asp**.</span><span class="sxs-lookup"><span data-stu-id="4cde8-105">Cut and paste the following code to Notepad or another text editor, and save it as **AddNewJS.asp**.</span></span>
