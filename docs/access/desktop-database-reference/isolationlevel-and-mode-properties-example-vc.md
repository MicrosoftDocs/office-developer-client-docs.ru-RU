...
ms.locfileid: "25481704"
---
# <a name="isolationlevel-and-mode-properties-example-vc"></a><span data-ttu-id="f5611-102">IsolationLevel and Mode Properties Example (VC++)</span><span class="sxs-lookup"><span data-stu-id="f5611-102">IsolationLevel and Mode Properties Example (VC++)</span></span>


<span data-ttu-id="f5611-103">**Применимо к**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="f5611-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="f5611-104">В этом примере используется свойство [Mode](mode-property-ado.md) открыть исключительных подключение и свойство [IsolationLevel](isolationlevel-property-ado.md) для открытия транзакций, которая проводится по отдельности других операций.</span><span class="sxs-lookup"><span data-stu-id="f5611-104">This example uses the [Mode](mode-property-ado.md) property to open an exclusive connection, and the [IsolationLevel](isolationlevel-property-ado.md) property to open a transaction that is conducted in isolation of other transactions.</span></span>
...
<span data-ttu-id="f5611-105">**IsolationLevelX.h**</span><span class="sxs-lookup"><span data-stu-id="f5611-105">**IsolationLevelX.h**</span></span>
