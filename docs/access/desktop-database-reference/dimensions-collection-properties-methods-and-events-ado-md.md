---
title: Свойства коллекции измерений, методы и события (ADO MD)
...
ms.locfileid: "25943799"
---
# <a name="dimensions-collection-properties-methods-and-events-ado-md"></a>Свойства коллекции измерений, методы и события (ADO MD)
