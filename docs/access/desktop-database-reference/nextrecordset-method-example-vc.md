---
title: Пример использования метода NextRecordset (VC++)
...
ms.locfileid: "32288583"
---
# <a name="nextrecordset-method-example-vc"></a><span data-ttu-id="275ce-102">Пример использования метода NextRecordset (VC++)</span><span class="sxs-lookup"><span data-stu-id="275ce-102">NextRecordset method example (VC++)</span></span>


<span data-ttu-id="275ce-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="275ce-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="275ce-104">В этом примере метод [NextRecordset](nextrecordset-method-ado.md) используется для просмотра данных в наборе записей, в который используется сложное командно-командная выписка, выполненная из трех отдельных **заявлений SELECT.**</span><span class="sxs-lookup"><span data-stu-id="275ce-104">This example uses the [NextRecordset](nextrecordset-method-ado.md) method to view the data in a recordset that uses a compound command statement made up of three separate **SELECT** statements.</span></span>
