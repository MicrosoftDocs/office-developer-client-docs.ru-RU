...
В этом примере используется метод [NextRecordset](nextrecordset-method-ado.md) для просмотра данных в наборе записей, который использует составную команду, которая состоит из трех отдельных команд **SELECT.**
