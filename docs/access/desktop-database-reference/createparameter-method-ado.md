...
**Set** *параметр*  =  *команда*. CreateParameter (*имя*, *Тип*, *направление*, *Размер*, *значение*)
...
|Параметр|Описание|
|:--------|:----------|
|*Name* |Необязательный атрибут. **Строковое** значение, содержащее имя объекта **Parameter** .|
|*Type* |Необязательный атрибут. Значение [DataTypeEnum](datatypeenum.md) , задающее тип данных объекта **Parameter** .|
|*Direction* |Необязательный атрибут. Значение [параметердиректионенум](parameterdirectionenum.md) , задающее тип объекта **Parameter** .|
|*Size* |Необязательный атрибут. **Длинное** значение, задающее максимальную длину значения параметра в символах или байтах.|
|*Значение* |Необязательный атрибут. Значение **Variant** , задающее значение для объекта **Parameter** .|
