...
В этом примере показано [динамическое](field-object-ado.md) свойство Оптимизируйте объект Field. Поле ***zip*** таблицы ***Авторов*** в базе ***данных Pubs*** не индексироваться. Параметр [Оптимизируйте](optimize-property-dynamic-ado.md) свойство **True** на поле zip ***разрешает*** ADO создавать индекс, улучшая производительность метода [Find.](find-method-ado.md)
