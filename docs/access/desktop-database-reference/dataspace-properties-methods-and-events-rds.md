---
title: Пространства данных свойства, методы и события (RDS)
...
ms.locfileid: "28713613"
---
# <a name="dataspace-properties-methods-and-events-rds"></a>Пространства данных свойства, методы и события (RDS)
