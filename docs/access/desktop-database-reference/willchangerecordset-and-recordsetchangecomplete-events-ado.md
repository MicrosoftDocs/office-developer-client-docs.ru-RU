...
События willchangerecordset*адреасон*, *адстатус*, ** пред

RecordsetChangeComplete*адреасон*, *перрор*, *адстатус*, ** пред
