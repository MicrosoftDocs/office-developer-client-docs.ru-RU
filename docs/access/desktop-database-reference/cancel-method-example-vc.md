...
---
# <a name="cancel-method-example-vc"></a><span data-ttu-id="576f4-102">Пример использования метода Cancel (VC++)</span><span class="sxs-lookup"><span data-stu-id="576f4-102">Cancel method example (VC++)</span></span>


<span data-ttu-id="576f4-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="576f4-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="576f4-104">В этом примере метод [Отмена](cancel-method-ado.md) отмены выполнения команды на [объекте Подключения,](connection-object-ado.md) если подключение загружено.</span><span class="sxs-lookup"><span data-stu-id="576f4-104">This example uses the [Cancel](cancel-method-ado.md) method to cancel a command executing on a [Connection](connection-object-ado.md) object if the connection is busy.</span></span>
