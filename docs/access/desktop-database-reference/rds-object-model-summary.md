...
<td><p>Этот объект может автоматически вызывать <strong>RDS. Объект Space</strong> и <strong>рдссервер. объект фактов</strong> . Используйте этот объект, чтобы вызвать процесс получения или обновления данных RDS, используемый по умолчанию. Этот объект также предоставляет средства для визуальных элементов управления для доступа к возвращенному объекту <strong>Recordset</strong> .</p></td>
</tr>
</tbody>
</table>
