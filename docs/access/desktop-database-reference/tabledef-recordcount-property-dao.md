...
Возвращает общее количество записей в **[объекте TableDef.](tabledef-object-dao.md)** Только для чтения, **Long**.
...
При работе с связанными **объектами TableDef** параметр **свойства RecordCount** всегда —1.
