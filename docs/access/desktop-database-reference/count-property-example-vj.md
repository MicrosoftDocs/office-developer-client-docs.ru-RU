...
В этом примере показано свойство [Count](count-property-ado.md) с двумя коллекциями в базе данных ***Employees*** . Свойство получает количество объектов в каждой коллекции и задает верхнюю границу циклов, которые перечисляют эти коллекции. Другой способ перечисления этих коллекций без использования свойства **Count** — использовать операторы.
