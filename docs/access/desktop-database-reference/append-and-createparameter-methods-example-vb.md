...
ms.locfileid: "25879454"
---
# <a name="append-and-createparameter-methods-example-vb"></a><span data-ttu-id="02a09-102">Пример использования методов Append и CreateParameter (VB)</span><span class="sxs-lookup"><span data-stu-id="02a09-102">Append and CreateParameter methods example (VB)</span></span>


<span data-ttu-id="02a09-103">**Применимо к**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="02a09-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="02a09-104">В этом примере использует методы [Append](append-method-ado.md) и [CreateParameter](createparameter-method-ado.md) для выполнения хранимой процедуры с входным параметром.</span><span class="sxs-lookup"><span data-stu-id="02a09-104">This example uses the [Append](append-method-ado.md) and [CreateParameter](createparameter-method-ado.md) methods to execute a stored procedure with an input parameter.</span></span>
