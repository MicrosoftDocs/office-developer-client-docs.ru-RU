...
*выражения* . CreateField ***(Имя,*** ***Тип***, ***Размер***)
...
<td><p><strong>Variant</strong></p></td>
<td><p>Аргумент, не поддерживаемый для этого объекта.</p></td>
</tr>
<tr class="odd">
...
Аргументы типа и размера применяются только к **объектам Field** в **объекте TableDef.** Эти аргументы игнорируются, если объект **Field** связан с объектом **Index** или **Relation**.
