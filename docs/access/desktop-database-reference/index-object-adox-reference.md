---
title: Ссылка на объект (ADOX) индекса
...
ms.locfileid: "28701202"
---
# <a name="index-object-adox-reference"></a>Ссылка на объект (ADOX) индекса

**Применимо к**: Access 2013, Office 2013

- [Объект Index (ADOX)](index-object-adox.md)
- [Индекс свойства, методы и события (ADOX)](index-properties-methods-and-events-adox.md)
