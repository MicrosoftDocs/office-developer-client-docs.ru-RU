...
В этом примере используется свойство **RecordsAffected** с запросами действий, выполненными из объекта **Database** и объекта **QueryDef.** Для запуска этой процедуры требуется функция RecordsAffectedOutput.
