...
** = *Поток*Variant. Read (*нумбитес* )

## <a name="parameters"></a>Параметры

|Параметр|Описание|
|:--------|:----------|
|*Нумбитес* |Необязательный атрибут. **Длинное** значение, задающее количество байтов для чтения из файла или значение [стреамреаденум](streamreadenum.md) **адреадалл**, используемое по умолчанию.|
