...
**Методы**
  ...
  - [Добавьте метод Keys, тип ключа, RelatedColumn, RelatedTable и UpdateRule пример свойств (VB)](keys-append-method-key-type-relatedcolumn-relatedtable-and-updaterule-properties-example-vb.md)
...
**Свойства**
  ...
  - [Тип ключа, RelatedColumn, RelatedTable и UpdateRule свойства, добавьте ключи пример метода (VB)](keys-append-method-key-type-relatedcolumn-relatedtable-and-updaterule-properties-example-vb.md)

  - [Свойство Name, столбцы и добавление таблиц пример: методы (VB)](columns-and-tables-append-methods-name-property-example-vb.md)
  ...
  - [Таблица свойство Type, метод Close подключения, пример (VB)](connection-close-method-table-type-property-example-vb.md)
