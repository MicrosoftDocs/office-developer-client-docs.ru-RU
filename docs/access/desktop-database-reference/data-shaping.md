...
Столбцы в наборе **записей** в форме могут содержать данные от поставщика данных, например Microsoft SQL Server, ссылки на другой **набор записей**, значения, полученные в результате вычисления для одной строки **набора записей**, значения, полученные в результате операции над столбец всего **набора записей**; или они могут быть созданным пустым столбцом.
