...
В приведенном ниже коде показано, как удалить процедуру с [](procedures-collection-adox.md) помощью метода [Delete](delete-method-adox-collections.md) Collection.
