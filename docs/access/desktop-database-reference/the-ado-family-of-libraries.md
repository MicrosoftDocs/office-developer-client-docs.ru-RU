...
Семейство ADO составляет три основные библиотеки: ADO (включая RDS), ADO MD и ADOX.

## <a name="ado"></a>ADO

ADO позволяет клиентские приложениям получать доступ к данным с сервера баз данных и управлять ими с помощью поставщика OLE DB. Основными преимуществами ADO являются простота использования, высокая скорость, низкая нагрузка на память и небольшое количество места на диске. ADO поддерживают основные функции создания клиентских, серверных и веб-приложений.
