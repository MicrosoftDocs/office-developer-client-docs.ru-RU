...
Указывает код ошибки для определенного поставщика для данного объекта [Error.](error-object-ado.md)
...
Используйте свойство **NativeError** для получения сведений об ошибках для определенного объекта **Error.** Например, при использовании поставщика ODBC Microsoft для OLE DB с базой данных Microsoft SQL Server, коды ошибок, которые происходят из SQL Server, передаются через ODBC и поставщику ODBC в свойство ADO **NativeError.**
