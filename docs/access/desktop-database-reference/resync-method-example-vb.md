...
---
# <a name="resync-method-example-vb"></a><span data-ttu-id="0be1e-102">Пример использования метода Resync (VB)</span><span class="sxs-lookup"><span data-stu-id="0be1e-102">Resync method example (VB)</span></span>


<span data-ttu-id="0be1e-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="0be1e-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="0be1e-104">В этом примере демонстрируется использование метода [Resync](resync-method-ado.md) для обновления данных в статическом наборе записей.</span><span class="sxs-lookup"><span data-stu-id="0be1e-104">This example demonstrates using the [Resync](resync-method-ado.md) method to refresh data in a static recordset.</span></span>
