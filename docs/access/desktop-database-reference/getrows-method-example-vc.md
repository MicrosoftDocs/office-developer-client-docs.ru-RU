...
---
# <a name="getrows-method-example-vc"></a>Пример использования метода GetRows (VC++)


**Область применения**: Access 2013, Office 2013

В этом примере используется метод [GetRows](getrows-method-ado.md) для получения указанного числа строк из объекта [Recordset](recordset-object-ado.md) и для заполнения массива итоговыми данными. Метод **GetRows** будет возвращать меньше требуемого количества строк в двух случаях: либо при достижении [конца файла](bof-eof-properties-ado.md) , **либо при** попытке получить запись, которая была удалена другим пользователем. Функция возвращает значение **False** только при возникновении второго случая. Функция GetRowsOK необходима для запуска этой процедуры.
