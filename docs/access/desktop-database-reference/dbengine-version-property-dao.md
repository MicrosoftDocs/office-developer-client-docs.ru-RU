...
Rreturns the version of DAO currently in use. Только для чтения, **String**.
...
Возвращаемая величина — это строка, которая оценивается как номер версии в виде "major.minor". Например, "3.0". Номер версии продукта состоит из номера версии (3), даты и выпуска (0).
