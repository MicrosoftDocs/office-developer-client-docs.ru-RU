...
> [!TIP]
> Можно выбрать форму в области навигации и перетащите его в строку действие в макросе. Это автоматически создает **ОткрытьФорму** действие, которое открывается форма в представлении формы.
