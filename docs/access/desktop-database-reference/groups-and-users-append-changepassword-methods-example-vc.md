...
---
# <a name="groups-and-users-append-changepassword-methods-example-vc"></a><span data-ttu-id="410a5-102">Пример использования методов Append и ChangePassword для коллекций Groups и Users (VC++)</span><span class="sxs-lookup"><span data-stu-id="410a5-102">Groups and Users Append, ChangePassword methods example (VC++)</span></span>


<span data-ttu-id="410a5-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="410a5-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="410a5-104">В этом примере демонстрируется метод [append](append-method-adox-groups.md) [групп](groups-collection-adox.md), а также метод [append](append-method-adox-users.md) [пользователей](users-collection-adox.md) , добавляя новую [группу](group-object-adox.md) и нового [пользователя](user-object-adox.md) в систему.</span><span class="sxs-lookup"><span data-stu-id="410a5-104">This example demonstrates the [Append](append-method-adox-groups.md) method of [Groups](groups-collection-adox.md), as well as the [Append](append-method-adox-users.md) method of [Users](users-collection-adox.md) by adding a new [Group](group-object-adox.md) and a new [User](user-object-adox.md) to the system.</span></span> <span data-ttu-id="410a5-105">Новая **Группа** добавляется в коллекцию **Groups** нового **пользователя**.</span><span class="sxs-lookup"><span data-stu-id="410a5-105">The new **Group** is appended to the **Groups** collection of the new **User**.</span></span> <span data-ttu-id="410a5-106">Таким образом, новый **пользователь** добавляется в **группу**.</span><span class="sxs-lookup"><span data-stu-id="410a5-106">Consequently, the new **User** is added to the **Group**.</span></span> <span data-ttu-id="410a5-107">Кроме того, метод [ChangePassword](changepassword-method-adox.md) используется для указания пароля **пользователя** .</span><span class="sxs-lookup"><span data-stu-id="410a5-107">Also, the [ChangePassword](changepassword-method-adox.md) method is used to specify the **User** password.</span></span>
