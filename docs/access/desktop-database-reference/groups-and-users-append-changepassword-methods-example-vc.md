...
---
# <a name="groups-and-users-append-changepassword-methods-example-vc"></a><span data-ttu-id="aeb5a-102">Пример использования методов Append и ChangePassword для коллекций Groups и Users (VC++)</span><span class="sxs-lookup"><span data-stu-id="aeb5a-102">Groups and Users Append, ChangePassword methods example (VC++)</span></span>


<span data-ttu-id="aeb5a-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="aeb5a-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="aeb5a-104">В этом примере демонстрируется метод Приложения [групп,](groups-collection-adox.md)а [](users-collection-adox.md) также метод Приложения [](group-object-adox.md) пользователей, [](user-object-adox.md) добавляя в систему новую группу и нового пользователя. [](append-method-adox-groups.md) [](append-method-adox-users.md)</span><span class="sxs-lookup"><span data-stu-id="aeb5a-104">This example demonstrates the [Append](append-method-adox-groups.md) method of [Groups](groups-collection-adox.md), as well as the [Append](append-method-adox-users.md) method of [Users](users-collection-adox.md) by adding a new [Group](group-object-adox.md) and a new [User](user-object-adox.md) to the system.</span></span> <span data-ttu-id="aeb5a-105">Новая **группа** примыкает к **коллекции Групп** нового **пользователя.**</span><span class="sxs-lookup"><span data-stu-id="aeb5a-105">The new **Group** is appended to the **Groups** collection of the new **User**.</span></span> <span data-ttu-id="aeb5a-106">Следовательно, новый **пользователь** добавляется в **группу**.</span><span class="sxs-lookup"><span data-stu-id="aeb5a-106">Consequently, the new **User** is added to the **Group**.</span></span> <span data-ttu-id="aeb5a-107">Кроме того, [метод ChangePassword](changepassword-method-adox.md) используется для указания **пароля пользователя.**</span><span class="sxs-lookup"><span data-stu-id="aeb5a-107">Also, the [ChangePassword](changepassword-method-adox.md) method is used to specify the **User** password.</span></span>
