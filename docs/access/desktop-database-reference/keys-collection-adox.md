...
Остальные свойства и методы являются стандартными для коллекций ADO. Вы можете выполнить указанные ниже действия.
  ...
  - Доступ к ключу в коллекции со свойством [Item](item-property-ado.md) .

  - Возвращает число ключей, которые содержит коллекция, со свойством [Count](count-property-ado.md) .
