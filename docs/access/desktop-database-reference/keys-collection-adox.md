...
Метод [Append](append-method-adox-keys.md) для коллекции **Keys** уникален для ADOX. Вы можете выполнить указанные ниже действия.

  - Добавьте новый ключ в коллекцию с помощью **метода Append.**

Остальные свойства и методы являются стандартными для коллекций ADO. Вы можете выполнить указанные ниже действия.

  - Доступ к ключу в коллекции с помощью [свойства Item.](item-property-ado.md)
