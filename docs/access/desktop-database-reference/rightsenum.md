...
<td><p>65536<br />
( &amp; H10000)</p></td>
<td><p>Пользователь или группа имеет разрешение на удаление данных из объекта. Для таких объектов, как <strong>таблицы,</strong>пользователь имеет разрешение на удаление значений данных из записей.</p></td>
</tr>
<tr class="odd">
...
<td><p>268435456<br />
( &amp; H10000000)</p></td>
<td><p>Пользователь или группа имеет все разрешения на объект.</p></td>
</tr>
<tr class="odd">
<td><p><strong>adRightInsert</strong></p></td>
<td><p>32768<br />
( &amp; H8000)</p></td>
<td><p>Пользователь или группа имеет разрешение на вставку объекта. Для таких объектов, как <strong>таблицы,</strong>пользователь имеет разрешение на вставку данных в таблицу.</p></td>
</tr>
<tr class="even">
<td><p><strong>adRightMaximumAllowed</strong></p></td>
<td><p>33554432 ( &amp; H2000000)</p></td>
<td><p>Пользователь или группа имеет максимальное число разрешений, разрешенных поставщиком. Определенные разрешения зависят от поставщика.</p></td>
</tr>
<tr class="odd">
...
<td><p>1024<br />
( &amp; H400)</p></td>
<td><p>Пользователь или группа имеет разрешение на чтение проекта объекта.</p></td>
</tr>
<tr class="even">
<td><p><strong>adRightReadPermissions</strong></p></td>
<td><p>131072<br />
( &amp; H20000)</p></td>
<td><p>Пользователь или группа могут просматривать( но не изменять) определенные разрешения для объекта в каталоге.</p></td>
</tr>
<tr class="odd">
...
<td><p>1073741824<br />
( &amp; H40000000)</p></td>
<td><p>Пользователь или группа имеет разрешение на обновление объекта. Для таких объектов, как <strong>таблицы,</strong>пользователь имеет разрешение на обновление данных в таблице.</p></td>
</tr>
<tr class="odd">
...
<td><p>2048<br />
( &amp; H800)</p></td>
<td><p>Пользователь или группа имеет разрешение на изменение проекта объекта.</p></td>
</tr>
<tr class="odd">
