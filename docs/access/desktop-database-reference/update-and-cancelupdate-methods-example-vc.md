...
ms.locfileid: "25875527"
---
# <a name="update-and-cancelupdate-methods-example-vc"></a><span data-ttu-id="75cec-102">Пример использования методов Update и CancelUpdate (VC++)</span><span class="sxs-lookup"><span data-stu-id="75cec-102">Update and CancelUpdate methods example (VC++)</span></span>


<span data-ttu-id="75cec-103">**Применимо к**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="75cec-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="75cec-104">В этом примере демонстрируется использование метода [обновления](update-method-ado.md) в сочетании с помощью метода [CancelUpdate](cancelupdate-method-ado.md) .</span><span class="sxs-lookup"><span data-stu-id="75cec-104">This example demonstrates the [Update](update-method-ado.md) method in conjunction with the [CancelUpdate](cancelupdate-method-ado.md) method.</span></span>
...
<span data-ttu-id="75cec-105">**UpdateX.h**</span><span class="sxs-lookup"><span data-stu-id="75cec-105">**UpdateX.h**</span></span>
