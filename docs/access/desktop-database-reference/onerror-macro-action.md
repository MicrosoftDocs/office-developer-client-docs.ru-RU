...
<td><p>Если аргументу Go присвоено значение имя макроса, введите имя макроса, который будет использоваться для обработки ошибок. Введенное имя должно соискать имя в столбце " <strong>имя макроса</strong> " текущего макроса; невозможно ввести имя другого объекта макроса. В приведенном ниже примере макрос <strong>ErrorHandler</strong> находится в том же объекте макроса, что и действие <strong>OnError</strong> . Этот аргумент должен оставаться пустым, если аргументу Go присвоено значение <strong>Next</strong> или <strong>Fail</strong>.</p></td>
</tr>
</tbody>
</table>
