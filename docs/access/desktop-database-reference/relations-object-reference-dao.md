...
---
# <a name="relations-object-reference-dao"></a>Справка об объектах relations (DAO)

**Область применения**: Access 2013, Office 2013

- [Коллекция связей (DAO)](relations-collection-dao.md)
- [Участники отношений (DAO)](relations-members-dao.md)
- [Свойства отношений (DAO)](relations-properties-dao.md)
