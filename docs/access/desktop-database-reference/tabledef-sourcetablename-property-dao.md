...
Задает или возвращает значение, которое указывает имя связанной таблицы или имя базовой таблицы (только в рабочей области Microsoft Access).

## <a name="syntax"></a>Синтаксис

*выражения* . SourceTableName

*выражение*: переменная, представляющая объект **TableDef**.

## <a name="remarks"></a>Комментарии

Этот параметр свойства только для чтения для базовой таблицы и чтения/записи для связанной таблицы или объекта, не подключенного к коллекции. Для базовой таблицы параметр — строка нулевой длины ("").

## <a name="example"></a>Пример

В этом примере **свойства Подключение** **SourceTableName** для привязки различных внешних таблиц к базе данных Microsoft Access. Процедура ConnectOutput необходима для запуска этой процедуры.
