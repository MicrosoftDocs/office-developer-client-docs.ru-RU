...
Для объекта **Recordset,** полностью основанного на таблицах ядров баз данных Microsoft Access, свойство **Bookmarkable** имеет значение True, и вы можете использовать свойство **Bookmark** с этим набором записей. Другие продукты базы данных, однако, могут не поддерживать закладки. Например, нельзя использовать закладки в любом объекте **Recordset2** на основе связанной таблицы Paradox, которая не имеет первичного ключа.
