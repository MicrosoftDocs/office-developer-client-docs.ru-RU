...
> [!NOTE]
> DBPROP_SERVERDATAONINSERT динамического свойства не поддерживается службой курсора, даже если она поддерживается базовым поставщиком данных.
...
<tr class="odd">
<td><p><a href="update-resync-property-dynamic-ado.md">Повторная синхронизация обновлений</a>(DBPROP_ADC_UPDATERESYNC)</p></td>
<td><p>Указывает, является ли метод <strong>Resync</strong> неявно вызванным после метода <a href="updatebatch-method-ado.md">UpdateBatch</a> (и его поведения), когда действует свойство <strong>UNIQUE Table</strong> .</p></td>
</tr>
</tbody>
</table>
