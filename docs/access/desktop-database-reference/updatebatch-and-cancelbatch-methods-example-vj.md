...
ms.locfileid: "25482969"
---
# <a name="updatebatch-and-cancelbatch-methods-example-vj"></a><span data-ttu-id="605cc-102">UpdateBatch and CancelBatch Methods Example (VJ++)</span><span class="sxs-lookup"><span data-stu-id="605cc-102">UpdateBatch and CancelBatch Methods Example (VJ++)</span></span>


<span data-ttu-id="605cc-103">**Применимо к**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="605cc-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="605cc-104">В этом примере демонстрируется использование метода [UpdateBatch](updatebatch-method-ado.md) в сочетании с методом [CancelBatch](cancelbatch-method-ado.md) .</span><span class="sxs-lookup"><span data-stu-id="605cc-104">This example demonstrates the [UpdateBatch](updatebatch-method-ado.md) method in conjunction with the [CancelBatch](cancelbatch-method-ado.md) method.</span></span>
