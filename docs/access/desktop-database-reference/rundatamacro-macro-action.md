...
Вы можете использовать макрокоманду **RunDataMacro** в макросах, именованных макросах данных и следующих макросах: **[после удаления](after-delete-macro-event.md)** макроса **[после вставки](after-insert-macro-event.md)** макроса и **[после обновления макроса](after-update-macro-event.md)**.
