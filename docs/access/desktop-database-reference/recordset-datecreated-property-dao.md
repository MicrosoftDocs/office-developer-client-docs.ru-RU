...
---
# <a name="recordsetdatecreated-property-dao"></a>Свойство Recordset.DateCreated (DAO)
...
Параметры даты и времени вытекают из компьютера, на котором была создана или обновлена базовая таблица.
