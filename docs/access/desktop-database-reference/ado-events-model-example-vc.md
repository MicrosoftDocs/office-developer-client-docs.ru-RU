...
- Директива ** \#Import** разрешает типы и **typedef**типы данных подписи метода и модификаторов в основные формы.

- Все чистые виртуальные методы, которые должны быть перезаписаны, имеют префикс "**необработанный\_**".
