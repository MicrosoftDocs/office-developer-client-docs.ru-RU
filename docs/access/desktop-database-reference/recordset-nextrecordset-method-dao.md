...
В рабочей области ODBCDirect можно **[](recordset-object-dao.md)** открыть набор записей, содержащий несколько выбранных запросов в аргументе **[](querydef-sql-property-dao.md)** источника **OpenRecordset** или свойстве SQL объекта **[select query QueryDef,](querydef-object-dao.md)** как в следующем примере.
