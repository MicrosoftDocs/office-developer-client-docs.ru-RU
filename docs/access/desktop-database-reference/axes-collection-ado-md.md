...
Объект [Cellset](cellset-object-ado-md.md) содержит **коллекцию Axes.** После открытия **cellset** эта коллекция будет содержать по крайней мере одну **ось.** Более [подробное описание](axis-object-ado-md.md) использования объектов Axis см. в объекте **Axis.**
