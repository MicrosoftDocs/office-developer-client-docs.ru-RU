...
Чтобы определить положение, которое ядро СУБД Microsoft Access использует для объектов **field** в коллекции **Fields** объекта **QueryDef**, **Recordset**или **tabledef** , используйте свойство **ординалпоситион** каждого объекта **field** . Изменение свойства **ординалпоситион** объекта **field** не приводит к изменению порядка объектов **field** в коллекции до тех пор, пока не будет использован метод **Refresh** .
