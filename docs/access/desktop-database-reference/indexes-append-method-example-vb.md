...
---
# <a name="indexes-append-method-example-vb"></a>Пример использования метода Append для коллекции Indexes (VB)


**Область применения**: Access 2013, Office 2013

В следующем коде показано, как создать новый индекс. Индекс находится на двух столбцах в таблице.
