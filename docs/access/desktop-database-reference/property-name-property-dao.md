...
---
# <a name="propertyname-property-dao"></a>Свойство Property.Name (DAO)
...
Свойство **Name** встроенного свойства всегда доступно только для чтения.

Максимальная длина имени объекта **Property** составляет 64 символов.
