...
Возвращает количество bytes, используемых в базе данных (а не в памяти) объекта Memo или Long Binary **[Field](field-object-dao.md)** в коллекции **[Fields](fields-collection-dao.md)** объекта **[Recordset.](recordset-object-dao.md)**
...
Чтобы определить размер объекта **Field,** помимо типов Memo и Long Binary, используйте **[свойство Size.](field-size-property-dao.md)**
