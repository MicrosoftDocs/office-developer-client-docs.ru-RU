...
После вызова метода **GetRows** текущая запись располагается в следующей непрочитанной строке. То есть **GetRows** имеет тот же влияни на текущую запись как **Move**нумровс.
