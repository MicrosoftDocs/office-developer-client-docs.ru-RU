...
---
# <a name="updatebatch-and-cancelbatch-methods-example-vc"></a><span data-ttu-id="67b8a-102">Пример использования методов UpdateBatch и CancelBatch (VC++)</span><span class="sxs-lookup"><span data-stu-id="67b8a-102">UpdateBatch and CancelBatch methods example (VC++)</span></span>


<span data-ttu-id="67b8a-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="67b8a-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="67b8a-104">В этом примере демонстрируется метод [UpdateBatch](updatebatch-method-ado.md) в сочетании с [методом CancelBatch.](cancelbatch-method-ado.md)</span><span class="sxs-lookup"><span data-stu-id="67b8a-104">This example demonstrates the [UpdateBatch](updatebatch-method-ado.md) method in conjunction with the [CancelBatch](cancelbatch-method-ado.md) method.</span></span>
...
<span data-ttu-id="67b8a-105">**UpdateBatchX.h**</span><span class="sxs-lookup"><span data-stu-id="67b8a-105">**UpdateBatchX.h**</span></span>
