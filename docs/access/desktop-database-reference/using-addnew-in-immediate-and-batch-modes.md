...
---
# <a name="using-addnew-in-immediate-and-batch-modes"></a><span data-ttu-id="62566-102">Использование AddNew в непосредственных и пакетных режимах</span><span class="sxs-lookup"><span data-stu-id="62566-102">Using AddNew in Immediate and Batch modes</span></span>
