---
title: Пример использования метода OpenSchema (VJ++)
...
ms.locfileid: "25861941"
---
# <a name="openschema-method-example-vj"></a><span data-ttu-id="71839-102">Пример использования метода OpenSchema (VJ++)</span><span class="sxs-lookup"><span data-stu-id="71839-102">OpenSchema method example (VJ++)</span></span>


<span data-ttu-id="71839-103">**Применимо к**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="71839-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="71839-104">В этом примере используется метод [OpenSchema](openschema-method-ado.md) для отображения имени и типа каждой таблицы в базе данных ***Pubs*** .</span><span class="sxs-lookup"><span data-stu-id="71839-104">This example uses the [OpenSchema](openschema-method-ado.md) method to display the name and type of each table in the ***Pubs*** database.</span></span>
