...
В этом примере используется свойство [Sort](sort-property-ado.md) объекта [Recordset](recordset-object-ado.md) для переустановки строк объекта **Recordset,** производного от таблицы ***Authors*** базы ***данных Pubs.*** Вторичная спрограммная подпрограмма печатает каждую строку.
...
Это вторичная спрограмма, которая печатает заданный заголовок и содержимое указанного **наборов записей.**
