...
В этом примере используется свойство [Sort](sort-property-ado.md) объекта [Recordset](recordset-object-ado.md) для изменения порядка строк в **наборе записей** , полученном из таблицы ***authors*** базы данных ***pubs*** . Дополнительная вспомогательная программа печатает каждую строку.
...
Это вторичная служебная программа, которая печатает заданное название и содержимое указанного **набора записей**.
