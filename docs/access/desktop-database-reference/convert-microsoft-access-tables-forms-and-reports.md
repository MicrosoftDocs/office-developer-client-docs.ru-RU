---
<<<<<<< Название HEAD: преобразование таблиц Microsoft Access, форм и отчетов TOCTitle: ms:assetid преобразование таблиц Microsoft Access, форм и отчетов: cc170e62-a663-60e8-4446-07a7a874b747 ms:mtpsurl: https://msdn.microsoft.com/library/Ff834413(v=office.15) ms:contentKeyID: 48547731 ms.date: 09/18/2015 === название: преобразование Microsoft Access таблиц, форм и отчетов TOCTitle: преобразование Microsoft Access таблиц, форм и отчетов Описание: изменений, внесенных Microsoft Access 2002 могут повлиять на поведение вашей версии 1. x или 2.0 приложения.
MS:AssetId: cc170e62-a663-60e8-4446-07a7a874b747 ms:mtpsurl: https://msdn.microsoft.com/library/Ff834413(v=office.15) ms:contentKeyID: 48547731 ms.date: 10/16/2018
...
=======
# <a name="convert-microsoft-access-tables-forms-and-reports"></a>Преобразование таблицы Microsoft Access, форм и отчетов
>>>>>>> master
...
<a name="iifisnullmycontrol-null-formatmycontrol-zls"></a>\=IIf (IsNull (\[MyControl\]), «Null», форматирование (\[MyControl\], «@; [[[ПУСТО»))
=======
