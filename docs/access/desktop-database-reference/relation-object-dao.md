...
Используя объект **relation** и его свойства, вы можете:
  ...
  - Используйте свойство **Name** всех объектов **field** в коллекции Fields **** объекта **relation** , чтобы задать или вернуть имена полей в первичном ключе указанной таблицы или параметры свойства **фореигннаме** объекта Объекты **field** для задания или возвращения имен полей во внешнем ключе ссылающейся таблицы.
