---
title: Свойства коллекции осей, методы и события (ADO MD)
...
ms.locfileid: "25927524"
---
# <a name="axes-collection-properties-methods-and-events-ado-md"></a>Свойства коллекции осей, методы и события (ADO MD)
