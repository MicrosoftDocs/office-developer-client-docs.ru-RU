...
---
# <a name="absolutepage-pagecount-and-pagesize-properties-example-vc"></a><span data-ttu-id="0ef40-102">Пример использования свойств AbsolutePage, PageCount и PageSize (VC++)</span><span class="sxs-lookup"><span data-stu-id="0ef40-102">AbsolutePage, PageCount, and PageSize properties example (VC++)</span></span>


<span data-ttu-id="0ef40-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="0ef40-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="0ef40-104">В этом примере используются свойства [AbsolutePage](absolutepage-property-ado.md), [PageCount](pagecount-property-ado.md)и [pageSize](pagesize-property-ado.md) для отображения имен и дат найма из таблицы ***сотрудников*** , по пять записей за раз.</span><span class="sxs-lookup"><span data-stu-id="0ef40-104">This example uses the [AbsolutePage](absolutepage-property-ado.md), [PageCount](pagecount-property-ado.md), and [PageSize](pagesize-property-ado.md) properties to display names and hire dates from the ***Employee*** table, five records at a time.</span></span>
...
<span data-ttu-id="0ef40-105">**Абсолутепажекс. h**</span><span class="sxs-lookup"><span data-stu-id="0ef40-105">**AbsolutePageX.h**</span></span>
