...
В этом примере свойства [AbsolutePage,](absolutepage-property-ado.md) [PageCount](pagecount-property-ado.md)и [PageSize](pagesize-property-ado.md) используются для отображения имен и дат найма из таблицы ***Сотрудников*** по пять записей одновременно.
