...
В этом примере показано [свойство Clustered](clustered-property-adox.md) [index.](index-object-adox.md) Обратите внимание, что базы данных Microsoft Jet не поддерживают кластерные  индексы, поэтому в этом примере будет **возвращено свойство False** для кластерного свойства всех индексов в базе данных *Northwind.*
