...
ms.locfileid: "25483185"
---
# <a name="addnew-method-example-vb"></a><span data-ttu-id="35ff8-102">AddNew Method Example (VB)</span><span class="sxs-lookup"><span data-stu-id="35ff8-102">AddNew Method Example (VB)</span></span>


<span data-ttu-id="35ff8-103">**Применимо к**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="35ff8-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="35ff8-104">В этом примере используется метод [AddNew](addnew-method-ado.md) , чтобы создать новую запись с указанным именем.</span><span class="sxs-lookup"><span data-stu-id="35ff8-104">This example uses the [AddNew](addnew-method-ado.md) method to create a new record with the specified name.</span></span>
