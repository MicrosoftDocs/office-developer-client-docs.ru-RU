...
В этом примере **свойства Bookmark** и [Filter](filter-property-ado.md) используются для создания ограниченного представления **наборов записей.** Доступны только записи, на которые ссылается массив закладок.
