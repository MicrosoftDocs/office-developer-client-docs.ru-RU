...
В этом примере используются **закладки** и свойства [фильтра](filter-property-ado.md) для создания ограниченного представления объекта **Recordset**. Доступны только записи, на которые ссылается массив закладок.
