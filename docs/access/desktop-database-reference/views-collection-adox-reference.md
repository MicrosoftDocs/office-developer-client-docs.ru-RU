...
**Применимо к**: Access 2013, Office 2013
  ...
  - [Представления коллекции (ADOX)](views-collection-adox.md)

  - [Представления коллекции свойства, методы и события (ADOX)](views-collection-properties-methods-and-events-adox.md)
