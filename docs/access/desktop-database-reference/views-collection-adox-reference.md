...
---
# <a name="views-collection-adox-reference"></a>Справочник по представления коллекции (ADOX)

**Применимо к**: Access 2013, Office 2013

- [Коллекция Views (ADOX)](views-collection-adox.md)
- [Свойства, методы и события коллекции Views (ADOX)](views-collection-properties-methods-and-events-adox.md)
