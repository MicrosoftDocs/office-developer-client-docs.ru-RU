...
---
# <a name="relations-collection-dao"></a>Коллекция связей (DAO)


**Область применения**: Access 2013, Office 2013

Коллекция **отношениях** содержит хранимые объекты **relation** объекта **Database** (только базы данных ядра СУБД Microsoft Access).

## <a name="remarks"></a>Замечания

Объект **relation** можно использовать для создания новых связей и проверки существующих связей в базе данных. Чтобы добавить объект **relation** в коллекцию **связей** , сначала создайте его с помощью метода **креатерелатион** , а затем добавьте его в коллекцию **связей** с помощью метода **append** . При закрытии объекта **базы данных** объект **relation** будет сохранен. Чтобы удалить объект **relation** из коллекции, используйте метод **Delete** .

Чтобы сослаться на объект **relation** в коллекции по его порядковому номеру или по значению свойства **Name** , используйте любую из следующих синтаксических форм:
