...
---
# <a name="echo-macro-action"></a>Действия макроса эхо
...
При запуске макроса обновление часто отображаются сведения о несущественные для функционирования макрос экрана. Если аргумент **Эхо на** значение **No**, макрос выполняется без обновления экрана. После завершения макроса доступа автоматически включает эхо и обновляет окна. **No** для аргумента **Эхо на** не влияет на функциональность макроса или его результаты.
