...
---
# <a name="find-method-example-vc"></a><span data-ttu-id="30235-102">Пример использования метода Find (VC++)</span><span class="sxs-lookup"><span data-stu-id="30235-102">Find method example (VC++)</span></span>


<span data-ttu-id="30235-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="30235-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="30235-104">В этом примере используется [](find-method-ado.md) метод Find объекта [Recordset](recordset-object-ado.md) для поиска и подсчета количества бизнес-названий в ***базе данных Pubs.***</span><span class="sxs-lookup"><span data-stu-id="30235-104">This example uses the [Recordset](recordset-object-ado.md) object's [Find](find-method-ado.md) method to locate and count the number of business titles in the ***Pubs*** database.</span></span> <span data-ttu-id="30235-105">В примере предполагается, что основной поставщик не поддерживает аналогичные функции.</span><span class="sxs-lookup"><span data-stu-id="30235-105">The example assumes the underlying provider does not support similar functionality.</span></span>
...
<span data-ttu-id="30235-106">**FindX.h**</span><span class="sxs-lookup"><span data-stu-id="30235-106">**FindX.h**</span></span>
