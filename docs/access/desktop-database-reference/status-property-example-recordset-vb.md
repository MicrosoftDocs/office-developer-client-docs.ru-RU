...
В этом примере используется свойство [Status](status-property-ado-recordset.md) для отображения записей, которые были изменены в пакетной операции до обновления пакета.
