...
---
# <a name="status-property-example-recordset-vb"></a>Пример использования свойства Status (Recordset) (VB)


**Область применения**: Access 2013, Office 2013

В этом примере свойство [Status](status-property-ado-recordset.md) используется для отображения записей, которые были изменены в пакетной операции перед пакетным обновлением.
