...
Возвращает дескриптивную строку, связанную с ошибкой. Это свойство по умолчанию для объекта **Error.**
...
Свойство **Description** содержит краткое описание ошибки. Используйте это свойство, чтобы предупредить пользователя об ошибке, которую нельзя или не хотите обрабатывать.
