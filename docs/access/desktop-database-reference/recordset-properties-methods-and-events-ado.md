---
title: Свойства набора записей, методы и события (ADO)
...
- [Методы MoveFirst, MoveLast, MoveNext и MovePrevious](movefirst-movelast-movenext-and-moveprevious-methods-ado.md)
...
- [События WillChangeField и FieldChangeComplete](willchangefield-and-fieldchangecomplete-events-ado.md)
- [События WillChangeRecord и RecordChangeComplete](willchangerecord-and-recordchangecomplete-events-ado.md)
- [События WillChangeRecordset и RecordsetChangeComplete](willchangerecordset-and-recordsetchangecomplete-events-ado.md)
- [События WillMove и MoveComplete](willmove-and-movecomplete-events-ado.md)
