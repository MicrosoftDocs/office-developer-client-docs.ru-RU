...
ms.locfileid: "32293961"
---
# <a name="deleterule-property-example-vc"></a><span data-ttu-id="154ac-102">Пример использования свойства DeleteRule (VC++)</span><span class="sxs-lookup"><span data-stu-id="154ac-102">DeleteRule property example (VC++)</span></span>


<span data-ttu-id="154ac-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="154ac-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="154ac-104">В этом примере показано [свойство DeleteRule](deleterule-property-adox.md) объекта [Key.](key-object-adox.md)</span><span class="sxs-lookup"><span data-stu-id="154ac-104">This example demonstrates the [DeleteRule](deleterule-property-adox.md) property of a [Key](key-object-adox.md) object.</span></span> <span data-ttu-id="154ac-105">Код appends a new [Table](table-object-adox.md) and then defines a new primary key, setting **DeleteRule** to **adRICascade**.</span><span class="sxs-lookup"><span data-stu-id="154ac-105">The code appends a new [Table](table-object-adox.md) and then defines a new primary key, setting **DeleteRule** to **adRICascade**.</span></span>
