...
Если при текущей первой записи используется **MovePrevious,** свойство **BOF** является **True,** и текущая запись не существует. Если вы снова **используете MovePrevious,** возникает ошибка, **и BOF** остается **True**.
