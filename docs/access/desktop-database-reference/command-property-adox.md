...
Указывает объект [команды](command-object-ado.md) ADO, который можно использовать для создания или выполнения процедуры.
...
Если поставщик не поддерживает хранимые команды, произойдет ошибка при вызове и задании этого свойства.
