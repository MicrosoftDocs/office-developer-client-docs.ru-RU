...
---
# <a name="member-properties-methods-and-events-ado-md"></a>Свойства, методы и события элемента (ADO MD)
...
- [Свойство LevelName](levelname-property-ado-md.md)
- [Свойство Name](name-property-ado-md.md)
- [Свойство Parent](parent-property-ado-md.md)
