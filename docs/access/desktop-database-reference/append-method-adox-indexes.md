...
|Параметр|Описание|
|:--------|:----------|
|*Индекс* |Объект **index** , который требуется добавить, или имя индекса, который требуется создать и добавить.|
|*Columns* |Необязательное. Значение **типа Variant** , задающее имена столбцов для индексирования. Параметр *Columns* соответствует значениям свойства [Name](name-property-adox.md) объекта [Column](column-object-adox.md) или объектов.|
