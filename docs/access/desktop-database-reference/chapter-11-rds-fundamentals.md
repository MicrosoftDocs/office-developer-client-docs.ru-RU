...
В этом разделе содержится ряд разделов, которые можно читать в предписанной порядке. Включены следующие разделы:
...
В этом разделе также содержится руководство [по RDS,](chapter-12-rds-tutorial.md) в котором показано, как получить доступ к источнику данных и обновить его, а также ряд разделов об использовании [RDS,](chapter-13-rds-usage-and-security.md)в котором обсуждаются более сложные темы RDS.
