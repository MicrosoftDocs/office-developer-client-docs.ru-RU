...
В этом разделе содержится ряд тем, которые можно прочитать в установленном порядке. В него включены следующие темы:
...
В этом разделе также содержится руководство [по RDS,](chapter-12-rds-tutorial.md) в котором показано, как получить доступ к источнику данных и обновить его, а также ряд тем об использовании RDS, в котором обсуждаются более сложные темы [RDS.](chapter-13-rds-usage-and-security.md)
