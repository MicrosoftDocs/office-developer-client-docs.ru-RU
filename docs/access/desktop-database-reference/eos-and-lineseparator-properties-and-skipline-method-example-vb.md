---
title: Пример свойств EOS и LineSeparator и метода SkipLine (VB)
...
---
# <a name="eos-and-lineseparator-properties-and-skipline-method-example-vb"></a><span data-ttu-id="3f83d-102">Пример свойств EOS и LineSeparator и метода SkipLine (VB)</span><span class="sxs-lookup"><span data-stu-id="3f83d-102">EOS and LineSeparator Properties and SkipLine method example (VB)</span></span>


<span data-ttu-id="3f83d-103">**Область применения**: Access 2013, Office 2013</span><span class="sxs-lookup"><span data-stu-id="3f83d-103">**Applies to**: Access 2013, Office 2013</span></span>

<span data-ttu-id="3f83d-104">В этом примере показано, как управлять текстовыми потоками по одной строке.</span><span class="sxs-lookup"><span data-stu-id="3f83d-104">This example demonstrates how to manipulate text streams one line at a time.</span></span> <span data-ttu-id="3f83d-105">Показано действие изменения сепаратора строки с возвращаемого/linefeed по умолчанию **(adCRLF)** на простое linefeed **(adLF)** или возвращение вагона **(adCR).**</span><span class="sxs-lookup"><span data-stu-id="3f83d-105">The effect of changing the line separator from the default carriage return/linefeed (**adCRLF**) to simply linefeed (**adLF**) or carriage return (**adCR**) is shown.</span></span>
