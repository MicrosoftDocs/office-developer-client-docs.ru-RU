...
Теперь, когда вы выполнили команду для источника данных и определили, что результирующий набор содержит данные, можно перемещаться по результатам, используя методы навигации и свойства, предоставляемые объектом **Recordset** . 

В следующих разделах описано, как использовать эти методы и свойства в примере **Recordset**:
