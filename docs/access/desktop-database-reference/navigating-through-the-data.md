...
Теперь, когда вы выполнили команду в отношении источника данных и определили, что набор результатов содержит данные, вы можете перемещаться по результатам с помощью методов навигации и свойств, предоставляемых объектом **Recordset.** 

В следующих темах описаны способы использования этих методов и свойств в примере **Recordset:**
