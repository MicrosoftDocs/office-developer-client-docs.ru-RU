...
|Имя |Описание|
|:----|:----------|
|*Options* |Необязательное. Битовая маска, содержащая значения [ексекутеоптионенум](executeoptionenum.md) и [коммандтипинум](commandtypeenum.md) , которые влияют на эту операцию.|
