...
Используйте **Поиск** для найдите файл Adovbs.inc и помещения их в каталог, который планируется использовать. Скопируйте и вставьте следующий код в блокноте или другом текстовом редакторе и сохраните файл с именем **MoveVBS.asp**. Результат можно просмотреть в любой браузер.

Попробуйте ввести буквы или нецелочисленным для просмотра рабочих обработки ошибок.
