...
---
# <a name="record-object-ado-reference"></a>Справочник по записи объектов (ADO)

**Применимо к**: Access 2013, Office 2013

- [Объект Record (ADO)](record-object-ado.md)
- [Запись свойства, методы и события (ADO)](record-properties-methods-and-events-ado.md)
