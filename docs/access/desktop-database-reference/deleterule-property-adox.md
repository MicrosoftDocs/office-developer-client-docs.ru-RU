...
Указывает действие, выполняемые при удалении первичного ключа.
...
Это свойство доступно только для чтения в [объектах Key,](key-object-adox.md) которые уже были appended в коллекцию.
