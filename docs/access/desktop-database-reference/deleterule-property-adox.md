...
Указывает действие, выполняемые при удалении основного ключа.
...
Это свойство доступно только для чтения на [объектах Key,](key-object-adox.md) которые уже примыкают к коллекции.
