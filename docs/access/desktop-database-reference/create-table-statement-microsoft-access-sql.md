...
<td><p>Определяет индекс по одному полю предложения ограничения. Дополнительные сведения по созданию этого индекса можно <a href="constraint-clause-microsoft-access-sql.md">Предложение ограничения</a>.</p></td>
</tr>
<tr class="even">
<td><p><em>multifieldindex</em></p></td>
<td><p>Предложение ограничения, определяет составной индекс. Дополнительные сведения по созданию этого индекса можно <a href="constraint-clause-microsoft-access-sql.md">Предложение ограничения</a>.</p></td>
</tr>
</tbody>
</table>
...
Используйте инструкцию CREATE TABLE, чтобы определить новую таблицу, поля и ограничения полей. Если не указано значение NULL для поля, а затем обязательно должно содержать допустимые данные в этих полях.
