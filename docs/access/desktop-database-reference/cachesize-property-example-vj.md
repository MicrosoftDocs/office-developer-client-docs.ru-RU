...
В этом примере свойство [CacheSize](cachesize-property-ado.md) показывает разницу в производительности для операции, выполненной с кэшом с 30 записью и без него.
