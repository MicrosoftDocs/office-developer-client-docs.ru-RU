...
В этом примере свойство [CacheSize](cachesize-property-ado.md) используется для демонстрации разницы в производительности для операции, выполняемой с кэшом с 30 записями и без него.
