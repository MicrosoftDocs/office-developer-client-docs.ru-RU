...
---
# <a name="positions-collection-ado-md-reference"></a>Коллекция позиций (ссылка на ADO MD)

**Область применения**: Access 2013, Office 2013

- [Коллекция позиций (ADO MD)](positions-collection-ado-md.md)
- [Свойства, методы и события коллекции позиций (ADO MD)](positions-collection-properties-methods-and-events-ado-md.md)
