...
---
# <a name="move-method-example-vc"></a>Пример использования метода Move (VC++)

**Область применения**: Access 2013, Office 2013

В этом примере с помощью метода [Move](move-method-ado.md) указатель перемещается в соответствии с вводимыми пользователем данными.
