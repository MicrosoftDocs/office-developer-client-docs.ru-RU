---
title: Ссылка на объект (ADO) потока
...
---
# <a name="stream-object-ado-reference"></a>Ссылка на объект (ADO) потока

**Применимо к**: Access 2013, Office 2013

- [Объект Stream (ADO)](stream-object-ado.md)
- [Поток свойства, методы и события (ADO)](stream-properties-methods-and-events-ado.md)
