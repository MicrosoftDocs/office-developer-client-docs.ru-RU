...
---
# <a name="parameter-object-ado-reference"></a>Справочник по объекту Parameter (ADO)

**Область применения**: Access 2013, Office 2013

- [Объект Parameter (ADO)](parameter-object-ado.md)
- [Свойства, методы и события параметров (ADO)](parameter-properties-methods-and-events-ado.md)
