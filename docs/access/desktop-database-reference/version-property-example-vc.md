...
В этом примере [свойство Version](version-property-ado.md) объекта [Подключения](connection-object-ado.md) используется для отображения текущей версии ADO. Он также использует несколько динамических свойств, чтобы показать:
