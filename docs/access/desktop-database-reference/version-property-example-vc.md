...
---
# <a name="version-property-example-vc"></a>Пример использования свойства Version (VC++)


**Область применения**: Access 2013, Office 2013

В этом примере свойство [Version](version-property-ado.md) объекта [Connection](connection-object-ado.md) используется для отображения текущей версии ADO. Он также использует несколько динамических свойств для демонстрации:

  - текущее имя и версия DBMS.
