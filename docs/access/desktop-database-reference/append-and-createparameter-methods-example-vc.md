...
ms.locfileid: "25482815"
---
# <a name="append-and-createparameter-methods-example-vc"></a><span data-ttu-id="62882-102">Append and CreateParameter Methods Example (VC++)</span><span class="sxs-lookup"><span data-stu-id="62882-102">Append and CreateParameter Methods Example (VC++)</span></span>


<span data-ttu-id="62882-103">**Применимо к**: Access 2013 | Office 2013</span><span class="sxs-lookup"><span data-stu-id="62882-103">**Applies to**: Access 2013 | Office 2013</span></span>

<span data-ttu-id="62882-104">В этом примере использует методы [Append](append-method-ado.md) и [CreateParameter](createparameter-method-ado.md) для выполнения хранимой процедуры с входным параметром.</span><span class="sxs-lookup"><span data-stu-id="62882-104">This example uses the [Append](append-method-ado.md) and [CreateParameter](createparameter-method-ado.md) methods to execute a stored procedure with an input parameter.</span></span>
...
<span data-ttu-id="62882-105">**AppendX.h**</span><span class="sxs-lookup"><span data-stu-id="62882-105">**AppendX.h**</span></span>
