...
Чтобы найти запись в объекте **Recordset** типа dynaset или мгновенный снимок, удовлетворяющую определенным условиям, которое не распространяются на существующие индексы, используйте методы **[Find](recordset2-findfirst-method-dao.md)**. Чтобы включить все записи, а не только те, которые удовлетворяют заданному условию, используйте методы **[Move](recordset-movefirst-method-dao.md)**, чтобы перейти из записи.
