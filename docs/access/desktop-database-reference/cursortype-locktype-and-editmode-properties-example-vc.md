...
В этом примере показано, как установить свойства [CursorType](cursortype-property-ado.md) и [LockType](locktype-property-ado.md) перед открытием [наборов записей.](recordset-object-ado.md) В нем также показано значение свойства [EditMode](editmode-property-ado.md) в различных условиях. Для запуска этой процедуры требуется функция EditModeOutput.
