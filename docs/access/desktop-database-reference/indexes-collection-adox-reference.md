...
ms.locfileid: "25871320"
---
# <a name="indexes-collection-adox-reference"></a>Indexes Collection (ADOX) Reference
...
**Применимо к**: Access 2013, Office 2013
  ...
  - [Коллекции индексов (ADOX)](indexes-collection-adox.md)

  - [Коллекции индексов свойства, методы и события (ADOX)](indexes-collection-properties-methods-and-events-adox.md)
