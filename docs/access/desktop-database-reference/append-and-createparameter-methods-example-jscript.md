...
В этом примере используются [методы Append](append-method-ado.md) и [CreateParameter](createparameter-method-ado.md) для выполнения сохраненной процедуры с параметром ввода. Вырезать и вклеить следующий код для Блокнот или другого текстового редактора и сохранить его как **AppendJS.asp**.
