...
Возвращает закладки с указанием последней добавленной или измененной записи.

## <a name="syntax"></a>Синтаксис

*выражения* . LastModified

*expression*: переменная, представляющая объект **Recordset**.

## <a name="remarks"></a>Примечания

Свойство **LastModified можно** использовать для перемещения к последней добавленной или обновленной записи. Используйте свойство **LastModified** с объектами **[recordset](recordset-object-dao.md)** таблицы и dynaset-type. Запись должна быть добавлена или изменена в самом объекте **Recordset,** чтобы свойство **LastModified** было иметь значение.
