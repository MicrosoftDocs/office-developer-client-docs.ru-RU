...
---
# <a name="databaseconnect-property-dao"></a>База данных. Подключение (DAO)


**Область применения**: Access 2013, Office 2013

Задает или возвращает значение, которое предоставляет сведения об источнике открытой базы данных. Для чтения и записи, **String**.
...
Вы можете Подключение **для** объекта **Базы** данных, предоставив исходный аргумент **методу OpenDatabase.** Вы можете проверить параметр, чтобы определить тип, путь, код пользователя, пароль или источник данных ODBC базы данных.
