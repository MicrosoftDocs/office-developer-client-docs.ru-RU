...
---
# <a name="less-than-or-equal-to-access-custom-web-app"></a>Меньше или равно (приложение настраиваемых web Access)

Сравнение двух выражений. При сравнении выражений, не являющееся null, результатом является значение TRUE, если операнд имеет значение меньше или равно значению правого; в противном случае результатом является значение FALSE.
