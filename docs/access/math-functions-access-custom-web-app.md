...
---
# <a name="math-functions-access-custom-web-app"></a>Математические функции (пользовательское веб-приложение Access)
...
- [Функция Count (пользовательское веб-приложение Access)](count-function-access-custom-web-app.md)
...
- [Power Function (пользовательское веб-приложение Access)](power-function-access-custom-web-app.md)
