...
description: Возвращает текстовое выражение с данными нижнего регистра, преобразованными в верхний регистр.
...
Возвращает текстовое выражение с данными нижнего регистра, преобразованными в верхний регистр.
