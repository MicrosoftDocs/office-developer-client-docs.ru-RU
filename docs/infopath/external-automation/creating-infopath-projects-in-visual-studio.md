...
- [Разработка шаблонов форм с помощью объектной модели infopath 2003](https://msdn.microsoft.com/library/c74cbcd0-4fe6-4eb7-a05c-f61e1868c42b%28Office.15%29.aspx): в этой статье описывается, как создавать проекты для шаблонов форм InfoPath с бизнес-логикой, написанной в управляемом коде (Visual Basic или C#), по отношению к элементам объектной модели InfoPath 2003-Compatible, предоставляемой пространством имен [Microsoft. Office. Interop. InfoPath. SemiTrust](https://msdn.microsoft.com/library/Microsoft.Office.Interop.InfoPath.SemiTrust.aspx) . 
