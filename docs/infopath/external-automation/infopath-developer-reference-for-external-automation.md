...
Дополнительные сведения о работе с шаблонами форм InfoPath, которые содержат бизнес-логику, написанную в управляемом коде, см. в справочнике разработчика [InfoPath 2013](https://go.microsoft.com/fwlink/?LinkId=159764)по шаблонам форм.
