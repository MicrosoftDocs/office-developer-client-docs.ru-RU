...
Дополнительные сведения о работе с шаблонами форм InfoPath, содержащих бизнес-логики, написанных в управляемом коде можно [справочника разработчика InfoPath 2013 для шаблонов форм](http://go.microsoft.com/fwlink/?LinkId=159764).
