...
Для получения дополнительных сведений о работе с шаблонами форм InfoPath, содержащими бизнес-логику, написанную в управляемом коде, ознакомьтесь со статьей [InfoPath 2013 Developer для шаблонов форм](https://go.microsoft.com/fwlink/?LinkId=159764).
