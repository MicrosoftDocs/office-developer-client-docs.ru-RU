...
---
# <a name="create-a-com-add-in-to-add-custom-features-to-infopath"></a>Создание надстройки COM для добавления настраиваемых функций InfoPath
...
2. В меню **файл** выберите команду **Новый проект**.
