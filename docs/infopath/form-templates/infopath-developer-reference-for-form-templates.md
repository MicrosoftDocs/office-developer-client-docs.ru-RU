...
---
# <a name="infopath-developer-reference-for-form-templates"></a><span data-ttu-id="2a004-105">Справочник разработчика InfoPath по шаблонам форм</span><span class="sxs-lookup"><span data-stu-id="2a004-105">InfoPath developer reference for form templates</span></span>

<span data-ttu-id="2a004-p102">Добро пожаловать на страницу справочника разработчика InfoPath 2013 по шаблонам форм. В этой документации предоставляются обзоры, задачи программирования и справочные сведения библиотеки классов, призванные помочь в создании шаблонов форм InfoPath, содержащих бизнес-логику, написанную на языке Visual Basic или Visual C#.</span><span class="sxs-lookup"><span data-stu-id="2a004-p102">Welcome to the InfoPath 2013 developer reference for form templates. This documentation provides overviews, programming tasks, and class library reference information that is designed to help you build InfoPath form templates that contain business logic written in Visual Basic or Visual C#.</span></span>
  
<span data-ttu-id="2a004-108">Дата публикации данной справки — октябрь 2012 г.</span><span class="sxs-lookup"><span data-stu-id="2a004-108">Publish date of this reference: October 2012</span></span>
...
[<span data-ttu-id="2a004-114">Уведомление корпорации Майкрософт о конфиденциальности в сети</span><span class="sxs-lookup"><span data-stu-id="2a004-114">Microsoft Online Privacy Notice</span></span>](http://privacy.microsoft.com/en-us/default.mspx)
