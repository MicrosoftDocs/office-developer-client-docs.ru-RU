...
## <a name="best-practices-for-form-templates-sent-as-an-attachment-to-an-email-message"></a>Best Practices for Form Templates Sent as an Attachment to an Email Message

InfoPath поддерживает развертывание шаблонов форм в виде вложения в сообщение электронной почты и перемещение шаблонов форм из одного расположения в другое. Для обеспечения безопасности лучше использовать цифровую подпись шаблона формы, который вы создаете и собираетесь развернуть в виде вложения в сообщение электронной почты. Цифровая подпись шаблона формы, развернутого сообщением электронной почты, обеспечивает не только проверку подлинности шаблона. Она имеет дополнительное значение, позволяя автоматически обновлять шаблоны форм.
