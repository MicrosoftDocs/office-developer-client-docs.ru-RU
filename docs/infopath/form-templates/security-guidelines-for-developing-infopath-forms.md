...
- Как подписать шаблоны форм, отправленные в виде вложения в сообщение электронной почты.
...
## <a name="best-practices-for-form-templates-sent-as-an-attachment-to-an-email-message"></a>Лучшие практики для шаблонов форм, отправленных в качестве вложения в сообщение электронной почты

InfoPath поддерживает развертывание шаблонов форм в качестве вложения в сообщение электронной почты и перемещение шаблонов форм из одного расположения в другое. Это хорошая практика безопасности, чтобы цифровой подписывать шаблон формы, который вы создаете и намерены развернуть в качестве вложения в сообщение электронной почты. Цифровая подпись на шаблоне формы, развернутом сообщением электронной почты, не только обеспечивает подлинность шаблона. Она имеет дополнительное значение, позволяя автоматически обновлять шаблоны форм.
