...
|:-----|:-----|:-----|
||**На основе URL-адреса** <br/> |**На основе идентификатора URN** <br/> |**Отметка небезопасности ActiveX для скриптов** <br/> |**Доступ к данным между доменами** <br/> |**Уровень безопасности объектной модели** <br/> |
