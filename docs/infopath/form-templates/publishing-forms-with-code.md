...
|:-----|:-----|:-----|
|**Требуемые разрешения** <br/> |Могут публиковаться любым администратором семейства сайтов.  <br/> |Могут развертываться администратором фермы.  <br/> |
...
|**Рекомендации по использованию** <br/> |Формы, требующие небольшого объема кода.  <br/> |Формы, содержащие большой объем кода.  <br/> |
