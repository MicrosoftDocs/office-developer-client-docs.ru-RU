...
Любой администратор может публиковать формы с кодом непосредственно из мастера публикации InfoPath Designer в библиотеке форм в SharePoint. Код выполняется в изолированной среде, что предотвращает выполнение вредоносного кода на сервере. Этот процесс называется публикацией изолированного решения или публикацией в изолированной инфраструктуре SharePoint.
...
|**Публикация** <br/> |Может быть опубликовано непосредственно из InfoPath.  <br/> |Могут публиковаться с помощью центра администрирования или средства командной строки stsadm.  <br/> |
...
- Не удается отправить к подключениям к данным электронной почты.
