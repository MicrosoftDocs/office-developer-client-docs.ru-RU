...
5. Для получения сведений об использовании средства настройки поиска справки Visual Studio или веб-сайте MSDN для «Инструмента настройки .NET Framework (Mscorcfg.msc)».
