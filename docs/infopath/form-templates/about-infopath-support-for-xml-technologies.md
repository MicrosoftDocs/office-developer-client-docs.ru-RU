...
description: Microsoft InfoPath — это гибридное средство, объединяющее лучшие возможности традиционного редактирования документов, например текстовый процессор или приложение электронной почты, с возможностями строгого захвата данных в пакете форм. В этой статье рассматриваются проблемы, для решения которых предназначено средство InfoPath, а также описаны принципы проектирования и отраслевые стандарты XML, использованные в решении проблем.
...
Microsoft InfoPath — это гибридное средство, объединяющее лучшие возможности традиционного редактирования документов, например текстовый процессор или приложение электронной почты, с возможностями строгого захвата данных в пакете форм. В этой статье рассматриваются проблемы, для решения которых предназначено средство InfoPath, а также описаны принципы проектирования и отраслевые стандарты XML, использованные в решении проблем.
