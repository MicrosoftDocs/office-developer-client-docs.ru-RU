...
2. В режиме конструктора InfoPath выберите на вкладке **данные** щелкните **Подключения к данным**.
...
1. В режиме конструктора InfoPath выберите на вкладке **данные** щелкните **Параметры отправки**.
    
2. В диалоговом окне **Параметры отправки** щелкните **Разрешить пользователям отправлять эту форму**и затем выберите **выполнить пользовательское действие с использованием кода**.
...
6. Нажмите кнопку **Отправить**. Должно появиться сообщение о том, автономный режим отправлена форма.
