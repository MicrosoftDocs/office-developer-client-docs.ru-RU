...
Для получения сведений о сборках Microsoft. Office. Interop. InfoPath и Microsoft. Office. Interop. InfoPath. XML обратитесь к документации по пространствам имен [Microsoft. Office. Interop. InfoPath](https://msdn.microsoft.com/library/microsoft.office.interop.infopath.aspx) и [Microsoft. Office. Interop. InfoPath. XML](https://msdn.microsoft.com/library/microsoft.office.interop.infopath.xml) . 
...
Для поддержки создания шаблонов форм, использующих языки с управляемым кодом, такие как Visual C# и Visual Basic для программной логики, в InfoPath была добавлена функциональная возможность, позволяющая размещать сборку взаимодействия между средой CLR и Microsoft. Office. Interop. InfoPath. SemiTrust, чтобы обеспечить безопасность управляемого кода для взаимодействия с объектной моделью COM, предоставляемой InfoPath. Сведения о модели безопасности, которая применяется к шаблонам форм InfoPath с управляемым кодом, представлены в статье [о модели безопасности для шаблонов форм с кодом](about-the-security-model-for-form-templates-with-code.md). 
...
### <a name="how-com-objects-are-exposed-to-the-infopath-2003-compatible-object-model"></a>Как объекты COM представлены в объектной модели, совместимой с InfoPath 2003
...
### <a name="how-microsoft-xml-core-services-msxml-50-for-microsoft-office-objects-are-exposed-to-the-infopath-2003-compatible-object-model"></a>Сведения о том, как базовые службы XML Microsoft (MSXML) 5,0 для объектов Microsoft Office представлены в объектной модели, совместимой с InfoPath 2003
...
### <a name="about-common-language-specification-compliance"></a>О соответствии спецификации общеязыковой спецификации
