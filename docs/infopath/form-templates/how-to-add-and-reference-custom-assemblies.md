...
Чтобы избежать конфликта с процессом управления системой проектов InfoPath файлами, добавляемыми в файл шаблона формы, не копируйте пользовательские сборки, на которые требуется указать ссылки, в папку верхнего уровня проекта шаблона формы. По умолчанию это путь в следующем формате: < *drive* >: \Users\ *username* \Документс\инфопас Projects \ *имя_проекта* 
