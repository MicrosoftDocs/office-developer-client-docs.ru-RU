...
[Доступ к данным приложений](how-to-access-application-data.md)
...
[Данные форм доступа](how-to-access-form-data.md)
...
[Записывая условная логика, определяемая средой запуска](how-to-write-conditional-logic-that-determines-the-run-time-environment.md)
...
[Работа с form Windows](how-to-work-with-form-windows.md)
...
[Работа с управлением правами на информацию Параметры](how-to-work-with-information-rights-management-settings.md)
