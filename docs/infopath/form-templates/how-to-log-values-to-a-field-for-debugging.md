...
## <a name="create-a-multi-line-text-field"></a>Создание многостроального текстового поля
...
## <a name="add-helper-functions-to-log-debug-information-to-the-field"></a>Добавление в поле дополнительных функций для регистрации данных отлаки
...
> [!NOTE] 
> При использовании Visual Basic добавьте  `Imports Microsoft.VisualBasic.Constants` директивы в верхней части файла кода формы. 
