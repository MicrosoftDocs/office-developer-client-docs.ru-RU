...
> [!IMPORTANT]
> Помимо описанных далее процедур, также необходимо выбрать пункт **Сохранить как** на вкладке **Файл**, а затем выбрать **Шаблон формы InfoPath 2003** в поле **Вывод** для сохранения шаблона формы в файл с форматом, совместимым с InfoPath 2003. Кроме того, чтобы открыть шаблоны форм, совместимые с InfoPath 2003, созданные с помощью InfoPath, все пользователи InfoPath 2003 должны иметь платформа .NET Framework 2.0 или более поздней установки на своих компьютерах. 
...
1. Запустите конструктор InfoPath.
    
2. На вкладке **Файл** выберите пункт **Параметры формы**.
    
3. В поле **Совместимость** выберите **Шаблон формы InfoPath 2003**.
    
4. В разделе **Программирование** выберите категорию либо **C# (совместимый с InfoPath 2003)** или **Visual Basic (совместимый с InfoPath 2003)** в раскрывающемся списке **Язык кода шаблона формы**. 
    
5. Нажмите кнопку **ОК**.
    
6. Разработать шаблон формы, а затем добавить обработчики событий Visual Studio 2012 г., как описано в описании Add [an Event Handler Using the InfoPath 2003 Object Model](how-to-add-an-event-handler-using-the-infopath-2003-object-model.md).
